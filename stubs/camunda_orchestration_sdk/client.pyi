...
from .semantic_types import AuditLogKey, AuthorizationKey, BatchOperationKey, DecisionDefinitionKey, DecisionEvaluationInstanceKey, DecisionInstanceKey, DecisionRequirementsKey, DocumentId, ElementInstanceKey, IncidentKey, JobKey, ProcessDefinitionKey, ProcessInstanceKey, TenantId, UserTaskKey, Username, VariableKey
...
class CamundaClient:
    ...
    def delete_process_instance(self, process_instance_key: ProcessInstanceKey, *, data: DeleteProcessInstanceDataType0 | None | Unset = UNSET, **kwargs: Any) -> None: ...
    ...
    def search_roles_for_group(self, group_id: str, *, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchRolesForGroupResponse200: ...
    def search_mapping_rules_for_group(self, group_id: str, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchMappingRulesForGroupResponse200: ...
    ...
    def search_mapping_rules_for_role(self, role_id: str, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchMappingRulesForRoleResponse200: ...
    ...
    def search_mapping_rule(self, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchMappingRuleResponse200: ...
    ...
    def search_roles_for_tenant(self, tenant_id: TenantId, *, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchRolesForTenantResponse200: ...
    ...
    def search_clients_for_tenant(self, tenant_id: TenantId, *, data: SearchClientsForTenantData | Unset = UNSET, **kwargs: Any) -> SearchClientsForTenantResponse200: ...
    def search_users_for_tenant(self, tenant_id: TenantId, *, data: SearchUsersForTenantData | Unset = UNSET, **kwargs: Any) -> SearchUsersForTenantResponse200: ...
    ...
    def search_mapping_rules_for_tenant(self, tenant_id: TenantId, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchMappingRulesForTenantResponse200: ...
    ...
    def search_users(self, *, data: UserSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchUsersResponse200: ...
    ...
    def delete_resource(self, resource_key: str, *, data: DeleteResourceRequestType0 | None | Unset = UNSET, **kwargs: Any) -> DeleteResourceResponse: ...
    ...
    def delete_decision_instance(self, decision_instance_key: DecisionInstanceKey, *, data: DeleteDecisionInstanceDataType0 | None | Unset = UNSET, **kwargs: Any) -> None: ...
...
class CamundaAsyncClient:
    ...
    async def delete_process_instance(self, process_instance_key: ProcessInstanceKey, *, data: DeleteProcessInstanceDataType0 | None | Unset = UNSET, **kwargs: Any) -> None: ...
    ...
    async def search_roles_for_group(self, group_id: str, *, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchRolesForGroupResponse200: ...
    async def search_mapping_rules_for_group(self, group_id: str, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchMappingRulesForGroupResponse200: ...
    ...
    async def search_mapping_rules_for_role(self, role_id: str, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchMappingRulesForRoleResponse200: ...
    ...
    async def search_mapping_rule(self, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchMappingRuleResponse200: ...
    ...
    async def search_roles_for_tenant(self, tenant_id: TenantId, *, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchRolesForTenantResponse200: ...
    ...
    async def search_clients_for_tenant(self, tenant_id: TenantId, *, data: SearchClientsForTenantData | Unset = UNSET, **kwargs: Any) -> SearchClientsForTenantResponse200: ...
    async def search_users_for_tenant(self, tenant_id: TenantId, *, data: SearchUsersForTenantData | Unset = UNSET, **kwargs: Any) -> SearchUsersForTenantResponse200: ...
    ...
    async def search_mapping_rules_for_tenant(self, tenant_id: TenantId, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchMappingRulesForTenantResponse200: ...
    ...
    async def search_users(self, *, data: UserSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchUsersResponse200: ...
    ...
    async def delete_resource(self, resource_key: str, *, data: DeleteResourceRequestType0 | None | Unset = UNSET, **kwargs: Any) -> DeleteResourceResponse: ...
    ...
    async def delete_decision_instance(self, decision_instance_key: DecisionInstanceKey, *, data: DeleteDecisionInstanceDataType0 | None | Unset = UNSET, **kwargs: Any) -> None: ...

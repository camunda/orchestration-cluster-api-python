...
from .models.delete_process_instance_request_type_0 import DeleteProcessInstanceRequestType0
...
class CamundaClient:
    ...
    def search_correlated_message_subscriptions(self, data: CorrelatedMessageSubscriptionSearchQuery | Unset = UNSET, **kwargs: Any) -> CorrelatedMessageSubscriptionSearchQueryResult: ...
    def get_variable(self, variable_key: VariableKey, **kwargs: Any) -> VariableResult: ...
    def search_variables(self, data: SearchVariablesData | Unset = UNSET, truncate_values: bool | Unset = UNSET, **kwargs: Any) -> VariableSearchQueryResult: ...
    def evaluate_expression(self, data: ExpressionEvaluationRequest, **kwargs: Any) -> ExpressionEvaluationResult: ...
    def migrate_process_instance(self, process_instance_key: ProcessInstanceKey, data: MigrateProcessInstanceData, **kwargs: Any) -> None: ...
    def migrate_process_instances_batch_operation(self, data: MigrateProcessInstancesBatchOperationData, **kwargs: Any) -> BatchOperationCreatedResult: ...
    def delete_process_instance(self, process_instance_key: ProcessInstanceKey, data: DeleteProcessInstanceDataType0 | None | Unset = UNSET, **kwargs: Any) -> BatchOperationCreatedResult: ...
    def get_process_instance_statistics(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> GetProcessInstanceStatisticsResponse200: ...
    def get_process_instance_call_hierarchy(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> list[Any]: ...
    def get_process_instance(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> GetProcessInstanceResponse200: ...
    ...
    def modify_process_instances_batch_operation(self, data: ModifyProcessInstancesBatchOperationData, **kwargs: Any) -> BatchOperationCreatedResult: ...
    def delete_process_instances_batch_operation(self, data: DeleteProcessInstancesBatchOperationData, **kwargs: Any) -> BatchOperationCreatedResult: ...
    def cancel_process_instance(self, process_instance_key: ProcessInstanceKey, data: CancelProcessInstanceDataType0 | None | Unset = UNSET, **kwargs: Any) -> None: ...
    def search_process_instance_incidents(self, process_instance_key: ProcessInstanceKey, data: IncidentSearchQuery | Unset = UNSET, **kwargs: Any) -> IncidentSearchQueryResult: ...
    def modify_process_instance(self, process_instance_key: ProcessInstanceKey, data: ModifyProcessInstanceData, **kwargs: Any) -> None: ...
    ...
    def cancel_process_instances_batch_operation(self, data: CancelProcessInstancesBatchOperationData, **kwargs: Any) -> BatchOperationCreatedResult: ...
    def resolve_incidents_batch_operation(self, data: ResolveIncidentsBatchOperationData | Unset = UNSET, **kwargs: Any) -> BatchOperationCreatedResult: ...
    def get_process_instance_sequence_flows(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> GetProcessInstanceSequenceFlowsResponse200: ...
    def search_roles_for_group(self, group_id: str, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchQueryResponse: ...
    def search_mapping_rules_for_group(self, group_id: str, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchQueryResponse: ...
    def update_group(self, group_id: str, data: GroupUpdateRequest, **kwargs: Any) -> GroupUpdateResult: ...
    def search_users_for_group(self, group_id: str, data: SearchUsersForGroupData | Unset = UNSET, **kwargs: Any) -> TenantUserSearchResult: ...
    ...
    def search_clients_for_group(self, group_id: str, data: SearchClientsForGroupData | Unset = UNSET, **kwargs: Any) -> TenantClientSearchResult: ...
    ...
    def search_groups(self, data: GroupSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> GroupSearchQueryResult: ...
    ...
    def search_mapping_rules_for_role(self, role_id: str, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchQueryResponse: ...
    def search_clients_for_role(self, role_id: str, data: SearchClientsForRoleData | Unset = UNSET, **kwargs: Any) -> TenantClientSearchResult: ...
    ...
    def search_groups_for_role(self, role_id: str, data: SearchGroupsForRoleData | Unset = UNSET, **kwargs: Any) -> RoleGroupSearchResult: ...
    ...
    def search_roles(self, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> RoleSearchQueryResult: ...
    ...
    def search_users_for_role(self, role_id: str, data: SearchUsersForRoleData | Unset = UNSET, **kwargs: Any) -> TenantUserSearchResult: ...
    ...
    def search_cluster_variables(self, data: ClusterVariableSearchQueryRequest | Unset = UNSET, truncate_values: bool | Unset = UNSET, **kwargs: Any) -> ClusterVariableSearchQueryResult: ...
    ...
    def get_tenant_cluster_variable(self, tenant_id: TenantId, name: str, **kwargs: Any) -> ClusterVariableResult: ...
    def get_global_cluster_variable(self, name: str, **kwargs: Any) -> ClusterVariableResult: ...
    ...
    def get_decision_definition(self, decision_definition_key: DecisionDefinitionKey, **kwargs: Any) -> DecisionDefinitionResult: ...
    def get_decision_definition_xml(self, decision_definition_key: DecisionDefinitionKey, **kwargs: Any) -> str: ...
    def search_decision_definitions(self, data: DecisionDefinitionSearchQuery | Unset = UNSET, **kwargs: Any) -> DecisionDefinitionSearchQueryResult: ...
    def get_usage_metrics(self, start_time: datetime.datetime, end_time: datetime.datetime, tenant_id: str | Unset = UNSET, with_tenants: bool | Unset = False, **kwargs: Any) -> UsageMetricsResponse: ...
    def search_mapping_rule(self, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> MappingRuleSearchQueryResult: ...
    def get_mapping_rule(self, mapping_rule_id: str, **kwargs: Any) -> MappingRuleResult: ...
    def delete_mapping_rule(self, mapping_rule_id: str, **kwargs: Any) -> None: ...
    def update_mapping_rule(self, mapping_rule_id: str, data: MappingRuleUpdateRequest | Unset = UNSET, **kwargs: Any) -> MappingRuleUpdateResult: ...
    def create_mapping_rule(self, data: MappingRuleCreateRequest | Unset = UNSET, **kwargs: Any) -> MappingRuleUpdateResult: ...
    def get_tenant(self, tenant_id: TenantId, **kwargs: Any) -> TenantResult: ...
    def search_roles_for_tenant(self, tenant_id: TenantId, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchQueryResponse: ...
    ...
    def search_clients_for_tenant(self, tenant_id: TenantId, data: SearchClientsForTenantData | Unset = UNSET, **kwargs: Any) -> TenantClientSearchResult: ...
    def search_users_for_tenant(self, tenant_id: TenantId, data: SearchUsersForTenantData | Unset = UNSET, **kwargs: Any) -> TenantUserSearchResult: ...
    ...
    def search_group_ids_for_tenant(self, tenant_id: TenantId, data: SearchGroupIdsForTenantData | Unset = UNSET, **kwargs: Any) -> TenantGroupSearchResult: ...
    def search_mapping_rules_for_tenant(self, tenant_id: TenantId, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchQueryResponse: ...
    def search_tenants(self, data: SearchTenantsData | Unset = UNSET, **kwargs: Any) -> TenantSearchQueryResult: ...
    ...
    def search_audit_logs(self, data: AuditLogSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchAuditLogsResponse200: ...
    def get_audit_log(self, audit_log_key: AuditLogKey, **kwargs: Any) -> GetAuditLogResponse200: ...
    def get_process_definition_message_subscription_statistics(self, data: ProcessDefinitionMessageSubscriptionStatisticsQuery | Unset = UNSET, **kwargs: Any) -> ProcessDefinitionMessageSubscriptionStatisticsQueryResult: ...
    def get_process_definition_instance_version_statistics(self, process_definition_id: ProcessDefinitionId, data: ProcessDefinitionInstanceVersionStatisticsQuery | Unset = UNSET, **kwargs: Any) -> ProcessDefinitionInstanceVersionStatisticsQueryResult: ...
    def search_process_definitions(self, data: SearchProcessDefinitionsData | Unset = UNSET, **kwargs: Any) -> ProcessDefinitionSearchQueryResult: ...
    def get_process_definition(self, process_definition_key: ProcessDefinitionKey, **kwargs: Any) -> ProcessDefinitionResult: ...
    def get_start_process_form(self, process_definition_key: ProcessDefinitionKey, **kwargs: Any) -> GetStartProcessFormResponse200: ...
    def get_process_definition_xml(self, process_definition_key: ProcessDefinitionKey, **kwargs: Any) -> str: ...
    def get_process_definition_instance_statistics(self, data: ProcessDefinitionInstanceStatisticsQuery | Unset = UNSET, **kwargs: Any) -> ProcessDefinitionInstanceStatisticsQueryResult: ...
    def get_process_definition_statistics(self, process_definition_key: ProcessDefinitionKey, data: GetProcessDefinitionStatisticsData | Unset = UNSET, **kwargs: Any) -> GetProcessDefinitionStatisticsResponse200: ...
    def search_users(self, data: SearchUsersData | Unset = UNSET, **kwargs: Any) -> UserSearchResult: ...
    ...
    def update_user(self, username: Username, data: UserUpdateRequest, **kwargs: Any) -> UserResult: ...
    ...
    def search_batch_operations(self, data: SearchBatchOperationsData | Unset = UNSET, **kwargs: Any) -> BatchOperationSearchQueryResult: ...
    def search_batch_operation_items(self, data: SearchBatchOperationItemsData | Unset = UNSET, **kwargs: Any) -> BatchOperationItemSearchQueryResult: ...
    def get_batch_operation(self, batch_operation_key: BatchOperationKey, **kwargs: Any) -> BatchOperationResponse: ...
    ...
    def delete_resource(self, resource_key: str, data: DeleteResourceDataType0 | None | Unset = UNSET, **kwargs: Any) -> DeleteResourceResponse: ...
    def publish_message(self, data: MessagePublicationRequest, **kwargs: Any) -> PublishMessageResponse200: ...
    def correlate_message(self, data: MessageCorrelationRequest, **kwargs: Any) -> MessageCorrelationResult: ...
    def search_decision_requirements(self, data: DecisionRequirementsSearchQuery | Unset = UNSET, **kwargs: Any) -> DecisionRequirementsSearchQueryResult: ...
    def get_decision_requirements_xml(self, decision_requirements_key: DecisionRequirementsKey, **kwargs: Any) -> str: ...
    def get_decision_requirements(self, decision_requirements_key: DecisionRequirementsKey, **kwargs: Any) -> DecisionRequirementsResult: ...
    def delete_decision_instance(self, decision_instance_key: DecisionInstanceKey, data: DeleteProcessInstanceRequestType0 | None | Unset = UNSET, **kwargs: Any) -> BatchOperationCreatedResult: ...
    def get_decision_instance(self, decision_evaluation_instance_key: DecisionEvaluationInstanceKey, **kwargs: Any) -> DecisionInstanceGetQueryResult: ...
    ...
    def search_decision_instances(self, data: DecisionInstanceSearchQuery | Unset = UNSET, **kwargs: Any) -> DecisionInstanceSearchQueryResult: ...
    def get_user_task(self, user_task_key: UserTaskKey, **kwargs: Any) -> GetUserTaskResponse200: ...
    def assign_user_task(self, user_task_key: UserTaskKey, data: UserTaskAssignmentRequest, **kwargs: Any) -> None: ...
    def get_user_task_form(self, user_task_key: UserTaskKey, **kwargs: Any) -> GetUserTaskFormResponse200: ...
    def search_user_task_audit_logs(self, user_task_key: UserTaskKey, data: SearchUserTaskAuditLogsData | Unset = UNSET, **kwargs: Any) -> SearchUserTaskAuditLogsResponse200: ...
    ...
    def search_user_task_variables(self, user_task_key: UserTaskKey, data: SearchUserTaskVariablesData | Unset = UNSET, truncate_values: bool | Unset = UNSET, **kwargs: Any) -> VariableSearchQueryResult: ...
    ...
    def activate_jobs(self, data: JobActivationRequest, **kwargs: Any) -> ActivateJobsResponse200: ...
    def search_jobs(self, data: JobSearchQuery | Unset = UNSET, **kwargs: Any) -> SearchJobsResponse200: ...
    ...
    def get_global_job_statistics(self, from_: datetime.datetime, to: datetime.datetime, job_type: str | Unset = UNSET, **kwargs: Any) -> GlobalJobStatisticsQueryResult: ...
    def complete_job(self, job_key: JobKey, data: CompleteJobData | Unset = UNSET, **kwargs: Any) -> None: ...
    def get_element_instance(self, element_instance_key: ElementInstanceKey, **kwargs: Any) -> ElementInstanceResult: ...
    def search_element_instances(self, data: ElementInstanceSearchQuery | Unset = UNSET, **kwargs: Any) -> ElementInstanceSearchQueryResult: ...
    ...
    def search_element_instance_incidents(self, element_instance_key: ElementInstanceKey, data: IncidentSearchQuery, **kwargs: Any) -> IncidentSearchQueryResult: ...
    ...
    def search_authorizations(self, data: AuthorizationSearchQuery | Unset = UNSET, **kwargs: Any) -> AuthorizationSearchResult: ...
    ...
    def get_authorization(self, authorization_key: AuthorizationKey, **kwargs: Any) -> AuthorizationResult: ...
    def resolve_incident(self, incident_key: IncidentKey, data: IncidentResolutionRequest | Unset = UNSET, **kwargs: Any) -> None: ...
    def search_incidents(self, data: IncidentSearchQuery | Unset = UNSET, **kwargs: Any) -> IncidentSearchQueryResult: ...
    def get_process_instance_statistics_by_definition(self, data: IncidentProcessInstanceStatisticsByDefinitionQuery, **kwargs: Any) -> IncidentProcessInstanceStatisticsByDefinitionQueryResult: ...
    def get_incident(self, incident_key: IncidentKey, **kwargs: Any) -> IncidentResult: ...
    def get_process_instance_statistics_by_error(self, data: IncidentProcessInstanceStatisticsByErrorQuery | Unset = UNSET, **kwargs: Any) -> IncidentProcessInstanceStatisticsByErrorQueryResult: ...
class CamundaAsyncClient:
    ...
    async def search_correlated_message_subscriptions(self, data: CorrelatedMessageSubscriptionSearchQuery | Unset = UNSET, **kwargs: Any) -> CorrelatedMessageSubscriptionSearchQueryResult: ...
    async def get_variable(self, variable_key: VariableKey, **kwargs: Any) -> VariableResult: ...
    async def search_variables(self, data: SearchVariablesData | Unset = UNSET, truncate_values: bool | Unset = UNSET, **kwargs: Any) -> VariableSearchQueryResult: ...
    async def evaluate_expression(self, data: ExpressionEvaluationRequest, **kwargs: Any) -> ExpressionEvaluationResult: ...
    async def migrate_process_instance(self, process_instance_key: ProcessInstanceKey, data: MigrateProcessInstanceData, **kwargs: Any) -> None: ...
    async def migrate_process_instances_batch_operation(self, data: MigrateProcessInstancesBatchOperationData, **kwargs: Any) -> BatchOperationCreatedResult: ...
    async def delete_process_instance(self, process_instance_key: ProcessInstanceKey, data: DeleteProcessInstanceDataType0 | None | Unset = UNSET, **kwargs: Any) -> BatchOperationCreatedResult: ...
    async def get_process_instance_statistics(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> GetProcessInstanceStatisticsResponse200: ...
    async def get_process_instance_call_hierarchy(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> list[Any]: ...
    async def get_process_instance(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> GetProcessInstanceResponse200: ...
    ...
    async def modify_process_instances_batch_operation(self, data: ModifyProcessInstancesBatchOperationData, **kwargs: Any) -> BatchOperationCreatedResult: ...
    async def delete_process_instances_batch_operation(self, data: DeleteProcessInstancesBatchOperationData, **kwargs: Any) -> BatchOperationCreatedResult: ...
    async def cancel_process_instance(self, process_instance_key: ProcessInstanceKey, data: CancelProcessInstanceDataType0 | None | Unset = UNSET, **kwargs: Any) -> None: ...
    async def search_process_instance_incidents(self, process_instance_key: ProcessInstanceKey, data: IncidentSearchQuery | Unset = UNSET, **kwargs: Any) -> IncidentSearchQueryResult: ...
    async def modify_process_instance(self, process_instance_key: ProcessInstanceKey, data: ModifyProcessInstanceData, **kwargs: Any) -> None: ...
    ...
    async def cancel_process_instances_batch_operation(self, data: CancelProcessInstancesBatchOperationData, **kwargs: Any) -> BatchOperationCreatedResult: ...
    async def resolve_incidents_batch_operation(self, data: ResolveIncidentsBatchOperationData | Unset = UNSET, **kwargs: Any) -> BatchOperationCreatedResult: ...
    async def get_process_instance_sequence_flows(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> GetProcessInstanceSequenceFlowsResponse200: ...
    async def search_roles_for_group(self, group_id: str, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchQueryResponse: ...
    async def search_mapping_rules_for_group(self, group_id: str, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchQueryResponse: ...
    async def update_group(self, group_id: str, data: GroupUpdateRequest, **kwargs: Any) -> GroupUpdateResult: ...
    async def search_users_for_group(self, group_id: str, data: SearchUsersForGroupData | Unset = UNSET, **kwargs: Any) -> TenantUserSearchResult: ...
    ...
    async def search_clients_for_group(self, group_id: str, data: SearchClientsForGroupData | Unset = UNSET, **kwargs: Any) -> TenantClientSearchResult: ...
    ...
    async def search_groups(self, data: GroupSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> GroupSearchQueryResult: ...
    ...
    async def search_mapping_rules_for_role(self, role_id: str, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchQueryResponse: ...
    async def search_clients_for_role(self, role_id: str, data: SearchClientsForRoleData | Unset = UNSET, **kwargs: Any) -> TenantClientSearchResult: ...
    ...
    async def search_groups_for_role(self, role_id: str, data: SearchGroupsForRoleData | Unset = UNSET, **kwargs: Any) -> RoleGroupSearchResult: ...
    ...
    async def search_roles(self, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> RoleSearchQueryResult: ...
    ...
    async def search_users_for_role(self, role_id: str, data: SearchUsersForRoleData | Unset = UNSET, **kwargs: Any) -> TenantUserSearchResult: ...
    ...
    async def search_cluster_variables(self, data: ClusterVariableSearchQueryRequest | Unset = UNSET, truncate_values: bool | Unset = UNSET, **kwargs: Any) -> ClusterVariableSearchQueryResult: ...
    ...
    async def get_tenant_cluster_variable(self, tenant_id: TenantId, name: str, **kwargs: Any) -> ClusterVariableResult: ...
    async def get_global_cluster_variable(self, name: str, **kwargs: Any) -> ClusterVariableResult: ...
    ...
    async def get_decision_definition(self, decision_definition_key: DecisionDefinitionKey, **kwargs: Any) -> DecisionDefinitionResult: ...
    async def get_decision_definition_xml(self, decision_definition_key: DecisionDefinitionKey, **kwargs: Any) -> str: ...
    async def search_decision_definitions(self, data: DecisionDefinitionSearchQuery | Unset = UNSET, **kwargs: Any) -> DecisionDefinitionSearchQueryResult: ...
    async def get_usage_metrics(self, start_time: datetime.datetime, end_time: datetime.datetime, tenant_id: str | Unset = UNSET, with_tenants: bool | Unset = False, **kwargs: Any) -> UsageMetricsResponse: ...
    async def search_mapping_rule(self, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> MappingRuleSearchQueryResult: ...
    async def get_mapping_rule(self, mapping_rule_id: str, **kwargs: Any) -> MappingRuleResult: ...
    async def delete_mapping_rule(self, mapping_rule_id: str, **kwargs: Any) -> None: ...
    async def update_mapping_rule(self, mapping_rule_id: str, data: MappingRuleUpdateRequest | Unset = UNSET, **kwargs: Any) -> MappingRuleUpdateResult: ...
    async def create_mapping_rule(self, data: MappingRuleCreateRequest | Unset = UNSET, **kwargs: Any) -> MappingRuleUpdateResult: ...
    async def get_tenant(self, tenant_id: TenantId, **kwargs: Any) -> TenantResult: ...
    async def search_roles_for_tenant(self, tenant_id: TenantId, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchQueryResponse: ...
    ...
    async def search_clients_for_tenant(self, tenant_id: TenantId, data: SearchClientsForTenantData | Unset = UNSET, **kwargs: Any) -> TenantClientSearchResult: ...
    async def search_users_for_tenant(self, tenant_id: TenantId, data: SearchUsersForTenantData | Unset = UNSET, **kwargs: Any) -> TenantUserSearchResult: ...
    ...
    async def search_group_ids_for_tenant(self, tenant_id: TenantId, data: SearchGroupIdsForTenantData | Unset = UNSET, **kwargs: Any) -> TenantGroupSearchResult: ...
    async def search_mapping_rules_for_tenant(self, tenant_id: TenantId, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchQueryResponse: ...
    async def search_tenants(self, data: SearchTenantsData | Unset = UNSET, **kwargs: Any) -> TenantSearchQueryResult: ...
    ...
    async def search_audit_logs(self, data: AuditLogSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> SearchAuditLogsResponse200: ...
    async def get_audit_log(self, audit_log_key: AuditLogKey, **kwargs: Any) -> GetAuditLogResponse200: ...
    async def get_process_definition_message_subscription_statistics(self, data: ProcessDefinitionMessageSubscriptionStatisticsQuery | Unset = UNSET, **kwargs: Any) -> ProcessDefinitionMessageSubscriptionStatisticsQueryResult: ...
    async def get_process_definition_instance_version_statistics(self, process_definition_id: ProcessDefinitionId, data: ProcessDefinitionInstanceVersionStatisticsQuery | Unset = UNSET, **kwargs: Any) -> ProcessDefinitionInstanceVersionStatisticsQueryResult: ...
    async def search_process_definitions(self, data: SearchProcessDefinitionsData | Unset = UNSET, **kwargs: Any) -> ProcessDefinitionSearchQueryResult: ...
    async def get_process_definition(self, process_definition_key: ProcessDefinitionKey, **kwargs: Any) -> ProcessDefinitionResult: ...
    async def get_start_process_form(self, process_definition_key: ProcessDefinitionKey, **kwargs: Any) -> GetStartProcessFormResponse200: ...
    async def get_process_definition_xml(self, process_definition_key: ProcessDefinitionKey, **kwargs: Any) -> str: ...
    async def get_process_definition_instance_statistics(self, data: ProcessDefinitionInstanceStatisticsQuery | Unset = UNSET, **kwargs: Any) -> ProcessDefinitionInstanceStatisticsQueryResult: ...
    async def get_process_definition_statistics(self, process_definition_key: ProcessDefinitionKey, data: GetProcessDefinitionStatisticsData | Unset = UNSET, **kwargs: Any) -> GetProcessDefinitionStatisticsResponse200: ...
    async def search_users(self, data: SearchUsersData | Unset = UNSET, **kwargs: Any) -> UserSearchResult: ...
    ...
    async def update_user(self, username: Username, data: UserUpdateRequest, **kwargs: Any) -> UserResult: ...
    ...
    async def search_batch_operations(self, data: SearchBatchOperationsData | Unset = UNSET, **kwargs: Any) -> BatchOperationSearchQueryResult: ...
    async def search_batch_operation_items(self, data: SearchBatchOperationItemsData | Unset = UNSET, **kwargs: Any) -> BatchOperationItemSearchQueryResult: ...
    async def get_batch_operation(self, batch_operation_key: BatchOperationKey, **kwargs: Any) -> BatchOperationResponse: ...
    ...
    async def delete_resource(self, resource_key: str, data: DeleteResourceDataType0 | None | Unset = UNSET, **kwargs: Any) -> DeleteResourceResponse: ...
    async def publish_message(self, data: MessagePublicationRequest, **kwargs: Any) -> PublishMessageResponse200: ...
    async def correlate_message(self, data: MessageCorrelationRequest, **kwargs: Any) -> MessageCorrelationResult: ...
    async def search_decision_requirements(self, data: DecisionRequirementsSearchQuery | Unset = UNSET, **kwargs: Any) -> DecisionRequirementsSearchQueryResult: ...
    async def get_decision_requirements_xml(self, decision_requirements_key: DecisionRequirementsKey, **kwargs: Any) -> str: ...
    async def get_decision_requirements(self, decision_requirements_key: DecisionRequirementsKey, **kwargs: Any) -> DecisionRequirementsResult: ...
    async def delete_decision_instance(self, decision_instance_key: DecisionInstanceKey, data: DeleteProcessInstanceRequestType0 | None | Unset = UNSET, **kwargs: Any) -> BatchOperationCreatedResult: ...
    async def get_decision_instance(self, decision_evaluation_instance_key: DecisionEvaluationInstanceKey, **kwargs: Any) -> DecisionInstanceGetQueryResult: ...
    ...
    async def search_decision_instances(self, data: DecisionInstanceSearchQuery | Unset = UNSET, **kwargs: Any) -> DecisionInstanceSearchQueryResult: ...
    async def get_user_task(self, user_task_key: UserTaskKey, **kwargs: Any) -> GetUserTaskResponse200: ...
    async def assign_user_task(self, user_task_key: UserTaskKey, data: UserTaskAssignmentRequest, **kwargs: Any) -> None: ...
    async def get_user_task_form(self, user_task_key: UserTaskKey, **kwargs: Any) -> GetUserTaskFormResponse200: ...
    async def search_user_task_audit_logs(self, user_task_key: UserTaskKey, data: SearchUserTaskAuditLogsData | Unset = UNSET, **kwargs: Any) -> SearchUserTaskAuditLogsResponse200: ...
    ...
    async def search_user_task_variables(self, user_task_key: UserTaskKey, data: SearchUserTaskVariablesData | Unset = UNSET, truncate_values: bool | Unset = UNSET, **kwargs: Any) -> VariableSearchQueryResult: ...
    ...
    async def activate_jobs(self, data: JobActivationRequest, **kwargs: Any) -> ActivateJobsResponse200: ...
    async def search_jobs(self, data: JobSearchQuery | Unset = UNSET, **kwargs: Any) -> SearchJobsResponse200: ...
    ...
    async def get_global_job_statistics(self, from_: datetime.datetime, to: datetime.datetime, job_type: str | Unset = UNSET, **kwargs: Any) -> GlobalJobStatisticsQueryResult: ...
    async def complete_job(self, job_key: JobKey, data: CompleteJobData | Unset = UNSET, **kwargs: Any) -> None: ...
    async def get_element_instance(self, element_instance_key: ElementInstanceKey, **kwargs: Any) -> ElementInstanceResult: ...
    async def search_element_instances(self, data: ElementInstanceSearchQuery | Unset = UNSET, **kwargs: Any) -> ElementInstanceSearchQueryResult: ...
    ...
    async def search_element_instance_incidents(self, element_instance_key: ElementInstanceKey, data: IncidentSearchQuery, **kwargs: Any) -> IncidentSearchQueryResult: ...
    ...
    async def search_authorizations(self, data: AuthorizationSearchQuery | Unset = UNSET, **kwargs: Any) -> AuthorizationSearchResult: ...
    ...
    async def get_authorization(self, authorization_key: AuthorizationKey, **kwargs: Any) -> AuthorizationResult: ...
    async def resolve_incident(self, incident_key: IncidentKey, data: IncidentResolutionRequest | Unset = UNSET, **kwargs: Any) -> None: ...
    async def search_incidents(self, data: IncidentSearchQuery | Unset = UNSET, **kwargs: Any) -> IncidentSearchQueryResult: ...
    async def get_process_instance_statistics_by_definition(self, data: IncidentProcessInstanceStatisticsByDefinitionQuery, **kwargs: Any) -> IncidentProcessInstanceStatisticsByDefinitionQueryResult: ...
    async def get_incident(self, incident_key: IncidentKey, **kwargs: Any) -> IncidentResult: ...
    async def get_process_instance_statistics_by_error(self, data: IncidentProcessInstanceStatisticsByErrorQuery | Unset = UNSET, **kwargs: Any) -> IncidentProcessInstanceStatisticsByErrorQueryResult: ...

...
from .semantic_types import AgentInstanceKey, AuditLogKey, AuthorizationKey, BatchOperationKey, ClientId, DecisionDefinitionKey, DecisionEvaluationInstanceKey, DecisionEvaluationKey, DecisionRequirementsKey, DocumentId, ElementInstanceKey, FormKey, GroupId, IncidentKey, JobKey, MappingRuleId, ProcessDefinitionKey, ProcessInstanceKey, RoleId, TenantId, UserTaskKey, Username, VariableKey
...
class CamundaClient:
    ...
    def create_agent_instance(self, *, data: AgentInstanceCreationRequest, **kwargs: Any) -> AgentInstanceCreationResult: ...
    def get_agent_instance(self, agent_instance_key: AgentInstanceKey, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> AgentInstanceResult: ...
    def search_agent_instances(self, *, data: AgentInstanceSearchQuery | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> AgentInstanceSearchQueryResult: ...
    def update_agent_instance(self, agent_instance_key: AgentInstanceKey, *, data: AgentInstanceUpdateRequest, **kwargs: Any) -> None: ...
    ...
    def search_element_instance_wait_states(self, *, data: ElementInstanceWaitStateQuery | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> ElementInstanceWaitStateQueryResult: ...
    ...
    def get_form_by_key(self, form_key: FormKey, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> FormResult: ...
    ...
    def assign_client_to_group(self, group_id: GroupId, client_id: ClientId, **kwargs: Any) -> None: ...
    def assign_mapping_rule_to_group(self, group_id: GroupId, mapping_rule_id: MappingRuleId, **kwargs: Any) -> None: ...
    def assign_user_to_group(self, group_id: GroupId, username: Username, **kwargs: Any) -> None: ...
    ...
    def get_group(self, group_id: GroupId, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> GroupResult: ...
    def search_clients_for_group(self, group_id: GroupId, *, data: GroupClientSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> GroupClientSearchResult: ...
    ...
    def search_mapping_rules_for_group(self, group_id: GroupId, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> GroupMappingRuleSearchResult: ...
    def search_roles_for_group(self, group_id: GroupId, *, data: RoleSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> GroupRoleSearchResult: ...
    def search_users_for_group(self, group_id: GroupId, *, data: GroupUserSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> GroupUserSearchResult: ...
    def unassign_client_from_group(self, group_id: GroupId, client_id: ClientId, **kwargs: Any) -> None: ...
    def unassign_mapping_rule_from_group(self, group_id: GroupId, mapping_rule_id: MappingRuleId, **kwargs: Any) -> None: ...
    def unassign_user_from_group(self, group_id: GroupId, username: Username, **kwargs: Any) -> None: ...
    def update_group(self, group_id: GroupId, *, data: GroupUpdateRequest, **kwargs: Any) -> GroupUpdateResult: ...
    ...
    def delete_mapping_rule(self, mapping_rule_id: MappingRuleId, **kwargs: Any) -> None: ...
    def get_mapping_rule(self, mapping_rule_id: MappingRuleId, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> MappingRuleResult: ...
    def search_mapping_rule(self, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> MappingRuleSearchQueryResult: ...
    def update_mapping_rule(self, mapping_rule_id: MappingRuleId, *, data: MappingRuleUpdateRequest | Unset = UNSET, **kwargs: Any) -> MappingRuleUpdateResult: ...
    ...
    def get_resource_content(self, resource_key: str, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> GetResourceContentResponse200: ...
    def get_resource_content_binary(self, resource_key: str, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> File: ...
    ...
    def assign_role_to_client(self, role_id: RoleId, client_id: ClientId, **kwargs: Any) -> None: ...
    def assign_role_to_group(self, role_id: RoleId, group_id: GroupId, **kwargs: Any) -> None: ...
    def assign_role_to_mapping_rule(self, role_id: RoleId, mapping_rule_id: MappingRuleId, **kwargs: Any) -> None: ...
    def assign_role_to_user(self, role_id: RoleId, username: Username, **kwargs: Any) -> None: ...
    ...
    def get_role(self, role_id: RoleId, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> RoleResult: ...
    def search_clients_for_role(self, role_id: RoleId, *, data: RoleClientSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> RoleClientSearchResult: ...
    def search_groups_for_role(self, role_id: RoleId, *, data: RoleGroupSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> RoleGroupSearchResult: ...
    def search_mapping_rules_for_role(self, role_id: RoleId, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> RoleMappingRuleSearchResult: ...
    ...
    def search_users_for_role(self, role_id: RoleId, *, data: RoleUserSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> RoleUserSearchResult: ...
    def unassign_role_from_client(self, role_id: RoleId, client_id: ClientId, **kwargs: Any) -> None: ...
    def unassign_role_from_group(self, role_id: RoleId, group_id: GroupId, **kwargs: Any) -> None: ...
    def unassign_role_from_mapping_rule(self, role_id: RoleId, mapping_rule_id: MappingRuleId, **kwargs: Any) -> None: ...
    def unassign_role_from_user(self, role_id: RoleId, username: Username, **kwargs: Any) -> None: ...
    def update_role(self, role_id: RoleId, *, data: RoleUpdateRequest, **kwargs: Any) -> RoleUpdateResult: ...
    ...
    def assign_client_to_tenant(self, tenant_id: TenantId, client_id: ClientId, **kwargs: Any) -> None: ...
    def assign_group_to_tenant(self, tenant_id: TenantId, group_id: GroupId, **kwargs: Any) -> None: ...
    def assign_mapping_rule_to_tenant(self, tenant_id: TenantId, mapping_rule_id: MappingRuleId, **kwargs: Any) -> None: ...
    def assign_role_to_tenant(self, tenant_id: TenantId, role_id: RoleId, **kwargs: Any) -> None: ...
    ...
    def search_clients_for_tenant(self, tenant_id: TenantId, *, data: TenantClientSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> TenantClientSearchResult: ...
    ...
    def search_mapping_rules_for_tenant(self, tenant_id: TenantId, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> TenantMappingRuleSearchResult: ...
    def search_roles_for_tenant(self, tenant_id: TenantId, *, data: RoleSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> TenantRoleSearchResult: ...
    ...
    def search_users_for_tenant(self, tenant_id: TenantId, *, data: TenantUserSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> TenantUserSearchResult: ...
    def unassign_client_from_tenant(self, tenant_id: TenantId, client_id: ClientId, **kwargs: Any) -> None: ...
    def unassign_group_from_tenant(self, tenant_id: TenantId, group_id: GroupId, **kwargs: Any) -> None: ...
    def unassign_mapping_rule_from_tenant(self, tenant_id: TenantId, mapping_rule_id: MappingRuleId, **kwargs: Any) -> None: ...
    def unassign_role_from_tenant(self, tenant_id: TenantId, role_id: RoleId, **kwargs: Any) -> None: ...
    ...
    def get_user(self, username: Username, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> UserResult: ...
    def search_users(self, *, data: UserSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> UserSearchResult: ...
    ...
    def search_user_task_effective_variables(self, user_task_key: UserTaskKey, *, data: UserTaskEffectiveVariableSearchQueryRequest | Unset = UNSET, truncate_values: bool | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> VariableSearchQueryResult: ...
    def search_user_task_variables(self, user_task_key: UserTaskKey, *, data: UserTaskVariableSearchQueryRequest | Unset = UNSET, truncate_values: bool | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> VariableSearchQueryResult: ...
    ...
    def search_variables(self, *, data: VariableSearchQuery | Unset = UNSET, truncate_values: bool | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> VariableSearchQueryResult: ...
class CamundaAsyncClient:
    ...
    async def create_agent_instance(self, *, data: AgentInstanceCreationRequest, **kwargs: Any) -> AgentInstanceCreationResult: ...
    async def get_agent_instance(self, agent_instance_key: AgentInstanceKey, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> AgentInstanceResult: ...
    async def search_agent_instances(self, *, data: AgentInstanceSearchQuery | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> AgentInstanceSearchQueryResult: ...
    async def update_agent_instance(self, agent_instance_key: AgentInstanceKey, *, data: AgentInstanceUpdateRequest, **kwargs: Any) -> None: ...
    ...
    async def search_element_instance_wait_states(self, *, data: ElementInstanceWaitStateQuery | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> ElementInstanceWaitStateQueryResult: ...
    ...
    async def get_form_by_key(self, form_key: FormKey, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> FormResult: ...
    ...
    async def assign_client_to_group(self, group_id: GroupId, client_id: ClientId, **kwargs: Any) -> None: ...
    async def assign_mapping_rule_to_group(self, group_id: GroupId, mapping_rule_id: MappingRuleId, **kwargs: Any) -> None: ...
    async def assign_user_to_group(self, group_id: GroupId, username: Username, **kwargs: Any) -> None: ...
    ...
    async def get_group(self, group_id: GroupId, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> GroupResult: ...
    async def search_clients_for_group(self, group_id: GroupId, *, data: GroupClientSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> GroupClientSearchResult: ...
    ...
    async def search_mapping_rules_for_group(self, group_id: GroupId, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> GroupMappingRuleSearchResult: ...
    async def search_roles_for_group(self, group_id: GroupId, *, data: RoleSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> GroupRoleSearchResult: ...
    async def search_users_for_group(self, group_id: GroupId, *, data: GroupUserSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> GroupUserSearchResult: ...
    async def unassign_client_from_group(self, group_id: GroupId, client_id: ClientId, **kwargs: Any) -> None: ...
    async def unassign_mapping_rule_from_group(self, group_id: GroupId, mapping_rule_id: MappingRuleId, **kwargs: Any) -> None: ...
    async def unassign_user_from_group(self, group_id: GroupId, username: Username, **kwargs: Any) -> None: ...
    async def update_group(self, group_id: GroupId, *, data: GroupUpdateRequest, **kwargs: Any) -> GroupUpdateResult: ...
    ...
    async def delete_mapping_rule(self, mapping_rule_id: MappingRuleId, **kwargs: Any) -> None: ...
    async def get_mapping_rule(self, mapping_rule_id: MappingRuleId, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> MappingRuleResult: ...
    async def search_mapping_rule(self, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> MappingRuleSearchQueryResult: ...
    async def update_mapping_rule(self, mapping_rule_id: MappingRuleId, *, data: MappingRuleUpdateRequest | Unset = UNSET, **kwargs: Any) -> MappingRuleUpdateResult: ...
    ...
    async def get_resource_content(self, resource_key: str, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> GetResourceContentResponse200: ...
    async def get_resource_content_binary(self, resource_key: str, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> File: ...
    ...
    async def assign_role_to_client(self, role_id: RoleId, client_id: ClientId, **kwargs: Any) -> None: ...
    async def assign_role_to_group(self, role_id: RoleId, group_id: GroupId, **kwargs: Any) -> None: ...
    async def assign_role_to_mapping_rule(self, role_id: RoleId, mapping_rule_id: MappingRuleId, **kwargs: Any) -> None: ...
    async def assign_role_to_user(self, role_id: RoleId, username: Username, **kwargs: Any) -> None: ...
    ...
    async def get_role(self, role_id: RoleId, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> RoleResult: ...
    async def search_clients_for_role(self, role_id: RoleId, *, data: RoleClientSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> RoleClientSearchResult: ...
    async def search_groups_for_role(self, role_id: RoleId, *, data: RoleGroupSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> RoleGroupSearchResult: ...
    async def search_mapping_rules_for_role(self, role_id: RoleId, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> RoleMappingRuleSearchResult: ...
    ...
    async def search_users_for_role(self, role_id: RoleId, *, data: RoleUserSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> RoleUserSearchResult: ...
    async def unassign_role_from_client(self, role_id: RoleId, client_id: ClientId, **kwargs: Any) -> None: ...
    async def unassign_role_from_group(self, role_id: RoleId, group_id: GroupId, **kwargs: Any) -> None: ...
    async def unassign_role_from_mapping_rule(self, role_id: RoleId, mapping_rule_id: MappingRuleId, **kwargs: Any) -> None: ...
    async def unassign_role_from_user(self, role_id: RoleId, username: Username, **kwargs: Any) -> None: ...
    async def update_role(self, role_id: RoleId, *, data: RoleUpdateRequest, **kwargs: Any) -> RoleUpdateResult: ...
    ...
    async def assign_client_to_tenant(self, tenant_id: TenantId, client_id: ClientId, **kwargs: Any) -> None: ...
    async def assign_group_to_tenant(self, tenant_id: TenantId, group_id: GroupId, **kwargs: Any) -> None: ...
    async def assign_mapping_rule_to_tenant(self, tenant_id: TenantId, mapping_rule_id: MappingRuleId, **kwargs: Any) -> None: ...
    async def assign_role_to_tenant(self, tenant_id: TenantId, role_id: RoleId, **kwargs: Any) -> None: ...
    ...
    async def search_clients_for_tenant(self, tenant_id: TenantId, *, data: TenantClientSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> TenantClientSearchResult: ...
    ...
    async def search_mapping_rules_for_tenant(self, tenant_id: TenantId, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> TenantMappingRuleSearchResult: ...
    async def search_roles_for_tenant(self, tenant_id: TenantId, *, data: RoleSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> TenantRoleSearchResult: ...
    ...
    async def search_users_for_tenant(self, tenant_id: TenantId, *, data: TenantUserSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> TenantUserSearchResult: ...
    async def unassign_client_from_tenant(self, tenant_id: TenantId, client_id: ClientId, **kwargs: Any) -> None: ...
    async def unassign_group_from_tenant(self, tenant_id: TenantId, group_id: GroupId, **kwargs: Any) -> None: ...
    async def unassign_mapping_rule_from_tenant(self, tenant_id: TenantId, mapping_rule_id: MappingRuleId, **kwargs: Any) -> None: ...
    async def unassign_role_from_tenant(self, tenant_id: TenantId, role_id: RoleId, **kwargs: Any) -> None: ...
    ...
    async def get_user(self, username: Username, *, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> UserResult: ...
    async def search_users(self, *, data: UserSearchQueryRequest | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> UserSearchResult: ...
    ...
    async def search_user_task_effective_variables(self, user_task_key: UserTaskKey, *, data: UserTaskEffectiveVariableSearchQueryRequest | Unset = UNSET, truncate_values: bool | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> VariableSearchQueryResult: ...
    async def search_user_task_variables(self, user_task_key: UserTaskKey, *, data: UserTaskVariableSearchQueryRequest | Unset = UNSET, truncate_values: bool | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> VariableSearchQueryResult: ...
    ...
    async def search_variables(self, *, data: VariableSearchQuery | Unset = UNSET, truncate_values: bool | Unset = UNSET, consistency: ConsistencyOptions | None = None, **kwargs: Any) -> VariableSearchQueryResult: ...

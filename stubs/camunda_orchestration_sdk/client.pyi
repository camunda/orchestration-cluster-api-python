...
class CamundaClient:
    ...
    def delete_decision_instance(self, decision_instance_key: DecisionInstanceKey, data: DeleteDecisionInstanceDataType0 | None | Unset = UNSET, **kwargs: Any) -> BatchOperationCreatedResult: ...
...
class CamundaAsyncClient:
    ...
    async def delete_decision_instance(self, decision_instance_key: DecisionInstanceKey, data: DeleteDecisionInstanceDataType0 | None | Unset = UNSET, **kwargs: Any) -> BatchOperationCreatedResult: ...

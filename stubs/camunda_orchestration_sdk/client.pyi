...
class CamundaClient:
    ...
    def get_audit_log(self, audit_log_key: AuditLogKey, **kwargs: Any) -> AuditLogResult: ...
    def search_audit_logs(self, *, data: AuditLogSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> AuditLogSearchQueryResult: ...
    ...
    def search_batch_operation_items(self, *, data: BatchOperationItemSearchQuery | Unset = UNSET, **kwargs: Any) -> BatchOperationItemSearchQueryResult: ...
    def search_batch_operations(self, *, data: BatchOperationSearchQuery | Unset = UNSET, **kwargs: Any) -> BatchOperationSearchQueryResult: ...
    ...
    def delete_decision_instance(self, decision_evaluation_key: DecisionEvaluationKey, *, data: DeleteDecisionInstanceRequest | None | Unset = UNSET, **kwargs: Any) -> None: ...
    ...
    def get_global_task_listener(self, id: str, **kwargs: Any) -> GlobalTaskListenerResult: ...
    def search_global_task_listeners(self, *, data: GlobalTaskListenerSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> GlobalTaskListenerSearchQueryResult: ...
    ...
    def search_clients_for_group(self, group_id: str, *, data: GroupClientSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> GroupClientSearchResult: ...
    def search_groups(self, *, data: GroupSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> GroupSearchQueryResult: ...
    def search_mapping_rules_for_group(self, group_id: str, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> GroupMappingRuleSearchResult: ...
    def search_roles_for_group(self, group_id: str, *, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> GroupRoleSearchResult: ...
    def search_users_for_group(self, group_id: str, *, data: GroupUserSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> GroupUserSearchResult: ...
    ...
    def get_job_error_statistics(self, *, data: JobErrorStatisticsQuery, **kwargs: Any) -> JobErrorStatisticsQueryResult: ...
    def get_job_time_series_statistics(self, *, data: JobTimeSeriesStatisticsQuery, **kwargs: Any) -> JobTimeSeriesStatisticsQueryResult: ...
    def get_job_type_statistics(self, *, data: JobTypeStatisticsQuery, **kwargs: Any) -> JobTypeStatisticsQueryResult: ...
    def get_job_worker_statistics(self, *, data: JobWorkerStatisticsQuery, **kwargs: Any) -> JobWorkerStatisticsQueryResult: ...
    def search_jobs(self, *, data: JobSearchQuery | Unset = UNSET, **kwargs: Any) -> JobSearchQueryResult: ...
    ...
    def create_mapping_rule(self, *, data: MappingRuleCreateRequest | Unset = UNSET, **kwargs: Any) -> MappingRuleCreateResult: ...
    ...
    def search_message_subscriptions(self, *, data: MessageSubscriptionSearchQuery | Unset = UNSET, **kwargs: Any) -> MessageSubscriptionSearchQueryResult: ...
    ...
    def get_process_definition_instance_version_statistics(self, *, data: ProcessDefinitionInstanceVersionStatisticsQuery, **kwargs: Any) -> ProcessDefinitionInstanceVersionStatisticsQueryResult: ...
    ...
    def get_process_definition_statistics(self, process_definition_key: ProcessDefinitionKey, *, data: ProcessDefinitionElementStatisticsQuery | Unset = UNSET, **kwargs: Any) -> ProcessDefinitionElementStatisticsQueryResult: ...
    def get_process_definition_xml(self, process_definition_key: ProcessDefinitionKey, **kwargs: Any) -> str: ...
    def get_start_process_form(self, process_definition_key: ProcessDefinitionKey, **kwargs: Any) -> FormResult: ...
    def search_process_definitions(self, *, data: ProcessDefinitionSearchQuery | Unset = UNSET, **kwargs: Any) -> ProcessDefinitionSearchQueryResult: ...
    def cancel_process_instance(self, process_instance_key: ProcessInstanceKey, *, data: CancelProcessInstanceRequest | None | Unset = UNSET, **kwargs: Any) -> None: ...
    ...
    def delete_process_instance(self, process_instance_key: ProcessInstanceKey, *, data: DeleteProcessInstanceRequest | None | Unset = UNSET, **kwargs: Any) -> None: ...
    ...
    def get_process_instance(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> ProcessInstanceResult: ...
    def get_process_instance_call_hierarchy(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> list[Any]: ...
    def get_process_instance_sequence_flows(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> ProcessInstanceSequenceFlowsQueryResult: ...
    def get_process_instance_statistics(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> ProcessInstanceElementStatisticsQueryResult: ...
    ...
    def search_process_instances(self, *, data: ProcessInstanceSearchQuery | Unset = UNSET, **kwargs: Any) -> ProcessInstanceSearchQueryResult: ...
    ...
    def search_clients_for_role(self, role_id: str, *, data: RoleClientSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> RoleClientSearchResult: ...
    def search_groups_for_role(self, role_id: str, *, data: RoleGroupSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> RoleGroupSearchResult: ...
    def search_mapping_rules_for_role(self, role_id: str, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> RoleMappingRuleSearchResult: ...
    def search_roles(self, *, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> RoleSearchQueryResult: ...
    def search_users_for_role(self, role_id: str, *, data: RoleUserSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> RoleUserSearchResult: ...
    ...
    def get_usage_metrics(self, *, start_time: datetime.datetime, end_time: datetime.datetime, tenant_id: str | Unset = UNSET, with_tenants: bool | Unset = UNSET, **kwargs: Any) -> UsageMetricsResponse: ...
    ...
    def search_clients_for_tenant(self, tenant_id: TenantId, *, data: TenantClientSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> TenantClientSearchResult: ...
    def search_group_ids_for_tenant(self, tenant_id: TenantId, *, data: TenantGroupSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> TenantGroupSearchResult: ...
    def search_mapping_rules_for_tenant(self, tenant_id: TenantId, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> TenantMappingRuleSearchResult: ...
    def search_roles_for_tenant(self, tenant_id: TenantId, *, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> TenantRoleSearchResult: ...
    def search_tenants(self, *, data: TenantSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> TenantSearchQueryResult: ...
    def search_users_for_tenant(self, tenant_id: TenantId, *, data: TenantUserSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> TenantUserSearchResult: ...
    ...
    def search_users(self, *, data: UserSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> UserSearchResult: ...
    def update_user(self, username: Username, *, data: UserUpdateRequest, **kwargs: Any) -> UserUpdateResult: ...
    ...
    def get_user_task(self, user_task_key: UserTaskKey, **kwargs: Any) -> UserTaskResult: ...
    def get_user_task_form(self, user_task_key: UserTaskKey, **kwargs: Any) -> FormResult: ...
    def search_user_task_audit_logs(self, user_task_key: UserTaskKey, *, data: UserTaskAuditLogSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> AuditLogSearchQueryResult: ...
    def search_user_task_effective_variables(self, user_task_key: UserTaskKey, *, data: UserTaskEffectiveVariableSearchQueryRequest | Unset = UNSET, truncate_values: bool | Unset = UNSET, **kwargs: Any) -> VariableSearchQueryResult: ...
    def search_user_task_variables(self, user_task_key: UserTaskKey, *, data: UserTaskVariableSearchQueryRequest | Unset = UNSET, truncate_values: bool | Unset = UNSET, **kwargs: Any) -> VariableSearchQueryResult: ...
    def search_user_tasks(self, *, data: UserTaskSearchQuery | Unset = UNSET, **kwargs: Any) -> UserTaskSearchQueryResult: ...
    ...
    def search_variables(self, *, data: VariableSearchQuery | Unset = UNSET, truncate_values: bool | Unset = UNSET, **kwargs: Any) -> VariableSearchQueryResult: ...
class CamundaAsyncClient:
    ...
    async def get_audit_log(self, audit_log_key: AuditLogKey, **kwargs: Any) -> AuditLogResult: ...
    async def search_audit_logs(self, *, data: AuditLogSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> AuditLogSearchQueryResult: ...
    ...
    async def search_batch_operation_items(self, *, data: BatchOperationItemSearchQuery | Unset = UNSET, **kwargs: Any) -> BatchOperationItemSearchQueryResult: ...
    async def search_batch_operations(self, *, data: BatchOperationSearchQuery | Unset = UNSET, **kwargs: Any) -> BatchOperationSearchQueryResult: ...
    ...
    async def delete_decision_instance(self, decision_evaluation_key: DecisionEvaluationKey, *, data: DeleteDecisionInstanceRequest | None | Unset = UNSET, **kwargs: Any) -> None: ...
    ...
    async def get_global_task_listener(self, id: str, **kwargs: Any) -> GlobalTaskListenerResult: ...
    async def search_global_task_listeners(self, *, data: GlobalTaskListenerSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> GlobalTaskListenerSearchQueryResult: ...
    ...
    async def search_clients_for_group(self, group_id: str, *, data: GroupClientSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> GroupClientSearchResult: ...
    async def search_groups(self, *, data: GroupSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> GroupSearchQueryResult: ...
    async def search_mapping_rules_for_group(self, group_id: str, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> GroupMappingRuleSearchResult: ...
    async def search_roles_for_group(self, group_id: str, *, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> GroupRoleSearchResult: ...
    async def search_users_for_group(self, group_id: str, *, data: GroupUserSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> GroupUserSearchResult: ...
    ...
    async def get_job_error_statistics(self, *, data: JobErrorStatisticsQuery, **kwargs: Any) -> JobErrorStatisticsQueryResult: ...
    async def get_job_time_series_statistics(self, *, data: JobTimeSeriesStatisticsQuery, **kwargs: Any) -> JobTimeSeriesStatisticsQueryResult: ...
    async def get_job_type_statistics(self, *, data: JobTypeStatisticsQuery, **kwargs: Any) -> JobTypeStatisticsQueryResult: ...
    async def get_job_worker_statistics(self, *, data: JobWorkerStatisticsQuery, **kwargs: Any) -> JobWorkerStatisticsQueryResult: ...
    async def search_jobs(self, *, data: JobSearchQuery | Unset = UNSET, **kwargs: Any) -> JobSearchQueryResult: ...
    ...
    async def create_mapping_rule(self, *, data: MappingRuleCreateRequest | Unset = UNSET, **kwargs: Any) -> MappingRuleCreateResult: ...
    ...
    async def search_message_subscriptions(self, *, data: MessageSubscriptionSearchQuery | Unset = UNSET, **kwargs: Any) -> MessageSubscriptionSearchQueryResult: ...
    ...
    async def get_process_definition_instance_version_statistics(self, *, data: ProcessDefinitionInstanceVersionStatisticsQuery, **kwargs: Any) -> ProcessDefinitionInstanceVersionStatisticsQueryResult: ...
    ...
    async def get_process_definition_statistics(self, process_definition_key: ProcessDefinitionKey, *, data: ProcessDefinitionElementStatisticsQuery | Unset = UNSET, **kwargs: Any) -> ProcessDefinitionElementStatisticsQueryResult: ...
    async def get_process_definition_xml(self, process_definition_key: ProcessDefinitionKey, **kwargs: Any) -> str: ...
    async def get_start_process_form(self, process_definition_key: ProcessDefinitionKey, **kwargs: Any) -> FormResult: ...
    async def search_process_definitions(self, *, data: ProcessDefinitionSearchQuery | Unset = UNSET, **kwargs: Any) -> ProcessDefinitionSearchQueryResult: ...
    async def cancel_process_instance(self, process_instance_key: ProcessInstanceKey, *, data: CancelProcessInstanceRequest | None | Unset = UNSET, **kwargs: Any) -> None: ...
    ...
    async def delete_process_instance(self, process_instance_key: ProcessInstanceKey, *, data: DeleteProcessInstanceRequest | None | Unset = UNSET, **kwargs: Any) -> None: ...
    ...
    async def get_process_instance(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> ProcessInstanceResult: ...
    async def get_process_instance_call_hierarchy(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> list[Any]: ...
    async def get_process_instance_sequence_flows(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> ProcessInstanceSequenceFlowsQueryResult: ...
    async def get_process_instance_statistics(self, process_instance_key: ProcessInstanceKey, **kwargs: Any) -> ProcessInstanceElementStatisticsQueryResult: ...
    ...
    async def search_process_instances(self, *, data: ProcessInstanceSearchQuery | Unset = UNSET, **kwargs: Any) -> ProcessInstanceSearchQueryResult: ...
    ...
    async def search_clients_for_role(self, role_id: str, *, data: RoleClientSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> RoleClientSearchResult: ...
    async def search_groups_for_role(self, role_id: str, *, data: RoleGroupSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> RoleGroupSearchResult: ...
    async def search_mapping_rules_for_role(self, role_id: str, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> RoleMappingRuleSearchResult: ...
    async def search_roles(self, *, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> RoleSearchQueryResult: ...
    async def search_users_for_role(self, role_id: str, *, data: RoleUserSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> RoleUserSearchResult: ...
    ...
    async def get_usage_metrics(self, *, start_time: datetime.datetime, end_time: datetime.datetime, tenant_id: str | Unset = UNSET, with_tenants: bool | Unset = UNSET, **kwargs: Any) -> UsageMetricsResponse: ...
    ...
    async def search_clients_for_tenant(self, tenant_id: TenantId, *, data: TenantClientSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> TenantClientSearchResult: ...
    async def search_group_ids_for_tenant(self, tenant_id: TenantId, *, data: TenantGroupSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> TenantGroupSearchResult: ...
    async def search_mapping_rules_for_tenant(self, tenant_id: TenantId, *, data: MappingRuleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> TenantMappingRuleSearchResult: ...
    async def search_roles_for_tenant(self, tenant_id: TenantId, *, data: RoleSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> TenantRoleSearchResult: ...
    async def search_tenants(self, *, data: TenantSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> TenantSearchQueryResult: ...
    async def search_users_for_tenant(self, tenant_id: TenantId, *, data: TenantUserSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> TenantUserSearchResult: ...
    ...
    async def search_users(self, *, data: UserSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> UserSearchResult: ...
    async def update_user(self, username: Username, *, data: UserUpdateRequest, **kwargs: Any) -> UserUpdateResult: ...
    ...
    async def get_user_task(self, user_task_key: UserTaskKey, **kwargs: Any) -> UserTaskResult: ...
    async def get_user_task_form(self, user_task_key: UserTaskKey, **kwargs: Any) -> FormResult: ...
    async def search_user_task_audit_logs(self, user_task_key: UserTaskKey, *, data: UserTaskAuditLogSearchQueryRequest | Unset = UNSET, **kwargs: Any) -> AuditLogSearchQueryResult: ...
    async def search_user_task_effective_variables(self, user_task_key: UserTaskKey, *, data: UserTaskEffectiveVariableSearchQueryRequest | Unset = UNSET, truncate_values: bool | Unset = UNSET, **kwargs: Any) -> VariableSearchQueryResult: ...
    async def search_user_task_variables(self, user_task_key: UserTaskKey, *, data: UserTaskVariableSearchQueryRequest | Unset = UNSET, truncate_values: bool | Unset = UNSET, **kwargs: Any) -> VariableSearchQueryResult: ...
    async def search_user_tasks(self, *, data: UserTaskSearchQuery | Unset = UNSET, **kwargs: Any) -> UserTaskSearchQueryResult: ...
    ...
    async def search_variables(self, *, data: VariableSearchQuery | Unset = UNSET, truncate_values: bool | Unset = UNSET, **kwargs: Any) -> VariableSearchQueryResult: ...

...
class CamundaClient:
    ...
    def search_resources(self, *, data: ResourceSearchQuery | Unset = UNSET, **kwargs: Any) -> ResourceSearchQueryResult: ...
    ...
    def search_user_task_effective_variables(self, user_task_key: UserTaskKey, *, data: SearchUserTaskEffectiveVariablesData | Unset = UNSET, truncate_values: bool | Unset = UNSET, **kwargs: Any) -> VariableSearchQueryResult: ...
...
class CamundaAsyncClient:
    ...
    async def search_resources(self, *, data: ResourceSearchQuery | Unset = UNSET, **kwargs: Any) -> ResourceSearchQueryResult: ...
    ...
    async def search_user_task_effective_variables(self, user_task_key: UserTaskKey, *, data: SearchUserTaskEffectiveVariablesData | Unset = UNSET, truncate_values: bool | Unset = UNSET, **kwargs: Any) -> VariableSearchQueryResult: ...

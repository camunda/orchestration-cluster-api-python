...
class OAuthClientCredentialsAuthProvider:
    def __init__(self, oauth_url: str, client_id: str, client_secret: str, audience: str, cache_dir: str | None = None, disk_cache_disable: bool = False, saas_401_cooldown_s: float = _SAAS_401_COOLDOWN_S_DEFAULT, transport: httpx.BaseTransport | None = None, timeout: float | None = None, logger: SdkLogger | None = None) -> None: ...
    def close(self) -> None: ...
...
class AsyncOAuthClientCredentialsAuthProvider:
    def __init__(self, oauth_url: str, client_id: str, client_secret: str, audience: str, cache_dir: str | None = None, disk_cache_disable: bool = False, saas_401_cooldown_s: float = _SAAS_401_COOLDOWN_S_DEFAULT, transport: httpx.AsyncBaseTransport | None = None, timeout: float | None = None, logger: SdkLogger | None = None) -> None: ...

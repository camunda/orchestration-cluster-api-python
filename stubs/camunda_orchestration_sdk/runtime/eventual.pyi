...
def eventual_poll(operation_id: str, is_get: bool, invoke: Callable[[], Any], options: ConsistencyOptions) -> Any: ...
async def eventual_poll_async(operation_id: str, is_get: bool, invoke: Callable[[], Any], options: ConsistencyOptions) -> Any: ...

...
class AuditLogResult:
    ...
    Attributes:
        ...
        batch_operation_type (AuditLogResultBatchOperationType | Unset): The type of batch operation performed, if this
            is part of a batch.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_operation_type: AuditLogResultBatchOperationType | Unset

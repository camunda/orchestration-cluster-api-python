...
from ..models.tenant_search_query_sort_request_field import (
    TenantSearchQuerySortRequestField,
)
from ..types import UNSET, Unset, str_any_dict_factory

T = TypeVar("T", bound="TenantSearchQuerySortRequest")
...
class TenantSearchQuerySortRequest:
    ...
    field: TenantSearchQuerySortRequestField
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        field = TenantSearchQuerySortRequestField(d.pop("field"))
        ...
        tenant_search_query_sort_request = cls(
            field=field,
            order=order,
        )

        tenant_search_query_sort_request.additional_properties = d
        return tenant_search_query_sort_request

...
if TYPE_CHECKING:
    ...
    from ..models.job_worker_statistics_filter import JobWorkerStatisticsFilter


T = TypeVar("T", bound="JobWorkerStatisticsQuery")


@_attrs_define
class JobWorkerStatisticsQuery:
    """Job worker statistics query.

    Attributes:
        filter_ (JobWorkerStatisticsFilter): Job worker statistics search filter.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        filter_ = JobWorkerStatisticsFilter.from_dict(d.pop("filter"))
        ...
        job_worker_statistics_query = cls(
            filter_=filter_,
            page=page,
        )

        job_worker_statistics_query.additional_properties = d
        return job_worker_statistics_query

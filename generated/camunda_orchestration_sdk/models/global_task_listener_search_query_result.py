...
T = TypeVar("T", bound="GlobalTaskListenerSearchQueryResult")


@_attrs_define
class GlobalTaskListenerSearchQueryResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = GlobalTaskListenerResult.from_dict(items_item_data)

            items.append(items_item)

        page = SearchQueryPageResponse.from_dict(d.pop("page"))

        global_task_listener_search_query_result = cls(
            items=items,
            page=page,
        )

        global_task_listener_search_query_result.additional_properties = d
        return global_task_listener_search_query_result

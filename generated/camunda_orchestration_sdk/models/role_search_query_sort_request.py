...
from ..models.role_search_query_sort_request_field import (
    RoleSearchQuerySortRequestField,
)
from ..models.sort_order_enum import SortOrderEnum
from ..types import UNSET, Unset, str_any_dict_factory

T = TypeVar("T", bound="RoleSearchQuerySortRequest")


@_attrs_define
class RoleSearchQuerySortRequest:
    """
    Attributes:
    ...
    field: RoleSearchQuerySortRequestField
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role_search_query_sort_request = cls(
            field=field,
            order=order,
        )

        role_search_query_sort_request.additional_properties = d
        return role_search_query_sort_request

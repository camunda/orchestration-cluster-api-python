...
T = TypeVar("T", bound="ProcessInstanceSearchQueryFilter")


@_attrs_define
class ProcessInstanceSearchQueryFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_instance_search_query_filter = cls(
        ...
        process_instance_search_query_filter.additional_properties = d
        return process_instance_search_query_filter

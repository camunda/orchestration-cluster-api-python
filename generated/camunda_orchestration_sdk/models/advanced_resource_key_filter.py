...
T = TypeVar("T", bound="AdvancedResourceKeyFilter")


@_attrs_define
class AdvancedResourceKeyFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_resource_key_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_resource_key_filter.additional_properties = d
        return advanced_resource_key_filter

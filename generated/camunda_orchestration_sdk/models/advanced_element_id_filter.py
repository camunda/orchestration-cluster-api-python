...
T = TypeVar("T", bound="AdvancedElementIdFilter")


@_attrs_define
class AdvancedElementIdFilter:
    r"""Advanced ElementId filter.

    Attributes:
        eq (str | Unset): Checks for equality with the provided value. Example: Activity_106kosb.
        neq (str | Unset): Checks for inequality with the provided value. Example: Activity_106kosb.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_element_id_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_element_id_filter.additional_properties = d
        return advanced_element_id_filter

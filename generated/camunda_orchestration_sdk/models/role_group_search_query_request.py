...
T = TypeVar("T", bound="RoleGroupSearchQueryRequest")


@_attrs_define
class RoleGroupSearchQueryRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role_group_search_query_request = cls(
            sort=sort,
            page=page,
        )

        role_group_search_query_request.additional_properties = d
        return role_group_search_query_request

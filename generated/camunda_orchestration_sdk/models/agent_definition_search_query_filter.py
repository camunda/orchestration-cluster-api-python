...
T = TypeVar("T", bound="AgentDefinitionSearchQueryFilter")


@_attrs_define
class AgentDefinitionSearchQueryFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_definition_search_query_filter = cls(
        ...
        agent_definition_search_query_filter.additional_properties = d
        return agent_definition_search_query_filter

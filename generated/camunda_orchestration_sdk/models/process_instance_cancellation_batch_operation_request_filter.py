...
if TYPE_CHECKING:
    ...
    from ..models.process_instance_filter_fields import ProcessInstanceFilterFields
    from ..models.variable_value_filter_property import VariableValueFilterProperty


T = TypeVar("T", bound="ProcessInstanceCancellationBatchOperationRequestFilter")


@_attrs_define
class ProcessInstanceCancellationBatchOperationRequestFilter:
    """The process instance filter.

    Attributes:
        process_definition_id (AdvancedStringFilter | str | Unset): The process definition id.
        process_definition_name (AdvancedStringFilter | str | Unset): The process definition name.
        process_definition_version (AdvancedIntegerFilter | int | Unset): The process definition version.
        process_definition_version_tag (AdvancedStringFilter | str | Unset): The process definition version tag.
        process_definition_key (AdvancedProcessDefinitionKeyFilter | str | Unset): The process definition key.
        ...
        or_ (list[ProcessInstanceFilterFields] | Unset): Defines a list of alternative filter groups combined using OR
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _or_ is not UNSET:
            ...
            for or_item_data in _or_:
                or_item = ProcessInstanceFilterFields.from_dict(or_item_data)

                or_.append(or_item)

        process_instance_cancellation_batch_operation_request_filter = cls(
        ...
        process_instance_cancellation_batch_operation_request_filter.additional_properties = d
        return process_instance_cancellation_batch_operation_request_filter

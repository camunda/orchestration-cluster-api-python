...
T = TypeVar("T", bound="AdvancedAuditLogEntityKeyFilter")


@_attrs_define
class AdvancedAuditLogEntityKeyFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_audit_log_entity_key_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_audit_log_entity_key_filter.additional_properties = d
        return advanced_audit_log_entity_key_filter

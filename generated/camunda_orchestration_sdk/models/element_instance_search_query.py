...
class ElementInstanceSearchQuery:
    ...
    Attributes:
        sort (list[ElementInstanceSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (ElementInstanceSearchQueryFilter | Unset): The element instance search filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = ElementInstanceSearchQuerySortRequest.from_dict(
                    sort_item_data
                )
        ...
        filter_: ElementInstanceSearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = ElementInstanceSearchQueryFilter.from_dict(_filter_)
        ...
        element_instance_search_query = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return element_instance_search_query

...
T = TypeVar("T", bound="DeploymentMetadataResultDecisionDefinition")


@_attrs_define
class DeploymentMetadataResultDecisionDefinition:
    """Deployed decision.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deployment_metadata_result_decision_definition.additional_properties = d
        return deployment_metadata_result_decision_definition

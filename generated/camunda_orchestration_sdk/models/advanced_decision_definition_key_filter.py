...
class AdvancedDecisionDefinitionKeyFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_decision_definition_key_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_decision_definition_key_filter.additional_properties = d
        return advanced_decision_definition_key_filter

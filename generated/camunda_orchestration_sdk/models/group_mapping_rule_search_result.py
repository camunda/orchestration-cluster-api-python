...
T = TypeVar("T", bound="GroupMappingRuleSearchResult")


@_attrs_define
class GroupMappingRuleSearchResult:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        group_mapping_rule_search_result = cls(
            items=items,
            page=page,
        )

        group_mapping_rule_search_result.additional_properties = d
        return group_mapping_rule_search_result

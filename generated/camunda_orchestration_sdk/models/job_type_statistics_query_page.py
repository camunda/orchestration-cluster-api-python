...
T = TypeVar("T", bound="JobTypeStatisticsQueryPage")
...
class JobTypeStatisticsQueryPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        job_type_statistics_query_page = cls(
            after=after,
            limit=limit,
        )

        job_type_statistics_query_page.additional_properties = d
        return job_type_statistics_query_page

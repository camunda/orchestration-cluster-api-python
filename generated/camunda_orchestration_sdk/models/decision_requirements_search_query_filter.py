...
class DecisionRequirementsSearchQueryFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        decision_requirements_search_query_filter = cls(
        ...
        decision_requirements_search_query_filter.additional_properties = d
        return decision_requirements_search_query_filter

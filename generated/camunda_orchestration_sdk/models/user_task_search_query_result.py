...
T = TypeVar("T", bound="UserTaskSearchQueryResult")


@_attrs_define
class UserTaskSearchQueryResult:
    ...
    Attributes:
        ...
        items (list[UserTaskResult] | Unset): The matching user tasks.
    """

    page: SearchQueryPageResponse
    items: list[UserTaskResult] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_task_search_query_result.additional_properties = d
        return user_task_search_query_result

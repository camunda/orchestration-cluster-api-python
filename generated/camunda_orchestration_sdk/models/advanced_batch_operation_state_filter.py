...
from ..models.advanced_batch_operation_state_filter_eq import (
    AdvancedBatchOperationStateFilterEq,
)
from ..models.advanced_batch_operation_state_filter_neq import (
    AdvancedBatchOperationStateFilterNeq,
)
from ..models.batch_operation_state_enum import BatchOperationStateEnum
from ..types import UNSET, Unset, str_any_dict_factory

T = TypeVar("T", bound="AdvancedBatchOperationStateFilter")
...
class AdvancedBatchOperationStateFilter:
    ...
    Attributes:
        ...
        neq (AdvancedBatchOperationStateFilterNeq | Unset): Checks for inequality with the provided value.
        exists (bool | Unset): Checks if the current property exists.
        in_ (list[BatchOperationStateEnum] | Unset): Checks if the property matches any of the provided values.
    ...
    neq: AdvancedBatchOperationStateFilterNeq | Unset = UNSET
    exists: bool | Unset = UNSET
    in_: list[BatchOperationStateEnum] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        _eq = d.pop("$eq", UNSET)
        eq: AdvancedBatchOperationStateFilterEq | Unset
        if isinstance(_eq, Unset):
            eq = UNSET
        else:
            eq = AdvancedBatchOperationStateFilterEq(_eq)

        _neq = d.pop("$neq", UNSET)
        neq: AdvancedBatchOperationStateFilterNeq | Unset
        if isinstance(_neq, Unset):
            neq = UNSET
        else:
            neq = AdvancedBatchOperationStateFilterNeq(_neq)
        ...
        if _in_ is not UNSET:
            ...
            for in_item_data in _in_:
                in_item = BatchOperationStateEnum(in_item_data)

                in_.append(in_item)

        like = d.pop("$like", UNSET)

        advanced_batch_operation_state_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_batch_operation_state_filter.additional_properties = d
        return advanced_batch_operation_state_filter

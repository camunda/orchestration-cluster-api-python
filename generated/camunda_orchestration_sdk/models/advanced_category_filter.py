...
from ..models.advanced_category_filter_eq import AdvancedCategoryFilterEq
...
class AdvancedCategoryFilter:
    ...
    Attributes:
        ...
        neq (AdvancedCategoryFilterNeq | Unset): Checks for inequality with the provided value.
        exists (bool | Unset): Checks if the current property exists.
        in_ (list[AuditLogCategoryEnum] | Unset): Checks if the property matches any of the provided values.
    ...
    neq: AdvancedCategoryFilterNeq | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        _eq = d.pop("$eq", UNSET)
        eq: AdvancedCategoryFilterEq | Unset
        if isinstance(_eq, Unset):
            eq = UNSET
        else:
            eq = AdvancedCategoryFilterEq(_eq)

        _neq = d.pop("$neq", UNSET)
        neq: AdvancedCategoryFilterNeq | Unset
        if isinstance(_neq, Unset):
            neq = UNSET
        else:
            neq = AdvancedCategoryFilterNeq(_neq)
        ...
        if _in_ is not UNSET:
            ...
            for in_item_data in _in_:
                in_item = AuditLogCategoryEnum(in_item_data)

                in_.append(in_item)

        like = d.pop("$like", UNSET)

        advanced_category_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_category_filter.additional_properties = d
        return advanced_category_filter

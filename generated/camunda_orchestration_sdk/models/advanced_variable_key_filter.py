...
T = TypeVar("T", bound="AdvancedVariableKeyFilter")


@_attrs_define
class AdvancedVariableKeyFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_variable_key_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_variable_key_filter.additional_properties = d
        return advanced_variable_key_filter

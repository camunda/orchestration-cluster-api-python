...
T = TypeVar("T", bound="MappingRuleCreateUpdateRequest")
...
class MappingRuleCreateUpdateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mapping_rule_create_update_request = cls(
            claim_name=claim_name,
            claim_value=claim_value,
            name=name,
        )

        mapping_rule_create_update_request.additional_properties = d
        return mapping_rule_create_update_request

...
class ProcessDefinitionInstanceVersionStatisticsResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_definition_instance_version_statistics_result = cls(
        ...
        process_definition_instance_version_statistics_result.additional_properties = d
        return process_definition_instance_version_statistics_result

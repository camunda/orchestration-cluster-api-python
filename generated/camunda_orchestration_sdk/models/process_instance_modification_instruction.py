...
class ProcessInstanceModificationInstruction:
    ...
    Attributes:
        ...
        move_instructions (list[ProcessInstanceModificationMoveInstruction] | Unset): Instructions describing which
            elements to move from one scope to another.
        terminate_instructions (list[ProcessInstanceModificationTerminateByIdInstruction |
            ProcessInstanceModificationTerminateByKeyInstruction] | Unset): Instructions describing which elements to
            terminate.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        move_instructions: list[ProcessInstanceModificationMoveInstruction] | Unset = (
            UNSET
        )
        if _move_instructions is not UNSET:
            ...
            for move_instructions_item_data in _move_instructions:
                move_instructions_item = (
                    ProcessInstanceModificationMoveInstruction.from_dict(
            ...
            for terminate_instructions_item_data in _terminate_instructions:
                ...
                def _parse_terminate_instructions_item(
                    ...
                    try:
                        ...
                        componentsschemas_process_instance_modification_terminate_instruction_type_0 = ProcessInstanceModificationTerminateByIdInstruction.from_dict(
                            data
                        )

                        return componentsschemas_process_instance_modification_terminate_instruction_type_0
                    ...
                    data = cast(dict[str, Any], data)
                    componentsschemas_process_instance_modification_terminate_instruction_type_1 = ProcessInstanceModificationTerminateByKeyInstruction.from_dict(
                        data
                    )

                    return componentsschemas_process_instance_modification_terminate_instruction_type_1
        ...
        process_instance_modification_instruction = cls(
        ...
        return process_instance_modification_instruction

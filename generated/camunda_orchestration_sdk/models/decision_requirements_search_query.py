...
if TYPE_CHECKING:
    ...
    from ..models.decision_requirements_search_query_filter import (
        DecisionRequirementsSearchQueryFilter,
    )
    from ..models.decision_requirements_search_query_sort_request import (
...
T = TypeVar("T", bound="DecisionRequirementsSearchQuery")


@_attrs_define
class DecisionRequirementsSearchQuery:
    """
    Attributes:
        sort (list[DecisionRequirementsSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (DecisionRequirementsSearchQueryFilter | Unset): The decision definition search filters.
    ...
    sort: list[DecisionRequirementsSearchQuerySortRequest] | Unset = UNSET
    filter_: DecisionRequirementsSearchQueryFilter | Unset = UNSET
    page: (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = DecisionRequirementsSearchQuerySortRequest.from_dict(
                    sort_item_data
                )
        ...
        filter_: DecisionRequirementsSearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = DecisionRequirementsSearchQueryFilter.from_dict(_filter_)
        ...
        decision_requirements_search_query = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return decision_requirements_search_query

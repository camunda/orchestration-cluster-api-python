...
if TYPE_CHECKING:
    ...
    from ..models.advanced_incident_state_filter_neq import (
...
class AdvancedIncidentStateFilter:
    ...
    Attributes:
        ...
        neq (AdvancedIncidentStateFilterNeq | Unset): Checks for inequality with the provided value.
        exists (bool | Unset): Checks if the current property exists.
        in_ (list[IncidentStateEnum] | Unset): Checks if the property matches any of the provided values.
        not_in (list[IncidentStateEnum] | Unset): Checks if the property does not match any of the provided values.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.advanced_incident_state_filter_eq import (
        ...
        d = dict(src_dict)
        _eq = d.pop("$eq", UNSET)
        eq: AdvancedIncidentStateFilterEq | Unset
        if isinstance(_eq, Unset):
            eq = UNSET
        else:
            eq = AdvancedIncidentStateFilterEq.from_dict(_eq)

        _neq = d.pop("$neq", UNSET)
        neq: AdvancedIncidentStateFilterNeq | Unset
        if isinstance(_neq, Unset):
            neq = UNSET
        else:
            neq = AdvancedIncidentStateFilterNeq.from_dict(_neq)
        ...
        if _in_ is not UNSET:
            ...
            for in_item_data in _in_:
                in_item = IncidentStateEnum(in_item_data)
        ...
        if _not_in is not UNSET:
            ...
            for not_in_item_data in _not_in:
                not_in_item = IncidentStateEnum(not_in_item_data)

                not_in.append(not_in_item)

        like = d.pop("$like", UNSET)

        advanced_incident_state_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_incident_state_filter.additional_properties = d
        return advanced_incident_state_filter

...
T = TypeVar("T", bound="GetGlobalJobStatisticsResponse500")


@_attrs_define
class GetGlobalJobStatisticsResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_global_job_statistics_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_global_job_statistics_response_500.additional_properties = d
        return get_global_job_statistics_response_500

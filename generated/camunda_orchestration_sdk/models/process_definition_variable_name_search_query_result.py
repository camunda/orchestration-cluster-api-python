...
class ProcessDefinitionVariableNameSearchQueryResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ProcessDefinitionVariableNameSearchResult.from_dict(
                items_item_data
            )
        ...
        process_definition_variable_name_search_query_result = cls(
            items=items,
            page=page,
        )

        process_definition_variable_name_search_query_result.additional_properties = d
        return process_definition_variable_name_search_query_result

...
T = TypeVar("T", bound="NameAdvancedFilter")


@_attrs_define
class NameAdvancedFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        name_advanced_filter.additional_properties = d
        return name_advanced_filter

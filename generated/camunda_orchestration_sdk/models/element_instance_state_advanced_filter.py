...
class ElementInstanceStateAdvancedFilter:
    ...
    Attributes:
        eq (ElementInstanceStateAdvancedFilterEq | Unset): Checks for equality with the provided value.
        neq (ElementInstanceStateAdvancedFilterNeq | Unset): Checks for inequality with the provided value.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        _eq = d.pop("$eq", UNSET)
        eq: ElementInstanceStateAdvancedFilterEq | Unset
        if isinstance(_eq, Unset):
            eq = UNSET
        else:
            eq = ElementInstanceStateAdvancedFilterEq(_eq)

        _neq = d.pop("$neq", UNSET)
        neq: ElementInstanceStateAdvancedFilterNeq | Unset
        if isinstance(_neq, Unset):
            neq = UNSET
        else:
            neq = ElementInstanceStateAdvancedFilterNeq(_neq)
        ...
        element_instance_state_advanced_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        element_instance_state_advanced_filter.additional_properties = d
        return element_instance_state_advanced_filter

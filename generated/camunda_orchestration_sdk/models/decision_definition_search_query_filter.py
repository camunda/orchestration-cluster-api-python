...
T = TypeVar("T", bound="DecisionDefinitionSearchQueryFilter")


@_attrs_define
class DecisionDefinitionSearchQueryFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        decision_definition_search_query_filter = cls(
        ...
        decision_definition_search_query_filter.additional_properties = d
        return decision_definition_search_query_filter

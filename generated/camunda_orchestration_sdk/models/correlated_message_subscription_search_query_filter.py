...
T = TypeVar("T", bound="CorrelatedMessageSubscriptionSearchQueryFilter")


@_attrs_define
class CorrelatedMessageSubscriptionSearchQueryFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        correlated_message_subscription_search_query_filter = cls(
        ...
        correlated_message_subscription_search_query_filter.additional_properties = d
        return correlated_message_subscription_search_query_filter

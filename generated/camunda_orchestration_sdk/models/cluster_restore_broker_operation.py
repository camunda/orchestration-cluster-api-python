...
T = TypeVar("T", bound="ClusterRestoreBrokerOperation")


@_attrs_define
class ClusterRestoreBrokerOperation:
    """A restore operation that applies to a broker as a whole, such as the one that updates its incarnation number.

    Attributes:
        operation (str): The type of the operation. Example: UpdateIncarnationNumberOperation.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cluster_restore_broker_operation.additional_properties = d
        return cluster_restore_broker_operation

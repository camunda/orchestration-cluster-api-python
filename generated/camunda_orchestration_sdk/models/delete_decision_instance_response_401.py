...
T = TypeVar("T", bound="DeleteDecisionInstanceResponse401")


@_attrs_define
class DeleteDecisionInstanceResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_decision_instance_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_decision_instance_response_401.additional_properties = d
        return delete_decision_instance_response_401

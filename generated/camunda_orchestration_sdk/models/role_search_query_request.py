...
class RoleSearchQueryRequest:
    ...
    Attributes:
        sort (list[RoleSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (RoleSearchQueryRequestFilter | Unset): The role search filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.limit_based_pagination import LimitBasedPagination
        from ..models.offset_based_pagination import OffsetBasedPagination
        from ..models.role_search_query_request_filter import (
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = RoleSearchQuerySortRequest.from_dict(sort_item_data)

                sort.append(sort_item)

        _filter_ = d.pop("filter", UNSET)
        filter_: RoleSearchQueryRequestFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = RoleSearchQueryRequestFilter.from_dict(_filter_)
        ...
        role_search_query_request = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return role_search_query_request

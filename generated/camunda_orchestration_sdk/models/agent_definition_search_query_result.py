...
T = TypeVar("T", bound="AgentDefinitionSearchQueryResult")


@_attrs_define
class AgentDefinitionSearchQueryResult:
    ...
    items: list[AgentDefinitionResult]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = AgentDefinitionResult.from_dict(items_item_data)

            items.append(items_item)

        page = SearchQueryPageResponse.from_dict(d.pop("page"))

        agent_definition_search_query_result = cls(
            items=items,
            page=page,
        )

        agent_definition_search_query_result.additional_properties = d
        return agent_definition_search_query_result

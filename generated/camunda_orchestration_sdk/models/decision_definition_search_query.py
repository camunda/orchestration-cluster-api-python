...
if TYPE_CHECKING:
    ...
    from ..models.decision_definition_search_query_filter import (
        DecisionDefinitionSearchQueryFilter,
    )
    from ..models.decision_definition_search_query_sort_request import (
...
class DecisionDefinitionSearchQuery:
    """
    Attributes:
        sort (list[DecisionDefinitionSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (DecisionDefinitionSearchQueryFilter | Unset): The decision definition search filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = DecisionDefinitionSearchQuerySortRequest.from_dict(
                    sort_item_data
                )
        ...
        filter_: DecisionDefinitionSearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = DecisionDefinitionSearchQueryFilter.from_dict(_filter_)
        ...
        decision_definition_search_query = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return decision_definition_search_query

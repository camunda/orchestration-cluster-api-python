...
if TYPE_CHECKING:
    ...
    from ..models.process_definition_variable_name_search_query_filter import (
        ProcessDefinitionVariableNameSearchQueryFilter,
    )


T = TypeVar("T", bound="ProcessDefinitionVariableNameSearchQuery")


@_attrs_define
class ProcessDefinitionVariableNameSearchQuery:
    """Process definition variable name search query request.

    Attributes:
        filter_ (ProcessDefinitionVariableNameSearchQueryFilter | Unset): The process definition variable name search
            filters.
    ...
    filter_: ProcessDefinitionVariableNameSearchQueryFilter | Unset = UNSET
    page: (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filter_: ProcessDefinitionVariableNameSearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = ProcessDefinitionVariableNameSearchQueryFilter.from_dict(_filter_)
        ...
        process_definition_variable_name_search_query = cls(
            filter_=filter_,
            page=page,
        )

        return process_definition_variable_name_search_query

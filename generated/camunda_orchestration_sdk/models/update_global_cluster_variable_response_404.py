...
T = TypeVar("T", bound="UpdateGlobalClusterVariableResponse404")


@_attrs_define
class UpdateGlobalClusterVariableResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_global_cluster_variable_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        update_global_cluster_variable_response_404.additional_properties = d
        return update_global_cluster_variable_response_404

...
T = TypeVar("T", bound="ProcessDefinitionInstanceVersionStatisticsQueryResult")


@_attrs_define
class ProcessDefinitionInstanceVersionStatisticsQueryResult:
    """
    Attributes:
        page (SearchQueryPageResponse): Pagination information about the search results. Example: {'totalItems': 1,
            'hasMoreTotalItems': False}.
        items (list[ProcessDefinitionInstanceVersionStatisticsResult] | Unset): The process definition instance version
            statistics result.
    """

    page: SearchQueryPageResponse
    items: list[ProcessDefinitionInstanceVersionStatisticsResult] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_definition_instance_version_statistics_query_result.additional_properties = d
        return process_definition_instance_version_statistics_query_result

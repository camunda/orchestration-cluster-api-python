...
from ..models.search_batch_operations_filter_actor_type import (
...
class SearchBatchOperationsFilter:
    ...
    Attributes:
        ...
        operation_type (BatchOperationTypeExactMatch | OperationTypeAdvancedFilter | Unset):
        state (AdvancedBatchOperationStateFilter | BatchOperationStateExactMatch | Unset):
        actor_type (SearchBatchOperationsFilterActorType | Unset): The type of the actor who performed the operation.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        actor_type: SearchBatchOperationsFilterActorType | Unset
        if isinstance(_actor_type, Unset):
            actor_type = UNSET
        else:
            actor_type = SearchBatchOperationsFilterActorType(_actor_type)
        ...
        search_batch_operations_filter = cls(
        ...
        search_batch_operations_filter.additional_properties = d
        return search_batch_operations_filter

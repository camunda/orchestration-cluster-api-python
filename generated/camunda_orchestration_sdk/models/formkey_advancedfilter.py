...
T = TypeVar("T", bound="FormkeyAdvancedfilter")


@_attrs_define
class FormkeyAdvancedfilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        formkey_advancedfilter.additional_properties = d
        return formkey_advancedfilter

...
T = TypeVar("T", bound="ProcessDefinitionElementStatisticsQueryResult")
...
class ProcessDefinitionElementStatisticsQueryResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_definition_element_statistics_query_result = cls(
            items=items,
        )

        process_definition_element_statistics_query_result.additional_properties = d
        return process_definition_element_statistics_query_result

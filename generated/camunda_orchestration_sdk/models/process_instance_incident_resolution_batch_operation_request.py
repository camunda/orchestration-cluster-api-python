...
T = TypeVar("T", bound="ProcessInstanceIncidentResolutionBatchOperationRequest")


@_attrs_define
class ProcessInstanceIncidentResolutionBatchOperationRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_instance_incident_resolution_batch_operation_request = cls(
            filter_=filter_,
            operation_reference=operation_reference,
        )

        return process_instance_incident_resolution_batch_operation_request

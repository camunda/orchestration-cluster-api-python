...
T = TypeVar("T", bound="MappingRuleUpdateResult")


@_attrs_define
class MappingRuleUpdateResult:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mapping_rule_update_result = cls(
        ...
        mapping_rule_update_result.additional_properties = d
        return mapping_rule_update_result

...
T = TypeVar("T", bound="RoleUserSearchQueryRequest")


@_attrs_define
class RoleUserSearchQueryRequest:
    """
    Attributes:
        sort (list[RoleUserSearchQuerySortRequest] | Unset): Sort field criteria.
    ...
    sort: list[RoleUserSearchQuerySortRequest] | Unset = UNSET
    page: (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = RoleUserSearchQuerySortRequest.from_dict(sort_item_data)
        ...
        role_user_search_query_request = cls(
            sort=sort,
            page=page,
        )

        role_user_search_query_request.additional_properties = d
        return role_user_search_query_request

...
T = TypeVar("T", bound="AdvancedMessageSubscriptionKeyFilter")


@_attrs_define
class AdvancedMessageSubscriptionKeyFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_message_subscription_key_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_message_subscription_key_filter.additional_properties = d
        return advanced_message_subscription_key_filter

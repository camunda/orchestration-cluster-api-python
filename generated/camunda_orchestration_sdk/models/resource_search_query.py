...
if TYPE_CHECKING:
    ...
    from ..models.resource_search_query_filter import ResourceSearchQueryFilter
    from ..models.resource_search_query_sort_request import (
        ResourceSearchQuerySortRequest,
    )


T = TypeVar("T", bound="ResourceSearchQuery")
...
class ResourceSearchQuery:
    """
    Attributes:
        sort (list[ResourceSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (ResourceSearchQueryFilter | Unset): The resource search filters.
    ...
    sort: list[ResourceSearchQuerySortRequest] | Unset = UNSET
    filter_: ResourceSearchQueryFilter | Unset = UNSET
    page: (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = ResourceSearchQuerySortRequest.from_dict(sort_item_data)

                sort.append(sort_item)

        _filter_ = d.pop("filter", UNSET)
        filter_: ResourceSearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = ResourceSearchQueryFilter.from_dict(_filter_)
        ...
        resource_search_query = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return resource_search_query

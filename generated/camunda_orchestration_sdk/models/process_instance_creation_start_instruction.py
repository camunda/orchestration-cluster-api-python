...
T = TypeVar("T", bound="ProcessInstanceCreationStartInstruction")
...
class ProcessInstanceCreationStartInstruction:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_instance_creation_start_instruction.additional_properties = d
        return process_instance_creation_start_instruction

...
class GlobalTaskListenerSearchQueryRequestFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        global_task_listener_search_query_request_filter = cls(
            id=id,
            type_=type_,
            retries=retries,
        ...
        global_task_listener_search_query_request_filter.additional_properties = d
        return global_task_listener_search_query_request_filter

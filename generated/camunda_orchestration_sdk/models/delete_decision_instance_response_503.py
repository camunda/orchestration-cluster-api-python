...
T = TypeVar("T", bound="DeleteDecisionInstanceResponse503")


@_attrs_define
class DeleteDecisionInstanceResponse503:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_decision_instance_response_503 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_decision_instance_response_503.additional_properties = d
        return delete_decision_instance_response_503

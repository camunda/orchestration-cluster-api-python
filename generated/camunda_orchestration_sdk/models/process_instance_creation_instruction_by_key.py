...
T = TypeVar("T", bound="ProcessInstanceCreationInstructionByKey")


@_attrs_define
class ProcessInstanceCreationInstructionByKey:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_instance_creation_instruction_by_key = cls(
        ...
        return process_instance_creation_instruction_by_key

...
T = TypeVar("T", bound="MessageSubscriptionFilter")


@_attrs_define
class MessageSubscriptionFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        message_subscription_filter = cls(
        ...
        message_subscription_filter.additional_properties = d
        return message_subscription_filter

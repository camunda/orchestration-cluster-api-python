...
T = TypeVar("T", bound="DeleteDecisionInstanceResponse404")


@_attrs_define
class DeleteDecisionInstanceResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_decision_instance_response_404 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_decision_instance_response_404.additional_properties = d
        return delete_decision_instance_response_404

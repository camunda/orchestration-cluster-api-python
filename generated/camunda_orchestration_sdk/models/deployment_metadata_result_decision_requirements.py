...
@_attrs_define
class DeploymentMetadataResultDecisionRequirements:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deployment_metadata_result_decision_requirements.additional_properties = d
        return deployment_metadata_result_decision_requirements

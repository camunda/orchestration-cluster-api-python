...
T = TypeVar("T", bound="CursorBasedForwardPagination")
...
class CursorBasedForwardPagination:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cursor_based_forward_pagination = cls(
            after=after,
            limit=limit,
        )

        cursor_based_forward_pagination.additional_properties = d
        return cursor_based_forward_pagination

...
T = TypeVar("T", bound="AdvancedAgentDefinitionKeyFilter")


@_attrs_define
class AdvancedAgentDefinitionKeyFilter:
    """Advanced AgentDefinitionKey filter.

    Attributes:
        eq (str | Unset): Checks for equality with the provided value. Example: 2251799813691958.
        neq (str | Unset): Checks for inequality with the provided value. Example: 2251799813691958.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_agent_definition_key_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_agent_definition_key_filter.additional_properties = d
        return advanced_agent_definition_key_filter

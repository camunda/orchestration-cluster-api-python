...
T = TypeVar("T", bound="ResultObjectType0")


@_attrs_define
class ResultObjectType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _activate_elements is not UNSET:
            ...
            for activate_elements_item_data in _activate_elements:
                activate_elements_item = JobResultActivateElement.from_dict(
        ...
        result_object_type_0.additional_properties = d
        return result_object_type_0

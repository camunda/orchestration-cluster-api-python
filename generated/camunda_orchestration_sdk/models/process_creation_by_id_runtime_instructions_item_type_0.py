...
class ProcessCreationByIdRuntimeInstructionsItemType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_creation_by_id_runtime_instructions_item_type_0 = cls(
            after_element_id=after_element_id,
            type_=type_,
        )

        process_creation_by_id_runtime_instructions_item_type_0.additional_properties = d
        return process_creation_by_id_runtime_instructions_item_type_0

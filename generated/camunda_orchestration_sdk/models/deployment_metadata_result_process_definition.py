...
class DeploymentMetadataResultProcessDefinition:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deployment_metadata_result_process_definition = cls(
        ...
        deployment_metadata_result_process_definition.additional_properties = d
        return deployment_metadata_result_process_definition

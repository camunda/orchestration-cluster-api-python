...
from camunda_orchestration_sdk.semantic_types import DecisionDefinitionId, DecisionEvaluationKey, ProcessDefinitionKey, ProcessInstanceKey, TenantId, lift_decision_definition_id, lift_decision_evaluation_key, lift_process_definition_key, lift_process_instance_key, lift_tenant_id
...
from ..models.delete_decision_instances_batch_operation_data_filter_decision_definition_type import (
...
T = TypeVar("T", bound="DeleteDecisionInstancesBatchOperationDataFilter")


@_attrs_define
class DeleteDecisionInstancesBatchOperationDataFilter:
    ...
    Attributes:
        ...
        decision_definition_type (DeleteDecisionInstancesBatchOperationDataFilterDecisionDefinitionType | Unset): The
    ...
    decision_definition_type: (
        DeleteDecisionInstancesBatchOperationDataFilterDecisionDefinitionType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_decision_instances_batch_operation_data_filter = cls(
        ...
        delete_decision_instances_batch_operation_data_filter.additional_properties = d
        return delete_decision_instances_batch_operation_data_filter

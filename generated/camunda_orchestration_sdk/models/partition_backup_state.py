...
from ..models.partition_backup_state_backup_type import PartitionBackupStateBackupType

T = TypeVar("T", bound="PartitionBackupState")
...
class PartitionBackupState:
    ...
    Attributes:
        ...
        checkpoint_type (PartitionBackupStateBackupType): The type of the backup. Example: SCHEDULED_BACKUP.
    ...
    checkpoint_id: int
    checkpoint_type: PartitionBackupStateBackupType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        checkpoint_type = PartitionBackupStateBackupType(d.pop("checkpointType"))
        ...
        partition_backup_state.additional_properties = d
        return partition_backup_state

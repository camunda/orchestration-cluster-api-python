...
T = TypeVar("T", bound="AgentInstanceHistoryItemRequestMetrics")


@_attrs_define
class AgentInstanceHistoryItemRequestMetrics:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_instance_history_item_request_metrics = cls(
            input_tokens=input_tokens,
            output_tokens=output_tokens,
            duration_ms=duration_ms,
        )

        agent_instance_history_item_request_metrics.additional_properties = d
        return agent_instance_history_item_request_metrics

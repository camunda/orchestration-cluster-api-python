...
T = TypeVar("T", bound="UsageMetricsResponseTenantsTheTenantID")


@_attrs_define
class UsageMetricsResponseTenantsTheTenantID:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        usage_metrics_response_tenants_the_tenant_id = cls(
            process_instances=process_instances,
            decision_instances=decision_instances,
            assignees=assignees,
        )

        usage_metrics_response_tenants_the_tenant_id.additional_properties = d
        return usage_metrics_response_tenants_the_tenant_id

...
if TYPE_CHECKING:
    from ..models.audit_log_search_query_request_filter import (
...
T = TypeVar("T", bound="AuditLogSearchQueryRequest")


@_attrs_define
class AuditLogSearchQueryRequest:
    """Audit log search request.

    Attributes:
        sort (list[AuditLogSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (AuditLogSearchQueryRequestFilter | Unset): The audit log search filters.
    ...
    filter_: AuditLogSearchQueryRequestFilter | Unset = UNSET
    page: (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filter_: AuditLogSearchQueryRequestFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = AuditLogSearchQueryRequestFilter.from_dict(_filter_)
        ...
        audit_log_search_query_request = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return audit_log_search_query_request

...
T = TypeVar("T", bound="DeleteDecisionInstancesBatchOperationResponse500")


@_attrs_define
class DeleteDecisionInstancesBatchOperationResponse500:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_decision_instances_batch_operation_response_500 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_decision_instances_batch_operation_response_500.additional_properties = d
        return delete_decision_instances_batch_operation_response_500

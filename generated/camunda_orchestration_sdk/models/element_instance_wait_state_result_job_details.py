...
class ElementInstanceWaitStateResultJobDetails:
    ...
    Attributes:
        ...
        job_kind (ElementInstanceWaitStateResultJobDetailsJobKind): The kind of job. Example: BPMN_ELEMENT.
        listener_event_type (ElementInstanceWaitStateResultJobDetailsListenerEventType): The listener event type of the
            job (only set for execution listener and task listener jobs). Example: UNSPECIFIED.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        job_kind = ElementInstanceWaitStateResultJobDetailsJobKind(d.pop("jobKind"))
        ...
        element_instance_wait_state_result_job_details = cls(
            job_key=job_key,
            job_type=job_type,
            job_kind=job_kind,
        ...
        element_instance_wait_state_result_job_details.additional_properties = d
        return element_instance_wait_state_result_job_details

...
class ElementInstanceWaitStateQueryFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        element_instance_wait_state_query_filter = cls(
        ...
        element_instance_wait_state_query_filter.additional_properties = d
        return element_instance_wait_state_query_filter

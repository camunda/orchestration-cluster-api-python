...
T = TypeVar("T", bound="AdvancedFormKeyFilter")


@_attrs_define
class AdvancedFormKeyFilter:
    """Advanced FormKey filter.

    Attributes:
        eq (str | Unset): Checks for equality with the provided value. Example: 2251799813684365.
        neq (str | Unset): Checks for inequality with the provided value. Example: 2251799813684365.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_form_key_filter.additional_properties = d
        return advanced_form_key_filter

...
if TYPE_CHECKING:
    from ..models.job_time_series_statistics_filter import JobTimeSeriesStatisticsFilter
    from ..models.job_type_statistics_query_page import JobTypeStatisticsQueryPage


T = TypeVar("T", bound="JobTimeSeriesStatisticsQuery")


@_attrs_define
class JobTimeSeriesStatisticsQuery:
    """Job time-series statistics query.

    Attributes:
        filter_ (JobTimeSeriesStatisticsFilter): Job time-series statistics search filter.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        job_time_series_statistics_query = cls(
            filter_=filter_,
            page=page,
        )

        job_time_series_statistics_query.additional_properties = d
        return job_time_series_statistics_query

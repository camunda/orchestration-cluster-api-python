...
T = TypeVar("T", bound="ProcessInstanceModificationTerminateByKeyInstruction")
...
class ProcessInstanceModificationTerminateByKeyInstruction:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_instance_modification_terminate_by_key_instruction.additional_properties = d
        return process_instance_modification_terminate_by_key_instruction

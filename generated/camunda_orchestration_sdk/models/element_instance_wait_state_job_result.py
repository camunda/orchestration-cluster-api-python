...
class ElementInstanceWaitStateJobResult:
    """Inspection result for an element instance waiting on a job.
    ...
    Attributes:
        ...
        element_type (ElementInstanceWaitStateJobResultElementType): The BPMN element type of this element instance.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        details = JobWaitStateDetails.from_dict(d.pop("details"))
        ...
        element_instance_wait_state_job_result = cls(
        ...
        element_instance_wait_state_job_result.additional_properties = d
        return element_instance_wait_state_job_result

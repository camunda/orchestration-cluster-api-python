...
if TYPE_CHECKING:
    ...
    from ..models.incident_search_query_sort_request import (
...
class IncidentSearchQuery:
    """
    Attributes:
        sort (list[IncidentSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (IncidentSearchQueryFilter | Unset): The incident search filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = IncidentSearchQuerySortRequest.from_dict(sort_item_data)

                sort.append(sort_item)

        _filter_ = d.pop("filter", UNSET)
        filter_: IncidentSearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = IncidentSearchQueryFilter.from_dict(_filter_)
        ...
        incident_search_query = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return incident_search_query

...
class BatchOperationError:
    ...
    Attributes:
        ...
        type_ (BatchOperationErrorType | Unset): The type of the error that occurred during the batch operation.
        message (str | Unset): The error message that occurred during the batch operation.
    """

    partition_id: int | Unset = UNSET
    type_: BatchOperationErrorType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: BatchOperationErrorType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = BatchOperationErrorType(_type_)

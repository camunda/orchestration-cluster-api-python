...
T = TypeVar("T", bound="DeleteDecisionInstanceResponse403")


@_attrs_define
class DeleteDecisionInstanceResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_decision_instance_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_decision_instance_response_403.additional_properties = d
        return delete_decision_instance_response_403

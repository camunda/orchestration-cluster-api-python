...
T = TypeVar("T", bound="ProcessInstanceMigrationBatchOperationRequestMigrationPlan")


@_attrs_define
class ProcessInstanceMigrationBatchOperationRequestMigrationPlan:
    """The migration plan.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_instance_migration_batch_operation_request_migration_plan = cls(
            target_process_definition_key=target_process_definition_key,
            mapping_instructions=mapping_instructions,
        )

        process_instance_migration_batch_operation_request_migration_plan.additional_properties = d
        return process_instance_migration_batch_operation_request_migration_plan

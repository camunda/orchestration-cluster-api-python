...
T = TypeVar("T", bound="ClusterBalanceResponseRunningRebalance")


@_attrs_define
class ClusterBalanceResponseRunningRebalance:
    """Normally the rebalance currently running, or absent if no rebalance is running. For a dry-run response, this is
    instead the unexecuted plan of that dry run.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cluster_balance_response_running_rebalance = cls(
        ...
        cluster_balance_response_running_rebalance.additional_properties = d
        return cluster_balance_response_running_rebalance

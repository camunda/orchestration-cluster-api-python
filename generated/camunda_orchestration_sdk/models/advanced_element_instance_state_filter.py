...
from ..models.advanced_element_instance_state_filter_eq import (
    AdvancedElementInstanceStateFilterEq,
)
from ..models.advanced_element_instance_state_filter_neq import (
    AdvancedElementInstanceStateFilterNeq,
)
from ..models.element_instance_state_enum import ElementInstanceStateEnum
from ..types import UNSET, Unset, str_any_dict_factory

T = TypeVar("T", bound="AdvancedElementInstanceStateFilter")
...
class AdvancedElementInstanceStateFilter:
    ...
    Attributes:
        ...
        neq (AdvancedElementInstanceStateFilterNeq | Unset): Checks for inequality with the provided value.
        exists (bool | Unset): Checks if the current property exists.
        in_ (list[ElementInstanceStateEnum] | Unset): Checks if the property matches any of the provided values.
    ...
    neq: AdvancedElementInstanceStateFilterNeq | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        _eq = d.pop("$eq", UNSET)
        eq: AdvancedElementInstanceStateFilterEq | Unset
        if isinstance(_eq, Unset):
            eq = UNSET
        else:
            eq = AdvancedElementInstanceStateFilterEq(_eq)

        _neq = d.pop("$neq", UNSET)
        neq: AdvancedElementInstanceStateFilterNeq | Unset
        if isinstance(_neq, Unset):
            neq = UNSET
        else:
            neq = AdvancedElementInstanceStateFilterNeq(_neq)
        ...
        if _in_ is not UNSET:
            ...
            for in_item_data in _in_:
                in_item = ElementInstanceStateEnum(in_item_data)

                in_.append(in_item)

        like = d.pop("$like", UNSET)

        advanced_element_instance_state_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_element_instance_state_filter.additional_properties = d
        return advanced_element_instance_state_filter

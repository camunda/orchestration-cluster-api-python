...
if TYPE_CHECKING:
    ...
    from ..models.role_client_search_query_sort_request import (
        RoleClientSearchQuerySortRequest,
    )


T = TypeVar("T", bound="RoleClientSearchQueryRequest")


@_attrs_define
class RoleClientSearchQueryRequest:
    """
    Attributes:
        sort (list[RoleClientSearchQuerySortRequest] | Unset): Sort field criteria.
    ...
    sort: list[RoleClientSearchQuerySortRequest] | Unset = UNSET
    page: (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = RoleClientSearchQuerySortRequest.from_dict(sort_item_data)
        ...
        role_client_search_query_request = cls(
            sort=sort,
            page=page,
        )

        role_client_search_query_request.additional_properties = d
        return role_client_search_query_request

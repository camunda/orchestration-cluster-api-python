...
class GroupSearchQueryRequest:
    ...
    Attributes:
        sort (list[GroupSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (GroupSearchQueryRequestFilter | Unset): The group search filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = GroupSearchQuerySortRequest.from_dict(sort_item_data)

                sort.append(sort_item)

        _filter_ = d.pop("filter", UNSET)
        filter_: GroupSearchQueryRequestFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = GroupSearchQueryRequestFilter.from_dict(_filter_)
        ...
        group_search_query_request = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return group_search_query_request

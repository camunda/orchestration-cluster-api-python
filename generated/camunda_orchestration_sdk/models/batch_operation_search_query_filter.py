...
from ..models.batch_operation_search_query_filter_actor_type import (
...
T = TypeVar("T", bound="BatchOperationSearchQueryFilter")


@_attrs_define
class BatchOperationSearchQueryFilter:
    ...
    Attributes:
        ...
        actor_type (BatchOperationSearchQueryFilterActorType | Unset): The type of the actor who performed the
            operation.
    ...
    actor_type: BatchOperationSearchQueryFilterActorType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        actor_type: BatchOperationSearchQueryFilterActorType | Unset
        if isinstance(_actor_type, Unset):
            actor_type = UNSET
        else:
            actor_type = BatchOperationSearchQueryFilterActorType(_actor_type)
        ...
        batch_operation_search_query_filter = cls(
        ...
        batch_operation_search_query_filter.additional_properties = d
        return batch_operation_search_query_filter

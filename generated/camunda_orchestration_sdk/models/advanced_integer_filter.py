...
T = TypeVar("T", bound="AdvancedIntegerFilter")


@_attrs_define
class AdvancedIntegerFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_integer_filter.additional_properties = d
        return advanced_integer_filter

...
T = TypeVar("T", bound="IncidentProcessInstanceStatisticsByDefinitionQueryFilter")


@_attrs_define
class IncidentProcessInstanceStatisticsByDefinitionQueryFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        incident_process_instance_statistics_by_definition_query_filter.additional_properties = d
        return incident_process_instance_statistics_by_definition_query_filter

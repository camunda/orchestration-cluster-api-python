...
class TenantClientSearchResult:
    ...
    Attributes:
        ...
        items (list[TenantClientResult] | Unset): The matching clients.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tenant_client_search_result = cls(
            page=page,
            items=items,
        )

        tenant_client_search_result.additional_properties = d
        return tenant_client_search_result

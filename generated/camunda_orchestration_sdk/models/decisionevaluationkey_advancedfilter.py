...
T = TypeVar("T", bound="DecisionevaluationkeyAdvancedfilter")


@_attrs_define
class DecisionevaluationkeyAdvancedfilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        decisionevaluationkey_advancedfilter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        decisionevaluationkey_advancedfilter.additional_properties = d
        return decisionevaluationkey_advancedfilter

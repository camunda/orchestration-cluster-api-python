...
T = TypeVar("T", bound="JobTimeSeriesStatisticsFilter")


@_attrs_define
class JobTimeSeriesStatisticsFilter:
    ...
    Attributes:
        ...
        job_type (str): Job type to return time-series metrics for. Example: fetch-customer-data.
        resolution (str | Unset): Time bucket resolution as an ISO 8601 duration (for example `PT1M` for 1 minute,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        job_time_series_statistics_filter = cls(
            from_=from_,
            to=to,
            job_type=job_type,
        ...
        job_time_series_statistics_filter.additional_properties = d
        return job_time_series_statistics_filter

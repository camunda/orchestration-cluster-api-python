...
T = TypeVar("T", bound="TenantMappingRuleSearchResult")


@_attrs_define
class TenantMappingRuleSearchResult:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tenant_mapping_rule_search_result = cls(
            items=items,
            page=page,
        )

        tenant_mapping_rule_search_result.additional_properties = d
        return tenant_mapping_rule_search_result

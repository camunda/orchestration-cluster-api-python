...
class ActivateJobsJobsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_user_task, Unset):
            ...
            user_task = UserTaskProperties.from_dict(_user_task)

        tags = cast(list[str], d.pop("tags", UNSET))

        activate_jobs_jobs_item = cls(
            type_=type_,
        ...
        activate_jobs_jobs_item.additional_properties = d
        return activate_jobs_jobs_item

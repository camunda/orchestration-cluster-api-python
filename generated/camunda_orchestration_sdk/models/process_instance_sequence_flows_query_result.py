...
T = TypeVar("T", bound="ProcessInstanceSequenceFlowsQueryResult")


@_attrs_define
class ProcessInstanceSequenceFlowsQueryResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_instance_sequence_flows_query_result = cls(
            items=items,
        )

        process_instance_sequence_flows_query_result.additional_properties = d
        return process_instance_sequence_flows_query_result

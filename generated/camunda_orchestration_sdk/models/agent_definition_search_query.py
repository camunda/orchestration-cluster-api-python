...
if TYPE_CHECKING:
    from ..models.agent_definition_search_query_filter import (
        AgentDefinitionSearchQueryFilter,
    )
    from ..models.agent_definition_search_query_sort_request import (
...
T = TypeVar("T", bound="AgentDefinitionSearchQuery")


@_attrs_define
class AgentDefinitionSearchQuery:
    """Agent definition search request.

    Attributes:
        sort (list[AgentDefinitionSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (AgentDefinitionSearchQueryFilter | Unset): The agent definition search filters.
    ...
    sort: list[AgentDefinitionSearchQuerySortRequest] | Unset = UNSET
    filter_: AgentDefinitionSearchQueryFilter | Unset = UNSET
    page: (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = AgentDefinitionSearchQuerySortRequest.from_dict(
                    sort_item_data
                )
        ...
        filter_: AgentDefinitionSearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = AgentDefinitionSearchQueryFilter.from_dict(_filter_)
        ...
        agent_definition_search_query = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return agent_definition_search_query

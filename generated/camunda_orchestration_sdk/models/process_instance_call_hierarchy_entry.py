...
T = TypeVar("T", bound="ProcessInstanceCallHierarchyEntry")


@_attrs_define
class ProcessInstanceCallHierarchyEntry:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_instance_call_hierarchy_entry.additional_properties = d
        return process_instance_call_hierarchy_entry

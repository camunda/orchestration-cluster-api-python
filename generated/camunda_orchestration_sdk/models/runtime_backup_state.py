...
T = TypeVar("T", bound="RuntimeBackupState")


@_attrs_define
class RuntimeBackupState:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        runtime_backup_state = cls(
            checkpoint_states=checkpoint_states,
            backup_states=backup_states,
            ranges=ranges,
        )

        runtime_backup_state.additional_properties = d
        return runtime_backup_state

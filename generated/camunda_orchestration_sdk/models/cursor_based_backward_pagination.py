...
T = TypeVar("T", bound="CursorBasedBackwardPagination")
...
class CursorBasedBackwardPagination:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cursor_based_backward_pagination = cls(
            before=before,
            limit=limit,
        )

        cursor_based_backward_pagination.additional_properties = d
        return cursor_based_backward_pagination

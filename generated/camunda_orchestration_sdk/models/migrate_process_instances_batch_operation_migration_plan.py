...
T = TypeVar("T", bound="MigrateProcessInstancesBatchOperationMigrationPlan")


@_attrs_define
class MigrateProcessInstancesBatchOperationMigrationPlan:
    """The migration plan.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        migrate_process_instances_batch_operation_migration_plan = cls(
            target_process_definition_key=target_process_definition_key,
            mapping_instructions=mapping_instructions,
        )

        migrate_process_instances_batch_operation_migration_plan.additional_properties = d
        return migrate_process_instances_batch_operation_migration_plan

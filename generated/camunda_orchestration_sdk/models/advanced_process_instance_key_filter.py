...
T = TypeVar("T", bound="AdvancedProcessInstanceKeyFilter")


@_attrs_define
class AdvancedProcessInstanceKeyFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_process_instance_key_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_process_instance_key_filter.additional_properties = d
        return advanced_process_instance_key_filter

...
T = TypeVar("T", bound="RoleMappingRuleSearchResult")


@_attrs_define
class RoleMappingRuleSearchResult:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role_mapping_rule_search_result = cls(
            items=items,
            page=page,
        )

        role_mapping_rule_search_result.additional_properties = d
        return role_mapping_rule_search_result

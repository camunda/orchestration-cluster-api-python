...
from ..models.update_tenant_cluster_variable_response_200_scope import (
    UpdateTenantClusterVariableResponse200Scope,
)
from ..types import UNSET, Unset, str_any_dict_factory

T = TypeVar("T", bound="UpdateTenantClusterVariableResponse200")


@_attrs_define
class UpdateTenantClusterVariableResponse200:
    """
    Attributes:
        ...
        scope (UpdateTenantClusterVariableResponse200Scope): The scope of a cluster variable.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_tenant_cluster_variable_response_200.additional_properties = d
        return update_tenant_cluster_variable_response_200

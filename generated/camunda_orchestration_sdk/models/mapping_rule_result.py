...
T = TypeVar("T", bound="MappingRuleResult")
...
class MappingRuleResult:
    ...
    Attributes:
        ...
        mapping_rule_id (str): The ID of the mapping rule. Example: my-mapping-rule.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mapping_rule_result.additional_properties = d
        return mapping_rule_result

...
class JobSearchQuery:
    ...
    Attributes:
        sort (list[JobSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (JobSearchQueryFilter | Unset): The job search filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = JobSearchQuerySortRequest.from_dict(sort_item_data)

                sort.append(sort_item)

        _filter_ = d.pop("filter", UNSET)
        filter_: JobSearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = JobSearchQueryFilter.from_dict(_filter_)

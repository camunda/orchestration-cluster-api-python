...
T = TypeVar("T", bound="AgentInstanceCreationRequestDefinition")
...
class AgentInstanceCreationRequestDefinition:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_instance_creation_request_definition = cls(
            model=model,
            provider=provider,
            system_prompt=system_prompt,
        )

        agent_instance_creation_request_definition.additional_properties = d
        return agent_instance_creation_request_definition

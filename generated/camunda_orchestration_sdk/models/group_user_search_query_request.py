...
if TYPE_CHECKING:
    ...
    from ..models.group_user_search_query_sort_request import (
...
class GroupUserSearchQueryRequest:
    """
    Attributes:
        sort (list[GroupUserSearchQuerySortRequest] | Unset): Sort field criteria.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = GroupUserSearchQuerySortRequest.from_dict(sort_item_data)
        ...
        group_user_search_query_request = cls(
            sort=sort,
            page=page,
        )

        group_user_search_query_request.additional_properties = d
        return group_user_search_query_request

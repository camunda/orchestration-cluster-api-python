...
T = TypeVar("T", bound="DecisionrequirementskeyAdvancedfilter")


@_attrs_define
class DecisionrequirementskeyAdvancedfilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        decisionrequirementskey_advancedfilter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        decisionrequirementskey_advancedfilter.additional_properties = d
        return decisionrequirementskey_advancedfilter

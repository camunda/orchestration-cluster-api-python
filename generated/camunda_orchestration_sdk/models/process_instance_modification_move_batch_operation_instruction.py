...
T = TypeVar("T", bound="ProcessInstanceModificationMoveBatchOperationInstruction")
...
class ProcessInstanceModificationMoveBatchOperationInstruction:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_instance_modification_move_batch_operation_instruction.additional_properties = d
        return process_instance_modification_move_batch_operation_instruction

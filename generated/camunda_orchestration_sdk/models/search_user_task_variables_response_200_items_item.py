...
from camunda_orchestration_sdk.semantic_types import ProcessInstanceKey, ScopeKey, TenantId, VariableKey, lift_process_instance_key, lift_scope_key, lift_tenant_id, lift_variable_key

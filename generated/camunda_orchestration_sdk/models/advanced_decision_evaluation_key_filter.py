...
T = TypeVar("T", bound="AdvancedDecisionEvaluationKeyFilter")


@_attrs_define
class AdvancedDecisionEvaluationKeyFilter:
    """Advanced DecisionEvaluationKey filter.

    Attributes:
        eq (str | Unset): Checks for equality with the provided value. Example: 2251792362345323.
        neq (str | Unset): Checks for inequality with the provided value. Example: 2251792362345323.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_decision_evaluation_key_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_decision_evaluation_key_filter.additional_properties = d
        return advanced_decision_evaluation_key_filter

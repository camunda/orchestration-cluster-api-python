...
from ..models.delete_process_instance_response_200_batch_operation_type import (
    DeleteProcessInstanceResponse200BatchOperationType,
)
from ..types import UNSET, Unset, str_any_dict_factory

T = TypeVar("T", bound="DeleteProcessInstanceResponse200")


@_attrs_define
class DeleteProcessInstanceResponse200:
    """The created batch operation.

    Attributes:
        batch_operation_key (str | Unset): Key of the batch operation. Example: 2251799813684321.
        batch_operation_type (DeleteProcessInstanceResponse200BatchOperationType | Unset): The type of the batch
            operation.
    """

    batch_operation_key: BatchOperationKey | Unset = UNSET
    batch_operation_type: DeleteProcessInstanceResponse200BatchOperationType | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_batch_operation_type, Unset):
            ...
            batch_operation_type = DeleteProcessInstanceResponse200BatchOperationType(
                _batch_operation_type
            )

        delete_process_instance_response_200 = cls(
            batch_operation_key=batch_operation_key,
            batch_operation_type=batch_operation_type,
        )

        delete_process_instance_response_200.additional_properties = d
        return delete_process_instance_response_200

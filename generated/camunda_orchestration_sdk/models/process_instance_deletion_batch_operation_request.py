...
T = TypeVar("T", bound="ProcessInstanceDeletionBatchOperationRequest")


@_attrs_define
class ProcessInstanceDeletionBatchOperationRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_instance_deletion_batch_operation_request = cls(
            filter_=filter_,
            operation_reference=operation_reference,
        )

        return process_instance_deletion_batch_operation_request

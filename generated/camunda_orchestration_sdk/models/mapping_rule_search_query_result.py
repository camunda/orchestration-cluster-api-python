...
T = TypeVar("T", bound="MappingRuleSearchQueryResult")


@_attrs_define
class MappingRuleSearchQueryResult:
    """
    Attributes:
        page (SearchQueryPageResponse): Pagination information about the search results. Example: {'totalItems': 1,
            'hasMoreTotalItems': False}.
        items (list[MappingRuleResult] | Unset): The matching mapping rules.
    """

    page: SearchQueryPageResponse
    items: list[MappingRuleResult] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mapping_rule_search_query_result = cls(
            page=page,
            items=items,
        )

        mapping_rule_search_query_result.additional_properties = d
        return mapping_rule_search_query_result

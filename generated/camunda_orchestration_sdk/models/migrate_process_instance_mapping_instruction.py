...
T = TypeVar("T", bound="MigrateProcessInstanceMappingInstruction")
...
class MigrateProcessInstanceMappingInstruction:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        migrate_process_instance_mapping_instruction = cls(
            source_element_id=source_element_id,
            target_element_id=target_element_id,
        )

        migrate_process_instance_mapping_instruction.additional_properties = d
        return migrate_process_instance_mapping_instruction

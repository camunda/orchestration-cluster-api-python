...
T = TypeVar("T", bound="AdvancedProcessDefinitionIdFilter")


@_attrs_define
class AdvancedProcessDefinitionIdFilter:
    r"""Advanced ProcessDefinitionId filter.

    Attributes:
        eq (str | Unset): Checks for equality with the provided value. Example: new-account-onboarding-workflow.
        neq (str | Unset): Checks for inequality with the provided value. Example: new-account-onboarding-workflow.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_process_definition_id_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_process_definition_id_filter.additional_properties = d
        return advanced_process_definition_id_filter

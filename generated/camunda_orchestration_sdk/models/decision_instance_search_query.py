...
class DecisionInstanceSearchQuery:
    """
    Attributes:
        sort (list[DecisionInstanceSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (DecisionInstanceSearchQueryFilter | Unset): The decision instance search filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = DecisionInstanceSearchQuerySortRequest.from_dict(
                    sort_item_data
                )
        ...
        filter_: DecisionInstanceSearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = DecisionInstanceSearchQueryFilter.from_dict(_filter_)
        ...
        decision_instance_search_query = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return decision_instance_search_query

...
T = TypeVar("T", bound="AgentInstanceCreationRequestLimits")
...
class AgentInstanceCreationRequestLimits:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_instance_creation_request_limits = cls(
            max_model_calls=max_model_calls,
            max_tool_calls=max_tool_calls,
            max_tokens=max_tokens,
        )

        agent_instance_creation_request_limits.additional_properties = d
        return agent_instance_creation_request_limits

...
from ..models.advanced_operation_type_filter_eq import AdvancedOperationTypeFilterEq
from ..models.advanced_operation_type_filter_neq import AdvancedOperationTypeFilterNeq
from ..models.audit_log_operation_type_enum import AuditLogOperationTypeEnum
from ..types import UNSET, Unset, str_any_dict_factory

T = TypeVar("T", bound="AdvancedOperationTypeFilter")
...
class AdvancedOperationTypeFilter:
    ...
    Attributes:
        ...
        neq (AdvancedOperationTypeFilterNeq | Unset): Checks for inequality with the provided value.
        exists (bool | Unset): Checks if the current property exists.
        in_ (list[AuditLogOperationTypeEnum] | Unset): Checks if the property matches any of the provided values.
    ...
    neq: AdvancedOperationTypeFilterNeq | Unset = UNSET
    exists: bool | Unset = UNSET
    in_: list[AuditLogOperationTypeEnum] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        _eq = d.pop("$eq", UNSET)
        eq: AdvancedOperationTypeFilterEq | Unset
        if isinstance(_eq, Unset):
            eq = UNSET
        else:
            eq = AdvancedOperationTypeFilterEq(_eq)

        _neq = d.pop("$neq", UNSET)
        neq: AdvancedOperationTypeFilterNeq | Unset
        if isinstance(_neq, Unset):
            neq = UNSET
        else:
            neq = AdvancedOperationTypeFilterNeq(_neq)
        ...
        if _in_ is not UNSET:
            ...
            for in_item_data in _in_:
                in_item = AuditLogOperationTypeEnum(in_item_data)

                in_.append(in_item)

        like = d.pop("$like", UNSET)

        advanced_operation_type_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_operation_type_filter.additional_properties = d
        return advanced_operation_type_filter

...
T = TypeVar("T", bound="SuspendProcessInstanceRequest")


@_attrs_define
class SuspendProcessInstanceRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        suspend_process_instance_request_type_0 = cls(
            operation_reference=operation_reference,
        )

        return suspend_process_instance_request_type_0

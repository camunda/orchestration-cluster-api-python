...
if TYPE_CHECKING:
    from ..models.batch_operation_search_query_filter import (
...
class BatchOperationSearchQuery:
    ...
    Attributes:
        sort (list[BatchOperationSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (BatchOperationSearchQueryFilter | Unset): The batch operation search filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = BatchOperationSearchQuerySortRequest.from_dict(
                    sort_item_data
                )
        ...
        filter_: BatchOperationSearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = BatchOperationSearchQueryFilter.from_dict(_filter_)
        ...
        batch_operation_search_query = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return batch_operation_search_query

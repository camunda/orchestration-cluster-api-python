...
T = TypeVar("T", bound="JobBatchUpdateRequestFilter")


@_attrs_define
class JobBatchUpdateRequestFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        job_batch_update_request_filter = cls(
            deadline=deadline,
        ...
        job_batch_update_request_filter.additional_properties = d
        return job_batch_update_request_filter

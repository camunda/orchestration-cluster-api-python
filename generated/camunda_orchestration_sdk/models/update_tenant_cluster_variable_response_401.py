...
T = TypeVar("T", bound="UpdateTenantClusterVariableResponse401")


@_attrs_define
class UpdateTenantClusterVariableResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_tenant_cluster_variable_response_401 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        update_tenant_cluster_variable_response_401.additional_properties = d
        return update_tenant_cluster_variable_response_401

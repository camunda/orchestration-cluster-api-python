...
T = TypeVar("T", bound="BaseProcessInstanceFilterFields")


@_attrs_define
class BaseProcessInstanceFilterFields:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        base_process_instance_filter_fields = cls(
        ...
        base_process_instance_filter_fields.additional_properties = d
        return base_process_instance_filter_fields

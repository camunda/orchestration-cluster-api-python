...
if TYPE_CHECKING:
    from ..models.correlated_message_subscription_search_query_filter import (
        CorrelatedMessageSubscriptionSearchQueryFilter,
    )
    from ..models.correlated_message_subscription_search_query_sort_request import (
...
T = TypeVar("T", bound="CorrelatedMessageSubscriptionSearchQuery")


@_attrs_define
class CorrelatedMessageSubscriptionSearchQuery:
    """
    Attributes:
        sort (list[CorrelatedMessageSubscriptionSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (CorrelatedMessageSubscriptionSearchQueryFilter | Unset): The correlated message subscriptions search
            filters.
    ...
    sort: list[CorrelatedMessageSubscriptionSearchQuerySortRequest] | Unset = UNSET
    filter_: CorrelatedMessageSubscriptionSearchQueryFilter | Unset = UNSET
    page: (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = (
                    CorrelatedMessageSubscriptionSearchQuerySortRequest.from_dict(
                        sort_item_data
                    )
                )
        ...
        filter_: CorrelatedMessageSubscriptionSearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = CorrelatedMessageSubscriptionSearchQueryFilter.from_dict(_filter_)
        ...
        correlated_message_subscription_search_query = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return correlated_message_subscription_search_query

...
class MessageSubscriptionResultToolProperties:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        message_subscription_result_tool_properties = cls()

        message_subscription_result_tool_properties.additional_properties = d
        return message_subscription_result_tool_properties

...
T = TypeVar("T", bound="MappingRuleCreateResult")
...
class MappingRuleCreateResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mapping_rule_create_result = cls(
        ...
        mapping_rule_create_result.additional_properties = d
        return mapping_rule_create_result

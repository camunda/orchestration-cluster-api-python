...
from ..models.advanced_global_listener_source_filter_eq import (
    AdvancedGlobalListenerSourceFilterEq,
)
from ..models.advanced_global_listener_source_filter_neq import (
...
class AdvancedGlobalListenerSourceFilter:
    ...
    Attributes:
        ...
        neq (AdvancedGlobalListenerSourceFilterNeq | Unset): Checks for inequality with the provided value.
        exists (bool | Unset): Checks if the current property exists.
        in_ (list[GlobalListenerSourceEnum] | Unset): Checks if the property matches any of the provided values.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        _eq = d.pop("$eq", UNSET)
        eq: AdvancedGlobalListenerSourceFilterEq | Unset
        if isinstance(_eq, Unset):
            eq = UNSET
        else:
            eq = AdvancedGlobalListenerSourceFilterEq(_eq)

        _neq = d.pop("$neq", UNSET)
        neq: AdvancedGlobalListenerSourceFilterNeq | Unset
        if isinstance(_neq, Unset):
            neq = UNSET
        else:
            neq = AdvancedGlobalListenerSourceFilterNeq(_neq)
        ...
        if _in_ is not UNSET:
            ...
            for in_item_data in _in_:
                in_item = GlobalListenerSourceEnum(in_item_data)

                in_.append(in_item)

        like = d.pop("$like", UNSET)

        advanced_global_listener_source_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_global_listener_source_filter.additional_properties = d
        return advanced_global_listener_source_filter

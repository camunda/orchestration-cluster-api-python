...
class AuthorizationSearchQueryFilter:
    ...
    Attributes:
        ...
        resource_type (AuthorizationSearchQueryFilterResourceType | Unset): The type of resource to search permissions
            for.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource_type: AuthorizationSearchQueryFilterResourceType | Unset
        if isinstance(_resource_type, Unset):
            resource_type = UNSET
        else:
            resource_type = AuthorizationSearchQueryFilterResourceType(_resource_type)

        authorization_search_query_filter = cls(
            owner_id=owner_id,
        ...
        authorization_search_query_filter.additional_properties = d
        return authorization_search_query_filter

...
class CorrelatedMessageSubscriptionSearchQueryResult:
    ...
    Attributes:
        ...
        items (list[CorrelatedMessageSubscriptionResult] | Unset): The matching correlated message subscriptions.
    """

    page: SearchQueryPageResponse
    items: list[CorrelatedMessageSubscriptionResult] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _items is not UNSET:
            ...
            for items_item_data in _items:
                items_item = CorrelatedMessageSubscriptionResult.from_dict(
                    items_item_data
                )

...
class ClusterVariableSearchQueryRequest:
    ...
    Attributes:
        sort (list[ClusterVariableSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (ClusterVariableSearchQueryRequestFilter | Unset): The cluster variable search filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = ClusterVariableSearchQuerySortRequest.from_dict(
                    sort_item_data
                )
        ...
        filter_: ClusterVariableSearchQueryRequestFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = ClusterVariableSearchQueryRequestFilter.from_dict(_filter_)
        ...
        cluster_variable_search_query_request = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return cluster_variable_search_query_request

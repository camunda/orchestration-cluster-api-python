...
T = TypeVar("T", bound="AgentInstanceDefinition")
...
class AgentInstanceDefinition:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_instance_definition = cls(
            model=model,
            provider=provider,
            system_prompt=system_prompt,
        )

        agent_instance_definition.additional_properties = d
        return agent_instance_definition

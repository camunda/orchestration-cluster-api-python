...
if TYPE_CHECKING:
    from ..models.agent_instance_search_query_filter import (
        AgentInstanceSearchQueryFilter,
    )
    from ..models.agent_instance_search_query_sort_request import (
...
T = TypeVar("T", bound="AgentInstanceSearchQuery")


@_attrs_define
class AgentInstanceSearchQuery:
    """Agent instance search request.

    Attributes:
        sort (list[AgentInstanceSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (AgentInstanceSearchQueryFilter | Unset): The agent instance search filters.
    ...
    sort: list[AgentInstanceSearchQuerySortRequest] | Unset = UNSET
    filter_: AgentInstanceSearchQueryFilter | Unset = UNSET
    page: (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = AgentInstanceSearchQuerySortRequest.from_dict(
                    sort_item_data
                )
        ...
        filter_: AgentInstanceSearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = AgentInstanceSearchQueryFilter.from_dict(_filter_)
        ...
        agent_instance_search_query = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return agent_instance_search_query

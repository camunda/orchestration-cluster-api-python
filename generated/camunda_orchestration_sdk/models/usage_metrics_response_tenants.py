...
class UsageMetricsResponseTenants:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        usage_metrics_response_tenants = cls()

        additional_properties = {}
        for prop_name, prop_dict in d.items():
            additional_property = UsageMetricsResponseTenantsTheTenantID.from_dict(
                prop_dict
            )

            additional_properties[prop_name] = additional_property

        usage_metrics_response_tenants.additional_properties = additional_properties
        return usage_metrics_response_tenants

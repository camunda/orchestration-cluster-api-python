...
T = TypeVar("T", bound="EntitykeyAdvancedfilter")


@_attrs_define
class EntitykeyAdvancedfilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entitykey_advancedfilter.additional_properties = d
        return entitykey_advancedfilter

...
class BatchOperationItemSearchQuery:
    ...
    Attributes:
        ...
        filter_ (BatchOperationItemSearchQueryFilter | Unset): The batch operation item search filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filter_: BatchOperationItemSearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = BatchOperationItemSearchQueryFilter.from_dict(_filter_)
        ...
        batch_operation_item_search_query = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return batch_operation_item_search_query

...
T = TypeVar("T", bound="InferredAncestorKeyInstruction")
...
class InferredAncestorKeyInstruction:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inferred_ancestor_key_instruction = cls(
            ancestor_scope_type=ancestor_scope_type,
        )

        inferred_ancestor_key_instruction.additional_properties = d
        return inferred_ancestor_key_instruction

...
if TYPE_CHECKING:
    ...
    from ..models.element_instance_state_advanced_filter import (
        ElementInstanceStateAdvancedFilter,
    )
    from ..models.variable_value_filter_property import VariableValueFilterProperty


T = TypeVar("T", bound="GetProcessDefinitionStatisticsFilter")


@_attrs_define
class GetProcessDefinitionStatisticsFilter:
    ...
    Attributes:
        ...
        element_instance_state (ElementInstanceStateAdvancedFilter | ElementInstanceStateExactMatch | Unset):
    ...
    element_instance_state: (
        ElementInstanceStateAdvancedFilter | ElementInstanceStateExactMatch | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_element_instance_state(
            ...
            element_instance_state_type_1 = (
                ElementInstanceStateAdvancedFilter.from_dict(data)
            )
        ...
        get_process_definition_statistics_filter = cls(
        ...
        get_process_definition_statistics_filter.additional_properties = d
        return get_process_definition_statistics_filter

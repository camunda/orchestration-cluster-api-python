...
from ..models.element_instance_filter_fields_type import ElementInstanceFilterFieldsType
...
T = TypeVar("T", bound="ElementInstanceFilterFields")


@_attrs_define
class ElementInstanceFilterFields:
    ...
    Attributes:
        ...
        type_ (ElementInstanceFilterFieldsType | Unset): Type of element as defined set of values.
    ...
    type_: ElementInstanceFilterFieldsType | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.state, Unset):
            state = UNSET
        elif isinstance(self.state, ElementInstanceStateExactMatch):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_state(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                state_type_0 = ElementInstanceStateExactMatch(data)
            ...
            state_type_1 = AdvancedElementInstanceStateFilter.from_dict(data)
        ...
        type_: ElementInstanceFilterFieldsType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = ElementInstanceFilterFieldsType(_type_)
        ...
        element_instance_filter_fields = cls(
        ...
        element_instance_filter_fields.additional_properties = d
        return element_instance_filter_fields

...
T = TypeVar("T", bound="TenantUserSearchResult")
...
class TenantUserSearchResult:
    ...
    Attributes:
        ...
        items (list[TenantUserResult] | Unset): The matching users.
    """

    page: SearchQueryPageResponse
    items: list[TenantUserResult] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _items is not UNSET:
            ...
            for items_item_data in _items:
                items_item = TenantUserResult.from_dict(items_item_data)

                items.append(items_item)

        tenant_user_search_result = cls(
            page=page,
            items=items,
        )

        tenant_user_search_result.additional_properties = d
        return tenant_user_search_result

...
T = TypeVar("T", bound="DeploymentkeyAdvancedfilter")


@_attrs_define
class DeploymentkeyAdvancedfilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deploymentkey_advancedfilter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        deploymentkey_advancedfilter.additional_properties = d
        return deploymentkey_advancedfilter

...
T = TypeVar("T", bound="MessageSubscriptionSearchQueryResult")


@_attrs_define
class MessageSubscriptionSearchQueryResult:
    """
    Attributes:
    ...
    items: list[MessageSubscriptionResult]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        message_subscription_search_query_result = cls(
            items=items,
            page=page,
        )

        message_subscription_search_query_result.additional_properties = d
        return message_subscription_search_query_result

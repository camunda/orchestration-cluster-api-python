...
T = TypeVar("T", bound="AdvancedAgentInstanceKeyFilter")


@_attrs_define
class AdvancedAgentInstanceKeyFilter:
    """Advanced AgentInstanceKey filter.

    Attributes:
        eq (str | Unset): Checks for equality with the provided value. Example: 4503599627370496.
        neq (str | Unset): Checks for inequality with the provided value. Example: 4503599627370496.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_agent_instance_key_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_agent_instance_key_filter.additional_properties = d
        return advanced_agent_instance_key_filter

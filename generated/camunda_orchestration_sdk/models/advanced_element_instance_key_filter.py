...
T = TypeVar("T", bound="AdvancedElementInstanceKeyFilter")


@_attrs_define
class AdvancedElementInstanceKeyFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_element_instance_key_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_element_instance_key_filter.additional_properties = d
        return advanced_element_instance_key_filter

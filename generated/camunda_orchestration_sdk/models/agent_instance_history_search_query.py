...
class AgentInstanceHistorySearchQuery:
    ...
    Attributes:
        sort (list[AgentInstanceHistorySearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (AgentInstanceHistorySearchQueryFilter | Unset): The history item search filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = AgentInstanceHistorySearchQuerySortRequest.from_dict(
                    sort_item_data
                )
        ...
        filter_: AgentInstanceHistorySearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = AgentInstanceHistorySearchQueryFilter.from_dict(_filter_)
        ...
        agent_instance_history_search_query = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return agent_instance_history_search_query

...
T = TypeVar("T", bound="AdvancedDeploymentKeyFilter")


@_attrs_define
class AdvancedDeploymentKeyFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_deployment_key_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_deployment_key_filter.additional_properties = d
        return advanced_deployment_key_filter

...
T = TypeVar("T", bound="JobTypeStatisticsQueryResult")


@_attrs_define
class JobTypeStatisticsQueryResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = JobTypeStatisticsItem.from_dict(items_item_data)

            items.append(items_item)

        page = SearchQueryPageResponse.from_dict(d.pop("page"))

        job_type_statistics_query_result = cls(
            items=items,
            page=page,
        )

        job_type_statistics_query_result.additional_properties = d
        return job_type_statistics_query_result

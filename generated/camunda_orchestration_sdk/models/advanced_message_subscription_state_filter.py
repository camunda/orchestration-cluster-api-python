...
class AdvancedMessageSubscriptionStateFilter:
    ...
    Attributes:
        ...
        neq (AdvancedMessageSubscriptionStateFilterNeq | Unset): Checks for inequality with the provided value.
        exists (bool | Unset): Checks if the current property exists.
        in_ (list[MessageSubscriptionStateEnum] | Unset): Checks if the property matches any of the provided values.
    ...
    neq: AdvancedMessageSubscriptionStateFilterNeq | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        _eq = d.pop("$eq", UNSET)
        eq: AdvancedMessageSubscriptionStateFilterEq | Unset
        if isinstance(_eq, Unset):
            eq = UNSET
        else:
            eq = AdvancedMessageSubscriptionStateFilterEq(_eq)

        _neq = d.pop("$neq", UNSET)
        neq: AdvancedMessageSubscriptionStateFilterNeq | Unset
        if isinstance(_neq, Unset):
            neq = UNSET
        else:
            neq = AdvancedMessageSubscriptionStateFilterNeq(_neq)
        ...
        if _in_ is not UNSET:
            ...
            for in_item_data in _in_:
                in_item = MessageSubscriptionStateEnum(in_item_data)

                in_.append(in_item)

        like = d.pop("$like", UNSET)

        advanced_message_subscription_state_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_message_subscription_state_filter.additional_properties = d
        return advanced_message_subscription_state_filter

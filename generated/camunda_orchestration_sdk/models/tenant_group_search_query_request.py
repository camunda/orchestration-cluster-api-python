...
if TYPE_CHECKING:
    ...
    from ..models.tenant_group_search_query_sort_request import (
        TenantGroupSearchQuerySortRequest,
    )


T = TypeVar("T", bound="TenantGroupSearchQueryRequest")


@_attrs_define
class TenantGroupSearchQueryRequest:
    """
    Attributes:
        sort (list[TenantGroupSearchQuerySortRequest] | Unset): Sort field criteria.
    ...
    sort: list[TenantGroupSearchQuerySortRequest] | Unset = UNSET
    page: (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = TenantGroupSearchQuerySortRequest.from_dict(sort_item_data)
        ...
        tenant_group_search_query_request = cls(
            sort=sort,
            page=page,
        )

        return tenant_group_search_query_request

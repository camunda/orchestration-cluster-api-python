...
if TYPE_CHECKING:
    ...
    from ..models.global_task_listener_search_query_request_filter import (
        GlobalTaskListenerSearchQueryRequestFilter,
    )
    from ..models.global_task_listener_search_query_sort_request import (
...
T = TypeVar("T", bound="GlobalTaskListenerSearchQueryRequest")


@_attrs_define
class GlobalTaskListenerSearchQueryRequest:
    """Global listener search query request.

    Attributes:
        sort (list[GlobalTaskListenerSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (GlobalTaskListenerSearchQueryRequestFilter | Unset): The global listener search filters.
    ...
    sort: list[GlobalTaskListenerSearchQuerySortRequest] | Unset = UNSET
    filter_: GlobalTaskListenerSearchQueryRequestFilter | Unset = UNSET
    page: (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = GlobalTaskListenerSearchQuerySortRequest.from_dict(
                    sort_item_data
                )
        ...
        filter_: GlobalTaskListenerSearchQueryRequestFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = GlobalTaskListenerSearchQueryRequestFilter.from_dict(_filter_)
        ...
        global_task_listener_search_query_request = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return global_task_listener_search_query_request

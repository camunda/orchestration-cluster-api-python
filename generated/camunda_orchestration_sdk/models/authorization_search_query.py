...
if TYPE_CHECKING:
    from ..models.authorization_search_query_filter import (
        AuthorizationSearchQueryFilter,
    )
    from ..models.authorization_search_query_sort_request import (
...
T = TypeVar("T", bound="AuthorizationSearchQuery")


@_attrs_define
class AuthorizationSearchQuery:
    """
    Attributes:
        sort (list[AuthorizationSearchQuerySortRequest] | Unset): Sort field criteria.
        filter_ (AuthorizationSearchQueryFilter | Unset): The authorization search filters.
    ...
    sort: list[AuthorizationSearchQuerySortRequest] | Unset = UNSET
    filter_: AuthorizationSearchQueryFilter | Unset = UNSET
    page: (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = AuthorizationSearchQuerySortRequest.from_dict(
                    sort_item_data
                )
        ...
        filter_: AuthorizationSearchQueryFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = AuthorizationSearchQueryFilter.from_dict(_filter_)
        ...
        authorization_search_query = cls(
            sort=sort,
            filter_=filter_,
            page=page,
        )

        return authorization_search_query

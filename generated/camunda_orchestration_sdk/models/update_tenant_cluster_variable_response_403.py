...
T = TypeVar("T", bound="UpdateTenantClusterVariableResponse403")


@_attrs_define
class UpdateTenantClusterVariableResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_tenant_cluster_variable_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        update_tenant_cluster_variable_response_403.additional_properties = d
        return update_tenant_cluster_variable_response_403

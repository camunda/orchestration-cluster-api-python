...
T = TypeVar("T", bound="SourceElementInstanceKeyInstruction")
...
class SourceElementInstanceKeyInstruction:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        source_element_instance_key_instruction.additional_properties = d
        return source_element_instance_key_instruction

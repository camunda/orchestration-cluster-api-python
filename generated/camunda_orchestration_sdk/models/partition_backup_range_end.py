...
class PartitionBackupRangeEnd:
    ...
    Attributes:
        ...
        checkpoint_type (PartitionBackupRangeEndBackupType): The type of the backup. Example: SCHEDULED_BACKUP.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        checkpoint_type = PartitionBackupRangeEndBackupType(d.pop("checkpointType"))
        ...
        partition_backup_range_end = cls(
        ...
        partition_backup_range_end.additional_properties = d
        return partition_backup_range_end

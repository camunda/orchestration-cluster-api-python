...
T = TypeVar("T", bound="GetGlobalJobStatisticsResponse400")


@_attrs_define
class GetGlobalJobStatisticsResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_global_job_statistics_response_400 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_global_job_statistics_response_400.additional_properties = d
        return get_global_job_statistics_response_400

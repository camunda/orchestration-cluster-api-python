...
class ProcessInstanceModificationMoveInstruction:
    ...
    body instances will activate new element instances at the target id.
        ...
        Attributes:
            source_element_instruction (SourceElementIdInstruction | SourceElementInstanceKeyInstruction): Defines the
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_source_element_instruction(
            ...
            try:
                ...
                componentsschemas_source_element_instruction_type_0 = (
                    SourceElementIdInstruction.from_dict(data)
                )

                return componentsschemas_source_element_instruction_type_0
            ...
            data = cast(dict[str, Any], data)
            componentsschemas_source_element_instruction_type_1 = (
        ...
        process_instance_modification_move_instruction = cls(
        ...
        process_instance_modification_move_instruction.additional_properties = d
        return process_instance_modification_move_instruction

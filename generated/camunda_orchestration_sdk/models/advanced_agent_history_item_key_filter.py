...
T = TypeVar("T", bound="AdvancedAgentHistoryItemKeyFilter")


@_attrs_define
class AdvancedAgentHistoryItemKeyFilter:
    """Advanced AgentHistoryItemKey filter.

    Attributes:
        eq (str | Unset): Checks for equality with the provided value. Example: 6755399441055744.
        neq (str | Unset): Checks for inequality with the provided value. Example: 6755399441055744.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_agent_history_item_key_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_agent_history_item_key_filter.additional_properties = d
        return advanced_agent_history_item_key_filter

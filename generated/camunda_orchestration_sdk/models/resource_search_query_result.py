...
T = TypeVar("T", bound="ResourceSearchQueryResult")


@_attrs_define
class ResourceSearchQueryResult:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ResourceResult.from_dict(items_item_data)

            items.append(items_item)

        page = SearchQueryPageResponse.from_dict(d.pop("page"))

        resource_search_query_result = cls(
            items=items,
            page=page,
        )

        resource_search_query_result.additional_properties = d
        return resource_search_query_result

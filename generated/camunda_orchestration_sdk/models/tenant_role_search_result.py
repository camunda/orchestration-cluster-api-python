...
T = TypeVar("T", bound="TenantRoleSearchResult")


@_attrs_define
class TenantRoleSearchResult:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tenant_role_search_result = cls(
            items=items,
            page=page,
        )

        tenant_role_search_result.additional_properties = d
        return tenant_role_search_result

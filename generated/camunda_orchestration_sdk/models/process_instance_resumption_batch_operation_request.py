...
T = TypeVar("T", bound="ProcessInstanceResumptionBatchOperationRequest")


@_attrs_define
class ProcessInstanceResumptionBatchOperationRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_instance_resumption_batch_operation_request = cls(
            filter_=filter_,
            operation_reference=operation_reference,
        )

        return process_instance_resumption_batch_operation_request

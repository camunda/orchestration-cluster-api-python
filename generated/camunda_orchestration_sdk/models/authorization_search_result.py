...
T = TypeVar("T", bound="AuthorizationSearchResult")
...
class AuthorizationSearchResult:
    ...
    Attributes:
        ...
        items (list[AuthorizationResult] | Unset): The matching authorizations.
    """

    page: SearchQueryPageResponse
    items: list[AuthorizationResult] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        authorization_search_result = cls(
            page=page,
            items=items,
        )

        authorization_search_result.additional_properties = d
        return authorization_search_result

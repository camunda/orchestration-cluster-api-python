...
from ..models.cluster_balance_response_last_completed_rebalance_result import (
...
T = TypeVar("T", bound="ClusterBalanceResponseLastCompletedRebalance")


@_attrs_define
class ClusterBalanceResponseLastCompletedRebalance:
    ...
    Attributes:
        ...
        result (ClusterBalanceResponseLastCompletedRebalanceResult): How the rebalance ended. Example: COMPLETED.
    """
    ...
    result: ClusterBalanceResponseLastCompletedRebalanceResult
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        result = ClusterBalanceResponseLastCompletedRebalanceResult(d.pop("result"))

        cluster_balance_response_last_completed_rebalance = cls(
        ...
        cluster_balance_response_last_completed_rebalance.additional_properties = d
        return cluster_balance_response_last_completed_rebalance

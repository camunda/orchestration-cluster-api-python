...
@_attrs_define
class ResultAdvancedfilter:
    r"""Advanced AuditLogResultEnum filter.

    Attributes:
        eq (ResultAdvancedfilterEq | Unset): Checks for equality with the provided value.
        neq (ResultAdvancedfilterNeq | Unset): Checks for inequality with the provided value.
        exists (bool | Unset): Checks if the current property exists.
        in_ (list[ResultAdvancedfilterInItem] | Unset): Checks if the property matches any of the provided values.
    ...
    eq: ResultAdvancedfilterEq | Unset = UNSET
    neq: ResultAdvancedfilterNeq | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        _eq = d.pop("$eq", UNSET)
        eq: ResultAdvancedfilterEq | Unset
        if isinstance(_eq, Unset):
            eq = UNSET
        else:
            eq = ResultAdvancedfilterEq(_eq)

        _neq = d.pop("$neq", UNSET)
        neq: ResultAdvancedfilterNeq | Unset
        if isinstance(_neq, Unset):
            neq = UNSET
        else:
            neq = ResultAdvancedfilterNeq(_neq)
        ...
        if _in_ is not UNSET:
            ...
            for in_item_data in _in_:
                in_item = ResultAdvancedfilterInItem(in_item_data)

                in_.append(in_item)

        like = d.pop("$like", UNSET)

        result_advancedfilter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        result_advancedfilter.additional_properties = d
        return result_advancedfilter

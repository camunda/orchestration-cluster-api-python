...
T = TypeVar("T", bound="BatchOperationItemSearchQueryFilter")


@_attrs_define
class BatchOperationItemSearchQueryFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_operation_item_search_query_filter = cls(
        ...
        batch_operation_item_search_query_filter.additional_properties = d
        return batch_operation_item_search_query_filter

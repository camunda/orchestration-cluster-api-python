...
T = TypeVar("T", bound="MappingRuleUpdateRequest")


@_attrs_define
class MappingRuleUpdateRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mapping_rule_update_request.additional_properties = d
        return mapping_rule_update_request

...
class SearchBatchOperationsData:
    ...
    Attributes:
        ...
        filter_ (SearchBatchOperationsFilter | Unset): The batch operation search filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filter_: SearchBatchOperationsFilter | Unset
        if isinstance(_filter_, Unset):
            filter_ = UNSET
        else:
            filter_ = SearchBatchOperationsFilter.from_dict(_filter_)

...
T = TypeVar("T", bound="DeleteDecisionInstancesBatchOperationResponse403")


@_attrs_define
class DeleteDecisionInstancesBatchOperationResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_decision_instances_batch_operation_response_403 = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_decision_instances_batch_operation_response_403.additional_properties = d
        return delete_decision_instances_batch_operation_response_403

...
from ..models.agent_instance_document_content_document_reference_camunda_document_type import (
...
T = TypeVar("T", bound="AgentInstanceDocumentContentDocumentReference")


@_attrs_define
class AgentInstanceDocumentContentDocumentReference:
    """A reference to a document stored in the Camunda Document Store.

    Attributes:
        camunda_document_type (AgentInstanceDocumentContentDocumentReferenceCamundaDocumentType): Document
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_instance_document_content_document_reference = cls(
        ...
        agent_instance_document_content_document_reference.additional_properties = d
        return agent_instance_document_content_document_reference

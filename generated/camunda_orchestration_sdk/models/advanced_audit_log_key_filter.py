...
T = TypeVar("T", bound="AdvancedAuditLogKeyFilter")


@_attrs_define
class AdvancedAuditLogKeyFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advanced_audit_log_key_filter = cls(
            eq=eq,
            neq=neq,
            exists=exists,
            in_=in_,
        ...
        advanced_audit_log_key_filter.additional_properties = d
        return advanced_audit_log_key_filter

...
T = TypeVar("T", bound="DecisionRequirementsFilter")
...
class DecisionRequirementsFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        decision_requirements_filter = cls(
        ...
        decision_requirements_filter.additional_properties = d
        return decision_requirements_filter

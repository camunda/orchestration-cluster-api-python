...
T = TypeVar("T", bound="AgentInstanceHistoryItemResultMetrics")
...
class AgentInstanceHistoryItemResultMetrics:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_instance_history_item_result_metrics.additional_properties = d
        return agent_instance_history_item_result_metrics

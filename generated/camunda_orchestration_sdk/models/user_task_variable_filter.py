...
T = TypeVar("T", bound="UserTaskVariableFilter")


@_attrs_define
class UserTaskVariableFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_task_variable_filter = cls(
            name=name,
        )

        user_task_variable_filter.additional_properties = d
        return user_task_variable_filter

...
T = TypeVar("T", bound="ProcessInstanceSearchQueryResult")


@_attrs_define
class ProcessInstanceSearchQueryResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_instance_search_query_result.additional_properties = d
        return process_instance_search_query_result

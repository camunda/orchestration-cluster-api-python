...
T = TypeVar("T", bound="SearchBatchOperationItemsFilter")


@_attrs_define
class SearchBatchOperationItemsFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_batch_operation_items_filter = cls(
        ...
        search_batch_operation_items_filter.additional_properties = d
        return search_batch_operation_items_filter

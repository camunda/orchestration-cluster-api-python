...
T = TypeVar("T", bound="DecisionInstanceDeletionBatchOperationRequestFilter")


@_attrs_define
class DecisionInstanceDeletionBatchOperationRequestFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return decision_instance_deletion_batch_operation_request_filter

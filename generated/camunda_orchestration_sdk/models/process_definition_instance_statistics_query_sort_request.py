...
class ProcessDefinitionInstanceStatisticsQuerySortRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        field = ProcessDefinitionInstanceStatisticsQuerySortRequestField(d.pop("field"))
        ...
        process_definition_instance_statistics_query_sort_request = cls(
            field=field,
            order=order,
        )

        process_definition_instance_statistics_query_sort_request.additional_properties = d
        return process_definition_instance_statistics_query_sort_request

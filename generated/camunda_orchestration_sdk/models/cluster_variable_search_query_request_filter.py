...
@_attrs_define
class ClusterVariableSearchQueryRequestFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cluster_variable_search_query_request_filter = cls(
            name=name,
            value=value,
            scope=scope,
            tenant_id=tenant_id,
        ...
        cluster_variable_search_query_request_filter.additional_properties = d
        return cluster_variable_search_query_request_filter

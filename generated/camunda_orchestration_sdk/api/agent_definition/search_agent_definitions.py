...
def _get_kwargs(*, body: AgentDefinitionSearchQuery | Unset = UNSET) -> dict[str, Any]:
    headers: dict[str, Any] = {}
    _kwargs: dict[str, Any] = {"method": "post", "url": "/agent-definitions/search"}
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = AgentDefinitionSearchQueryResult.from_dict(response.json())
        return response_200
...
def sync_detailed(
    *, client: AuthenticatedClient, body: AgentDefinitionSearchQuery | Unset = UNSET
    ...
    Args:
        body (AgentDefinitionSearchQuery | Unset): Agent definition search request.
...
def sync(
    ...
    **kwargs: Any,
    ...
    if response.status_code < 200 or response.status_code >= 300:
        if response.status_code == 400:
            raise errors.BadRequestError(
                ...
                operation_id="search_agent_definitions",
            )
        if response.status_code == 401:
    ...
    return cast(AgentDefinitionSearchQueryResult, response.parsed)

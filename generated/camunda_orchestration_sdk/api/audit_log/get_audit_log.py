...
def sync_detailed(audit_log_key: str, *, client: AuthenticatedClient) -> Response[AuditLogResult | ProblemDetail]:
    """Get audit log
...
def sync(audit_log_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> AuditLogResult:
    """Get audit log
...
async def asyncio_detailed(audit_log_key: str, *, client: AuthenticatedClient) -> Response[AuditLogResult | ProblemDetail]:
    """Get audit log
...
async def asyncio(audit_log_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> AuditLogResult:
    """Get audit log

...
def sync_detailed(
    tenant_id: str, *, client: AuthenticatedClient
) -> Response[Any | ProblemDetail]:
    """Delete tenant
...
def sync(tenant_id: str, *, client: AuthenticatedClient, **kwargs: Any) -> None:
    ...
    if response.status_code < 200 or response.status_code >= 300:
        ...
        raise errors.UnexpectedStatus(
            response.status_code, response.content, operation_id="delete_tenant"
        )
    return None
...
async def asyncio(
    tenant_id: str, *, client: AuthenticatedClient, **kwargs: Any
) -> None:
    """Delete tenant

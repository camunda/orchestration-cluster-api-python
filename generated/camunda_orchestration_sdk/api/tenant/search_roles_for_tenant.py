...
def sync(tenant_id: str, *, client: AuthenticatedClient | Client, body: SearchRolesForTenantData | Unset=UNSET, **kwargs: Any) -> SearchRolesForTenantResponse200:
    """Search roles for tenant
...
async def asyncio(tenant_id: str, *, client: AuthenticatedClient | Client, body: SearchRolesForTenantData | Unset=UNSET, **kwargs: Any) -> SearchRolesForTenantResponse200:
    """Search roles for tenant

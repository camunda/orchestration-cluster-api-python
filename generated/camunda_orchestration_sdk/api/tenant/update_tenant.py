...
def sync(tenant_id: str, *, client: AuthenticatedClient | Client, body: UpdateTenantData, **kwargs: Any) -> UpdateTenantResponse200:
    """Update tenant
...
async def asyncio(tenant_id: str, *, client: AuthenticatedClient | Client, body: UpdateTenantData, **kwargs: Any) -> UpdateTenantResponse200:
    """Update tenant

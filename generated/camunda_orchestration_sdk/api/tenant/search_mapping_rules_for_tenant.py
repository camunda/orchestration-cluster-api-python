...
def sync(tenant_id: str, *, client: AuthenticatedClient | Client, body: SearchMappingRulesForTenantData | Unset=UNSET, **kwargs: Any) -> SearchMappingRulesForTenantResponse200:
    """Search mapping rules for tenant
...
async def asyncio(tenant_id: str, *, client: AuthenticatedClient | Client, body: SearchMappingRulesForTenantData | Unset=UNSET, **kwargs: Any) -> SearchMappingRulesForTenantResponse200:
    """Search mapping rules for tenant

...
def sync_detailed(
    tenant_id: str, username: str, *, client: AuthenticatedClient
) -> Response[Any | ProblemDetail]:
...
def sync(
    tenant_id: str, username: str, *, client: AuthenticatedClient, **kwargs: Any
) -> None:
    """Assign a user to a tenant
    ...
    if response.status_code < 200 or response.status_code >= 300:
        if response.status_code == 400:
            raise errors.BadRequestError(
                ...
                operation_id="assign_user_to_tenant",
            )
        if response.status_code == 403:
        ...
        raise errors.UnexpectedStatus(
            response.status_code, response.content, operation_id="assign_user_to_tenant"
        )
    return None

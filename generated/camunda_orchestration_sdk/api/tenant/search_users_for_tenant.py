...
def sync(tenant_id: str, *, client: AuthenticatedClient | Client, body: SearchUsersForTenantData | Unset=UNSET, **kwargs) -> SearchUsersForTenantResponse200:
    """Search users for tenant
...
async def asyncio(tenant_id: str, *, client: AuthenticatedClient | Client, body: SearchUsersForTenantData | Unset=UNSET, **kwargs) -> SearchUsersForTenantResponse200:
    """Search users for tenant

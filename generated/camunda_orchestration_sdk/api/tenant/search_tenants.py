...
def sync(*, client: AuthenticatedClient | Client, body: SearchTenantsData | Unset=UNSET, **kwargs: Any) -> SearchTenantsResponse200:
    """Search tenants
...
async def asyncio(*, client: AuthenticatedClient | Client, body: SearchTenantsData | Unset=UNSET, **kwargs: Any) -> SearchTenantsResponse200:
    """Search tenants

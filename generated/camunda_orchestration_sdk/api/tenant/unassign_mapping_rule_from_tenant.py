...
def sync_detailed(
    tenant_id: str, mapping_rule_id: str, *, client: AuthenticatedClient
) -> Response[Any | ProblemDetail]:
...
def sync(
    tenant_id: str, mapping_rule_id: str, *, client: AuthenticatedClient, **kwargs: Any
) -> None:
    """Unassign a mapping rule from a tenant
    ...
    if response.status_code < 200 or response.status_code >= 300:
        if response.status_code == 400:
            raise errors.BadRequestError(
                ...
                operation_id="unassign_mapping_rule_from_tenant",
            )
        if response.status_code == 403:

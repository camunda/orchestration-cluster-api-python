...
def sync_detailed(tenant_id: str, *, client: AuthenticatedClient | Client) -> Response[ProblemDetail | TenantResult]:
    """Get tenant
...
def sync(tenant_id: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> TenantResult:
    """Get tenant
...
async def asyncio_detailed(tenant_id: str, *, client: AuthenticatedClient | Client) -> Response[ProblemDetail | TenantResult]:
    """Get tenant
...
async def asyncio(tenant_id: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> TenantResult:
    """Get tenant

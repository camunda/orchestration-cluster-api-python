...
def sync(tenant_id: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetTenantResponse200:
    """Get tenant
...
async def asyncio(tenant_id: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetTenantResponse200:
    """Get tenant

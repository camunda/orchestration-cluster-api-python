...
def sync(tenant_id: str, *, client: AuthenticatedClient | Client, body: SearchGroupIdsForTenantData | Unset=UNSET, **kwargs) -> SearchGroupIdsForTenantResponse200:
    """Search groups for tenant
...
async def asyncio(tenant_id: str, *, client: AuthenticatedClient | Client, body: SearchGroupIdsForTenantData | Unset=UNSET, **kwargs) -> SearchGroupIdsForTenantResponse200:
    """Search groups for tenant

...
def _get_kwargs(tenant_id: str, *, body: SearchGroupIdsForTenantData | Unset=UNSET) -> dict[str, Any]:
...
def sync_detailed(tenant_id: str, *, client: AuthenticatedClient | Client, body: SearchGroupIdsForTenantData | Unset=UNSET) -> Response[SearchGroupIdsForTenantResponse200]:
...
def sync(tenant_id: str, *, client: AuthenticatedClient | Client, body: SearchGroupIdsForTenantData | Unset=UNSET, **kwargs: Any) -> SearchGroupIdsForTenantResponse200:
    """Search groups for tenant
...
async def asyncio_detailed(tenant_id: str, *, client: AuthenticatedClient | Client, body: SearchGroupIdsForTenantData | Unset=UNSET) -> Response[SearchGroupIdsForTenantResponse200]:
    """Search groups for tenant
...
async def asyncio(tenant_id: str, *, client: AuthenticatedClient | Client, body: SearchGroupIdsForTenantData | Unset=UNSET, **kwargs: Any) -> SearchGroupIdsForTenantResponse200:
    """Search groups for tenant

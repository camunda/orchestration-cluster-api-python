...
def sync_detailed(process_definition_key: str, *, client: AuthenticatedClient | Client) -> Response[ProblemDetail | str]:
...
def sync(process_definition_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> str:
    """Get process definition XML
...
async def asyncio_detailed(process_definition_key: str, *, client: AuthenticatedClient | Client) -> Response[ProblemDetail | str]:
    """Get process definition XML
...
async def asyncio(process_definition_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> str:
    """Get process definition XML

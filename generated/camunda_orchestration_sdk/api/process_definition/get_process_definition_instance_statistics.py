...
def sync_detailed(*, client: AuthenticatedClient | Client, body: ProcessDefinitionInstanceStatisticsQuery | Unset=UNSET) -> Response[ProblemDetail | ProcessDefinitionInstanceStatisticsQueryResult]:
...
def sync(*, client: AuthenticatedClient | Client, body: ProcessDefinitionInstanceStatisticsQuery | Unset=UNSET, **kwargs: Any) -> ProcessDefinitionInstanceStatisticsQueryResult:
    """Get process instance statistics
...
async def asyncio_detailed(*, client: AuthenticatedClient | Client, body: ProcessDefinitionInstanceStatisticsQuery | Unset=UNSET) -> Response[ProblemDetail | ProcessDefinitionInstanceStatisticsQueryResult]:
    """Get process instance statistics
...
async def asyncio(*, client: AuthenticatedClient | Client, body: ProcessDefinitionInstanceStatisticsQuery | Unset=UNSET, **kwargs: Any) -> ProcessDefinitionInstanceStatisticsQueryResult:
    """Get process instance statistics

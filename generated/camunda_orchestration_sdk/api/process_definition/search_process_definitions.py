...
def sync(*, client: AuthenticatedClient | Client, body: SearchProcessDefinitionsData | Unset=UNSET, **kwargs: Any) -> SearchProcessDefinitionsResponse200:
    """Search process definitions
...
async def asyncio(*, client: AuthenticatedClient | Client, body: SearchProcessDefinitionsData | Unset=UNSET, **kwargs: Any) -> SearchProcessDefinitionsResponse200:
    """Search process definitions

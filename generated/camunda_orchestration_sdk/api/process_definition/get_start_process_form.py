...
def sync(process_definition_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetStartProcessFormResponse200:
    """Get process start form
...
async def asyncio(process_definition_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetStartProcessFormResponse200:
    """Get process start form

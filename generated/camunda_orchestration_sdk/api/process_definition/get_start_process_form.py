...
def sync_detailed(process_definition_key: str, *, client: AuthenticatedClient) -> Response[Any | FormResult | ProblemDetail]:
...
def sync(process_definition_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> FormResult:
    """Get process start form
...
async def asyncio_detailed(process_definition_key: str, *, client: AuthenticatedClient) -> Response[Any | FormResult | ProblemDetail]:
    """Get process start form
...
async def asyncio(process_definition_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> FormResult:
    """Get process start form

...
def sync(ad_hoc_sub_process_instance_key: str, *, client: AuthenticatedClient | Client, body: ActivateAdHocSubProcessActivitiesData, **kwargs: Any) -> None:
    """Activate activities within an ad-hoc sub-process
...
async def asyncio(ad_hoc_sub_process_instance_key: str, *, client: AuthenticatedClient | Client, body: ActivateAdHocSubProcessActivitiesData, **kwargs: Any) -> None:
    """Activate activities within an ad-hoc sub-process

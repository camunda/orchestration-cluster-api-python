...
def sync_detailed(ad_hoc_sub_process_instance_key: str, *, client: AuthenticatedClient | Client, body: AdHocSubProcessActivateActivitiesInstruction) -> Response[Any | ProblemDetail]:
...
def sync(ad_hoc_sub_process_instance_key: str, *, client: AuthenticatedClient | Client, body: AdHocSubProcessActivateActivitiesInstruction, **kwargs: Any) -> None:
    """Activate activities within an ad-hoc sub-process
...
async def asyncio_detailed(ad_hoc_sub_process_instance_key: str, *, client: AuthenticatedClient | Client, body: AdHocSubProcessActivateActivitiesInstruction) -> Response[Any | ProblemDetail]:
    """Activate activities within an ad-hoc sub-process
...
async def asyncio(ad_hoc_sub_process_instance_key: str, *, client: AuthenticatedClient | Client, body: AdHocSubProcessActivateActivitiesInstruction, **kwargs: Any) -> None:
    """Activate activities within an ad-hoc sub-process

...
def sync(*, client: AuthenticatedClient | Client, body: DeleteDecisionInstancesBatchOperationData, **kwargs: Any) -> DeleteDecisionInstancesBatchOperationResponse200:
    """Delete decision instances (batch)
...
async def asyncio(*, client: AuthenticatedClient | Client, body: DeleteDecisionInstancesBatchOperationData, **kwargs: Any) -> DeleteDecisionInstancesBatchOperationResponse200:
    """Delete decision instances (batch)

...
from ...models.delete_decision_instances_batch_operation_response_400 import (
    DeleteDecisionInstancesBatchOperationResponse400,
)
from ...models.delete_decision_instances_batch_operation_response_401 import (
    DeleteDecisionInstancesBatchOperationResponse401,
)
from ...models.delete_decision_instances_batch_operation_response_403 import (
    DeleteDecisionInstancesBatchOperationResponse403,
)
from ...models.delete_decision_instances_batch_operation_response_500 import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = DeleteDecisionInstancesBatchOperationResponse200.from_dict(
            response.json()
        )
        return response_200
    if response.status_code == 400:
        response_400 = DeleteDecisionInstancesBatchOperationResponse400.from_dict(
            response.json()
        )
        return response_400
    if response.status_code == 401:
        response_401 = DeleteDecisionInstancesBatchOperationResponse401.from_dict(
            response.json()
        )
        return response_401
    if response.status_code == 403:
        response_403 = DeleteDecisionInstancesBatchOperationResponse403.from_dict(
            response.json()
        )
        return response_403
    if response.status_code == 500:
        response_500 = DeleteDecisionInstancesBatchOperationResponse500.from_dict(
            response.json()
        )
        return response_500
...
def sync_detailed(
    *,
    ...
    body: DeleteDecisionInstancesBatchOperationData,
) -> Response[
    DeleteDecisionInstancesBatchOperationResponse200
    | DeleteDecisionInstancesBatchOperationResponse400
    | DeleteDecisionInstancesBatchOperationResponse401
    ...
    if response.status_code < 200 or response.status_code >= 300:
        if response.status_code == 400:
            raise errors.DeleteDecisionInstancesBatchOperationBadRequest(
                ...
                content=response.content,
                parsed=cast(
                    DeleteDecisionInstancesBatchOperationResponse400, response.parsed
                ),
            )
        if response.status_code == 401:
            raise errors.DeleteDecisionInstancesBatchOperationUnauthorized(
                ...
                content=response.content,
                parsed=cast(
                    DeleteDecisionInstancesBatchOperationResponse401, response.parsed
                ),
            )
        if response.status_code == 403:
            raise errors.DeleteDecisionInstancesBatchOperationForbidden(
                ...
                content=response.content,
                parsed=cast(
                    DeleteDecisionInstancesBatchOperationResponse403, response.parsed
                ),
            )
        if response.status_code == 500:
            raise errors.DeleteDecisionInstancesBatchOperationInternalServerError(
                ...
                content=response.content,
                parsed=cast(
                    DeleteDecisionInstancesBatchOperationResponse500, response.parsed
                ),
            )
        raise errors.UnexpectedStatus(response.status_code, response.content)
    assert response.parsed is not None
    return cast(DeleteDecisionInstancesBatchOperationResponse200, response.parsed)

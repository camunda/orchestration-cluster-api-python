...
def sync(decision_evaluation_instance_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetDecisionInstanceResponse200:
    """Get decision instance
...
async def asyncio(decision_evaluation_instance_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetDecisionInstanceResponse200:
    """Get decision instance

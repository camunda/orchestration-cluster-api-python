...
def sync_detailed(*, client: AuthenticatedClient, body: DecisionInstanceSearchQuery | Unset=UNSET) -> Response[DecisionInstanceSearchQueryResult | ProblemDetail]:
...
def sync(*, client: AuthenticatedClient, body: DecisionInstanceSearchQuery | Unset=UNSET, **kwargs: Any) -> DecisionInstanceSearchQueryResult:
    """Search decision instances
...
async def asyncio_detailed(*, client: AuthenticatedClient, body: DecisionInstanceSearchQuery | Unset=UNSET) -> Response[DecisionInstanceSearchQueryResult | ProblemDetail]:
    """Search decision instances
...
async def asyncio(*, client: AuthenticatedClient, body: DecisionInstanceSearchQuery | Unset=UNSET, **kwargs: Any) -> DecisionInstanceSearchQueryResult:
    """Search decision instances

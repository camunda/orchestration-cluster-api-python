...
def sync_detailed(batch_operation_key: str, *, client: AuthenticatedClient) -> Response[BatchOperationResponse | ProblemDetail]:
    """Get batch operation
...
def sync(batch_operation_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> BatchOperationResponse:
    """Get batch operation
...
async def asyncio_detailed(batch_operation_key: str, *, client: AuthenticatedClient) -> Response[BatchOperationResponse | ProblemDetail]:
    """Get batch operation
...
async def asyncio(batch_operation_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> BatchOperationResponse:
    """Get batch operation

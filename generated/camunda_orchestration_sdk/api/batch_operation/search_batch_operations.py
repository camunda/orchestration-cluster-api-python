...
def sync(*, client: AuthenticatedClient | Client, body: SearchBatchOperationsData | Unset=UNSET, **kwargs) -> SearchBatchOperationsResponse200:
    """Search batch operations
...
async def asyncio(*, client: AuthenticatedClient | Client, body: SearchBatchOperationsData | Unset=UNSET, **kwargs) -> SearchBatchOperationsResponse200:
    """Search batch operations

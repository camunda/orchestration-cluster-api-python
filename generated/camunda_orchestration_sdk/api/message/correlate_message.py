...
def sync_detailed(
    *, client: AuthenticatedClient, body: MessageCorrelationRequest
) -> Response[MessageCorrelationResult | ProblemDetail]:
    """Correlate message
...
def sync(
    *, client: AuthenticatedClient, body: MessageCorrelationRequest, **kwargs: Any
    ...
    if response.status_code < 200 or response.status_code >= 300:
        if response.status_code == 400:
            raise errors.BadRequestError(
                ...
                operation_id="correlate_message",
            )
        if response.status_code == 403:
        ...
        raise errors.UnexpectedStatus(
            response.status_code, response.content, operation_id="correlate_message"
        )

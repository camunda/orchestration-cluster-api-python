...
def sync_detailed(
    *, client: AuthenticatedClient, body: MessagePublicationRequest
) -> Response[MessagePublicationResult | ProblemDetail]:
    """Publish message
...
def sync(
    *, client: AuthenticatedClient, body: MessagePublicationRequest, **kwargs: Any
    ...
    if response.status_code < 200 or response.status_code >= 300:
        ...
        raise errors.UnexpectedStatus(
            response.status_code, response.content, operation_id="publish_message"
        )

...
def sync(*, client: AuthenticatedClient | Client, body: PublishMessageData, **kwargs: Any) -> PublishMessageResponse200:
    """Publish message
...
async def asyncio(*, client: AuthenticatedClient | Client, body: PublishMessageData, **kwargs: Any) -> PublishMessageResponse200:
    """Publish message

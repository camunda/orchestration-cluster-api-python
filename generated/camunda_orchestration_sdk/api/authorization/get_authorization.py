...
def sync_detailed(authorization_key: str, *, client: AuthenticatedClient | Client) -> Response[AuthorizationResult | ProblemDetail]:
    """Get authorization
...
def sync(authorization_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> AuthorizationResult:
    """Get authorization
...
async def asyncio_detailed(authorization_key: str, *, client: AuthenticatedClient | Client) -> Response[AuthorizationResult | ProblemDetail]:
    """Get authorization
...
async def asyncio(authorization_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> AuthorizationResult:
    """Get authorization

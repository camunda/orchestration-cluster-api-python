...
def sync(authorization_key: str, *, client: AuthenticatedClient | Client, body: Object | Object1, **kwargs: Any) -> None:
    """Update authorization
...
async def asyncio(authorization_key: str, *, client: AuthenticatedClient | Client, body: Object | Object1, **kwargs: Any) -> None:
    """Update authorization

...
def sync_detailed(decision_requirements_key: str, *, client: AuthenticatedClient) -> Response[DecisionRequirementsResult | ProblemDetail]:
...
def sync(decision_requirements_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> DecisionRequirementsResult:
    """Get decision requirements
...
async def asyncio_detailed(decision_requirements_key: str, *, client: AuthenticatedClient) -> Response[DecisionRequirementsResult | ProblemDetail]:
    """Get decision requirements
...
async def asyncio(decision_requirements_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> DecisionRequirementsResult:
    """Get decision requirements

...
def sync(*, client: AuthenticatedClient | Client, body: SearchDecisionRequirementsData | Unset=UNSET, **kwargs) -> SearchDecisionRequirementsResponse200:
    """Search decision requirements
...
async def asyncio(*, client: AuthenticatedClient | Client, body: SearchDecisionRequirementsData | Unset=UNSET, **kwargs) -> SearchDecisionRequirementsResponse200:
    """Search decision requirements

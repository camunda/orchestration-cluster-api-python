...
def sync(element_instance_key: str, *, client: AuthenticatedClient | Client, body: SearchElementInstanceIncidentsData, **kwargs: Any) -> SearchElementInstanceIncidentsResponse200:
    """Search for incidents of a specific element instance
...
async def asyncio(element_instance_key: str, *, client: AuthenticatedClient | Client, body: SearchElementInstanceIncidentsData, **kwargs: Any) -> SearchElementInstanceIncidentsResponse200:
    """Search for incidents of a specific element instance

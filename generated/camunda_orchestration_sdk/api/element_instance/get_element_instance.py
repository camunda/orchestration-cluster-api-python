...
def sync_detailed(element_instance_key: str, *, client: AuthenticatedClient) -> Response[ElementInstanceResult | ProblemDetail]:
...
def sync(element_instance_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> ElementInstanceResult:
    """Get element instance
...
async def asyncio_detailed(element_instance_key: str, *, client: AuthenticatedClient) -> Response[ElementInstanceResult | ProblemDetail]:
    """Get element instance
...
async def asyncio(element_instance_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> ElementInstanceResult:
    """Get element instance

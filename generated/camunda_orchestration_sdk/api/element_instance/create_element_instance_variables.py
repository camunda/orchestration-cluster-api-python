...
def sync(element_instance_key: str, *, client: AuthenticatedClient | Client, body: CreateElementInstanceVariablesData, **kwargs: Any) -> None:
    """Update element instance variables
...
async def asyncio(element_instance_key: str, *, client: AuthenticatedClient | Client, body: CreateElementInstanceVariablesData, **kwargs: Any) -> None:
    """Update element instance variables

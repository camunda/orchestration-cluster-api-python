...
def sync_detailed(element_instance_key: str, *, client: AuthenticatedClient, body: SetVariableRequest) -> Response[Any | ProblemDetail]:
...
def sync(element_instance_key: str, *, client: AuthenticatedClient, body: SetVariableRequest, **kwargs: Any) -> None:
    """Update element instance variables
...
async def asyncio_detailed(element_instance_key: str, *, client: AuthenticatedClient, body: SetVariableRequest) -> Response[Any | ProblemDetail]:
    """Update element instance variables
...
async def asyncio(element_instance_key: str, *, client: AuthenticatedClient, body: SetVariableRequest, **kwargs: Any) -> None:
    """Update element instance variables

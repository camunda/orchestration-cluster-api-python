...
def sync(*, client: AuthenticatedClient | Client, body: CreateAdminUserData, **kwargs: Any) -> None:
    """Create admin user
...
async def asyncio(*, client: AuthenticatedClient | Client, body: CreateAdminUserData, **kwargs: Any) -> None:
    """Create admin user

...
def sync_detailed(user_task_key: str, *, client: AuthenticatedClient | Client, body: SearchUserTaskVariablesData | Unset=UNSET, truncate_values: bool | Unset=UNSET) -> Response[ProblemDetail | VariableSearchQueryResult]:
...
def sync(user_task_key: str, *, client: AuthenticatedClient | Client, body: SearchUserTaskVariablesData | Unset=UNSET, truncate_values: bool | Unset=UNSET, **kwargs: Any) -> VariableSearchQueryResult:
    """Search user task variables
...
async def asyncio_detailed(user_task_key: str, *, client: AuthenticatedClient | Client, body: SearchUserTaskVariablesData | Unset=UNSET, truncate_values: bool | Unset=UNSET) -> Response[ProblemDetail | VariableSearchQueryResult]:
    """Search user task variables
...
async def asyncio(user_task_key: str, *, client: AuthenticatedClient | Client, body: SearchUserTaskVariablesData | Unset=UNSET, truncate_values: bool | Unset=UNSET, **kwargs: Any) -> VariableSearchQueryResult:
    """Search user task variables

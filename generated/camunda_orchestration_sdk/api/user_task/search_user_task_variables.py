...
from ...models.user_task_variable_search_query_request import UserTaskVariableSearchQueryRequest
from ...models.variable_search_query_result import VariableSearchQueryResult
from ...types import UNSET, Response, Unset

def _get_kwargs(user_task_key: str, *, body: UserTaskVariableSearchQueryRequest | Unset=UNSET, truncate_values: bool | Unset=UNSET) -> dict[str, Any]:
...
def sync_detailed(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskVariableSearchQueryRequest | Unset=UNSET, truncate_values: bool | Unset=UNSET) -> Response[ProblemDetail | VariableSearchQueryResult]:
...
def sync(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskVariableSearchQueryRequest | Unset=UNSET, truncate_values: bool | Unset=UNSET, **kwargs: Any) -> VariableSearchQueryResult:
    """Search user task variables
...
Returns:
    ...
    if response.status_code < 200 or response.status_code >= 300:
        if response.status_code == 400:
            raise errors.BadRequestError(status_code=response.status_code, content=response.content, parsed=cast(ProblemDetail, response.parsed), operation_id='search_user_task_variables')
        if response.status_code == 500:
            raise errors.InternalServerErrorError(status_code=response.status_code, content=response.content, parsed=cast(ProblemDetail, response.parsed), operation_id='search_user_task_variables')
        raise errors.UnexpectedStatus(response.status_code, response.content, operation_id='search_user_task_variables')
    assert response.parsed is not None
    return cast(VariableSearchQueryResult, response.parsed)

async def asyncio_detailed(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskVariableSearchQueryRequest | Unset=UNSET, truncate_values: bool | Unset=UNSET) -> Response[ProblemDetail | VariableSearchQueryResult]:
    """Search user task variables
...
async def asyncio(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskVariableSearchQueryRequest | Unset=UNSET, truncate_values: bool | Unset=UNSET, **kwargs: Any) -> VariableSearchQueryResult:
    """Search user task variables

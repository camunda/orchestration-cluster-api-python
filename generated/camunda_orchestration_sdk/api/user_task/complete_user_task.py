...
def sync_detailed(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskCompletionRequest | Unset=UNSET) -> Response[Any | ProblemDetail]:
    """Complete user task
...
def sync(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskCompletionRequest | Unset=UNSET, **kwargs: Any) -> None:
    """Complete user task
...
async def asyncio_detailed(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskCompletionRequest | Unset=UNSET) -> Response[Any | ProblemDetail]:
    """Complete user task
...
async def asyncio(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskCompletionRequest | Unset=UNSET, **kwargs: Any) -> None:
    """Complete user task

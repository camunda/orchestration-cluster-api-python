...
def sync(user_task_key: str, *, client: AuthenticatedClient | Client, body: CompleteUserTaskData | Unset=UNSET, **kwargs: Any) -> None:
    """Complete user task
...
async def asyncio(user_task_key: str, *, client: AuthenticatedClient | Client, body: CompleteUserTaskData | Unset=UNSET, **kwargs: Any) -> None:
    """Complete user task

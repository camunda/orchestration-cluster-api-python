...
def sync_detailed(user_task_key: str, *, client: AuthenticatedClient) -> Response[ProblemDetail | UserTaskResult]:
    """Get user task
...
def sync(user_task_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> UserTaskResult:
    """Get user task
...
async def asyncio_detailed(user_task_key: str, *, client: AuthenticatedClient) -> Response[ProblemDetail | UserTaskResult]:
    """Get user task
...
async def asyncio(user_task_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> UserTaskResult:
    """Get user task

...
def sync_detailed(user_task_key: str, *, client: AuthenticatedClient) -> Response[Any | FormResult | ProblemDetail]:
    """Get user task form
...
def sync(user_task_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> FormResult:
    """Get user task form
...
async def asyncio_detailed(user_task_key: str, *, client: AuthenticatedClient) -> Response[Any | FormResult | ProblemDetail]:
    """Get user task form
...
async def asyncio(user_task_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> FormResult:
    """Get user task form

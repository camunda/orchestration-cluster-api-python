...
def sync_detailed(*, client: AuthenticatedClient, body: UserTaskSearchQuery | Unset=UNSET) -> Response[ProblemDetail | UserTaskSearchQueryResult]:
    """Search user tasks
...
def sync(*, client: AuthenticatedClient, body: UserTaskSearchQuery | Unset=UNSET, **kwargs: Any) -> UserTaskSearchQueryResult:
    """Search user tasks
...
async def asyncio_detailed(*, client: AuthenticatedClient, body: UserTaskSearchQuery | Unset=UNSET) -> Response[ProblemDetail | UserTaskSearchQueryResult]:
    """Search user tasks
...
async def asyncio(*, client: AuthenticatedClient, body: UserTaskSearchQuery | Unset=UNSET, **kwargs: Any) -> UserTaskSearchQueryResult:
    """Search user tasks

...
def sync(user_task_key: str, *, client: AuthenticatedClient | Client, body: AssignUserTaskData, **kwargs: Any) -> None:
    """Assign user task
...
async def asyncio(user_task_key: str, *, client: AuthenticatedClient | Client, body: AssignUserTaskData, **kwargs: Any) -> None:
    """Assign user task

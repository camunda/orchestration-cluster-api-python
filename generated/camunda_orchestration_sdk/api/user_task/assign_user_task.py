...
def sync_detailed(
    user_task_key: str, *, client: AuthenticatedClient, body: UserTaskAssignmentRequest
) -> Response[Any | ProblemDetail]:
    """Assign user task
    ...
    **kwargs: Any,
    ...
    if response.status_code < 200 or response.status_code >= 300:
        ...
        raise errors.UnexpectedStatus(
            response.status_code, response.content, operation_id="assign_user_task"
        )
    return None

...
def sync_detailed(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskAssignmentRequest) -> Response[Any | ProblemDetail]:
    """Assign user task
...
def sync(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskAssignmentRequest, **kwargs: Any) -> None:
    """Assign user task
...
async def asyncio_detailed(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskAssignmentRequest) -> Response[Any | ProblemDetail]:
    """Assign user task
...
async def asyncio(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskAssignmentRequest, **kwargs: Any) -> None:
    """Assign user task

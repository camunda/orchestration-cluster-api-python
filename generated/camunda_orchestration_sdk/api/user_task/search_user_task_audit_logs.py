...
def sync_detailed(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskAuditLogSearchQueryRequest | Unset=UNSET) -> Response[AuditLogSearchQueryResult | ProblemDetail]:
...
def sync(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskAuditLogSearchQueryRequest | Unset=UNSET, **kwargs: Any) -> AuditLogSearchQueryResult:
    """Search user task audit logs
...
async def asyncio_detailed(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskAuditLogSearchQueryRequest | Unset=UNSET) -> Response[AuditLogSearchQueryResult | ProblemDetail]:
    """Search user task audit logs
...
async def asyncio(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskAuditLogSearchQueryRequest | Unset=UNSET, **kwargs: Any) -> AuditLogSearchQueryResult:
    """Search user task audit logs

...
def sync(user_task_key: str, *, client: AuthenticatedClient | Client, body: SearchUserTaskAuditLogsData | Unset=UNSET, **kwargs: Any) -> SearchUserTaskAuditLogsResponse200:
    """Search user task audit logs
...
async def asyncio(user_task_key: str, *, client: AuthenticatedClient | Client, body: SearchUserTaskAuditLogsData | Unset=UNSET, **kwargs: Any) -> SearchUserTaskAuditLogsResponse200:
    """Search user task audit logs

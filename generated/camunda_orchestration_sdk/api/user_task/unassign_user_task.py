...
def _get_kwargs(user_task_key: str) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/user-tasks/{user_task_key}/assignee".format(
...
def sync_detailed(
    user_task_key: str, *, client: AuthenticatedClient
) -> Response[Any | ProblemDetail]:
    """Unassign user task
    ...
    if response.status_code < 200 or response.status_code >= 300:
        if response.status_code == 400:
            raise errors.BadRequestError(
                ...
                operation_id="unassign_user_task",
            )
        if response.status_code == 404:
        ...
        raise errors.UnexpectedStatus(
            response.status_code, response.content, operation_id="unassign_user_task"
        )
    return None
...
async def asyncio(
    user_task_key: str, *, client: AuthenticatedClient, **kwargs: Any
) -> None:
    """Unassign user task

...
def sync_detailed(user_task_key: str, *, client: AuthenticatedClient | Client) -> Response[Any | ProblemDetail]:
    """Unassign user task
...
async def asyncio_detailed(user_task_key: str, *, client: AuthenticatedClient | Client) -> Response[Any | ProblemDetail]:
    """Unassign user task

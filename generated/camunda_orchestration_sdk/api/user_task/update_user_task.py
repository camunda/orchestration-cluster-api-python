...
def sync_detailed(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskUpdateRequest | Unset=UNSET) -> Response[Any | ProblemDetail]:
    """Update user task
...
def sync(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskUpdateRequest | Unset=UNSET, **kwargs: Any) -> None:
    """Update user task
...
async def asyncio_detailed(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskUpdateRequest | Unset=UNSET) -> Response[Any | ProblemDetail]:
    """Update user task
...
async def asyncio(user_task_key: str, *, client: AuthenticatedClient, body: UserTaskUpdateRequest | Unset=UNSET, **kwargs: Any) -> None:
    """Update user task

...
def sync(user_task_key: str, *, client: AuthenticatedClient | Client, body: UpdateUserTaskData | Unset=UNSET, **kwargs: Any) -> None:
    """Update user task
...
async def asyncio(user_task_key: str, *, client: AuthenticatedClient | Client, body: UpdateUserTaskData | Unset=UNSET, **kwargs: Any) -> None:
    """Update user task

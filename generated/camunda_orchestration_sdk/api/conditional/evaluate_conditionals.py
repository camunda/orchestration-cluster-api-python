...
def sync(*, client: AuthenticatedClient | Client, body: EvaluateConditionalsData, **kwargs: Any) -> EvaluateConditionalsResponse200:
    """Evaluate root level conditional start events
...
async def asyncio(*, client: AuthenticatedClient | Client, body: EvaluateConditionalsData, **kwargs: Any) -> EvaluateConditionalsResponse200:
    """Evaluate root level conditional start events

...
def sync_detailed(
    *, client: AuthenticatedClient, body: JobActivationRequest
) -> Response[JobActivationResult | ProblemDetail]:
    """Activate jobs
...
def sync(
    *, client: AuthenticatedClient, body: JobActivationRequest, **kwargs: Any
) -> JobActivationResult:
    """Activate jobs
    ...
    if response.status_code < 200 or response.status_code >= 300:
        ...
        raise errors.UnexpectedStatus(
            response.status_code, response.content, operation_id="activate_jobs"
        )

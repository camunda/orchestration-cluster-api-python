...
def sync(*, client: AuthenticatedClient | Client, body: ActivateJobsData, **kwargs: Any) -> ActivateJobsResponse200:
    """Activate jobs
...
async def asyncio(*, client: AuthenticatedClient | Client, body: ActivateJobsData, **kwargs: Any) -> ActivateJobsResponse200:
    """Activate jobs

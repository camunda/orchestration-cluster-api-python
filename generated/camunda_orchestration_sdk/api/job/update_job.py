...
def sync_detailed(
    job_key: str, *, client: AuthenticatedClient, body: JobUpdateRequest
) -> Response[Any | ProblemDetail]:
    """Update job
...
def sync(
    job_key: str, *, client: AuthenticatedClient, body: JobUpdateRequest, **kwargs: Any
) -> None:
    """Update job
    ...
    if response.status_code < 200 or response.status_code >= 300:
        ...
        raise errors.UnexpectedStatus(
            response.status_code, response.content, operation_id="update_job"
        )
    return None

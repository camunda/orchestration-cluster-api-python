...
def sync_detailed(
    job_key: str, *, client: AuthenticatedClient, body: JobErrorRequest
) -> Response[Any | ProblemDetail]:
    """Throw error for job
...
def sync(
    job_key: str, *, client: AuthenticatedClient, body: JobErrorRequest, **kwargs: Any
) -> None:
    """Throw error for job
    ...
    if response.status_code < 200 or response.status_code >= 300:
        ...
        raise errors.UnexpectedStatus(
            response.status_code, response.content, operation_id="throw_job_error"
        )
    return None

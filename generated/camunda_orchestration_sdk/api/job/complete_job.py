...
def sync(job_key: str, *, client: AuthenticatedClient | Client, body: CompleteJobData | Unset=UNSET, **kwargs: Any) -> None:
    """Complete job
...
async def asyncio(job_key: str, *, client: AuthenticatedClient | Client, body: CompleteJobData | Unset=UNSET, **kwargs: Any) -> None:
    """Complete job

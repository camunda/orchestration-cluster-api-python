...
def sync_detailed(*, client: AuthenticatedClient, body: JobErrorStatisticsQuery) -> Response[JobErrorStatisticsQueryResult | ProblemDetail]:
...
def sync(*, client: AuthenticatedClient, body: JobErrorStatisticsQuery, **kwargs: Any) -> JobErrorStatisticsQueryResult:
    """Get error metrics for a job type
...
async def asyncio_detailed(*, client: AuthenticatedClient, body: JobErrorStatisticsQuery) -> Response[JobErrorStatisticsQueryResult | ProblemDetail]:
    """Get error metrics for a job type
...
async def asyncio(*, client: AuthenticatedClient, body: JobErrorStatisticsQuery, **kwargs: Any) -> JobErrorStatisticsQueryResult:
    """Get error metrics for a job type

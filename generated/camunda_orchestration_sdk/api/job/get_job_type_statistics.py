...
def sync_detailed(
    *, client: AuthenticatedClient, body: JobTypeStatisticsQuery
) -> Response[JobTypeStatisticsQueryResult | ProblemDetail]:
...
def sync(
    *, client: AuthenticatedClient, body: JobTypeStatisticsQuery, **kwargs: Any
    ...
    if response.status_code < 200 or response.status_code >= 300:
        if response.status_code == 400:
            raise errors.BadRequestError(
                ...
                operation_id="get_job_type_statistics",
            )
        if response.status_code == 401:

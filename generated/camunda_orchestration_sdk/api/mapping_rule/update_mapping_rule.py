...
def sync(mapping_rule_id: str, *, client: AuthenticatedClient | Client, body: UpdateMappingRuleData | Unset=UNSET, **kwargs: Any) -> UpdateMappingRuleResponse200:
    """Update mapping rule
...
async def asyncio(mapping_rule_id: str, *, client: AuthenticatedClient | Client, body: UpdateMappingRuleData | Unset=UNSET, **kwargs: Any) -> UpdateMappingRuleResponse200:
    """Update mapping rule

...
def sync(*, client: AuthenticatedClient | Client, body: CreateMappingRuleData | Unset=UNSET, **kwargs) -> CreateMappingRuleResponse201:
    """Create mapping rule
...
async def asyncio(*, client: AuthenticatedClient | Client, body: CreateMappingRuleData | Unset=UNSET, **kwargs) -> CreateMappingRuleResponse201:
    """Create mapping rule

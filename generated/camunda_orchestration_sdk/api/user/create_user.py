...
def sync_detailed(
    *, client: AuthenticatedClient, body: UserRequest
) -> Response[ProblemDetail | UserCreateResult]:
    """Create user
...
def sync(
    *, client: AuthenticatedClient, body: UserRequest, **kwargs: Any
) -> UserCreateResult:
    """Create user
    ...
    if response.status_code < 200 or response.status_code >= 300:
        ...
        raise errors.UnexpectedStatus(
            response.status_code, response.content, operation_id="create_user"
        )

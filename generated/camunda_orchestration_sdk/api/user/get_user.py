...
def sync_detailed(username: str, *, client: AuthenticatedClient) -> Response[ProblemDetail | UserResult]:
    """Get user
...
def sync(username: str, *, client: AuthenticatedClient, **kwargs: Any) -> UserResult:
    """Get user
...
async def asyncio_detailed(username: str, *, client: AuthenticatedClient) -> Response[ProblemDetail | UserResult]:
    """Get user
...
async def asyncio(username: str, *, client: AuthenticatedClient, **kwargs: Any) -> UserResult:
    """Get user

...
def sync_detailed(
    *, client: AuthenticatedClient, body: SignalBroadcastRequest
) -> Response[ProblemDetail | SignalBroadcastResult]:
    """Broadcast signal
...
def sync(
    *, client: AuthenticatedClient, body: SignalBroadcastRequest, **kwargs: Any
    ...
    if response.status_code < 200 or response.status_code >= 300:
        ...
        raise errors.UnexpectedStatus(
            response.status_code, response.content, operation_id="broadcast_signal"
        )

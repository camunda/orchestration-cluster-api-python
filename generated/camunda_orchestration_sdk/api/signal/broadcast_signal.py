...
def sync(*, client: AuthenticatedClient | Client, body: BroadcastSignalData, **kwargs: Any) -> BroadcastSignalResponse200:
    """Broadcast signal
...
async def asyncio(*, client: AuthenticatedClient | Client, body: BroadcastSignalData, **kwargs: Any) -> BroadcastSignalResponse200:
    """Broadcast signal

...
def sync(*, client: AuthenticatedClient | Client, body: DecisionevaluationbyID | Decisionevaluationbykey, **kwargs: Any) -> EvaluateDecisionResponse200:
    """Evaluate decision
...
async def asyncio(*, client: AuthenticatedClient | Client, body: DecisionevaluationbyID | Decisionevaluationbykey, **kwargs: Any) -> EvaluateDecisionResponse200:
    """Evaluate decision

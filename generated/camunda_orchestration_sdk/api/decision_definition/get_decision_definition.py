...
def sync_detailed(
    decision_definition_key: str, *, client: AuthenticatedClient
) -> Response[DecisionDefinitionResult | ProblemDetail]:
...
def sync(
    decision_definition_key: str, *, client: AuthenticatedClient, **kwargs: Any
    ...
    if response.status_code < 200 or response.status_code >= 300:
        if response.status_code == 400:
            raise errors.BadRequestError(
                ...
                operation_id="get_decision_definition",
            )
        if response.status_code == 401:

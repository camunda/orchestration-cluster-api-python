...
def sync(*, client: AuthenticatedClient | Client, body: SearchClusterVariablesData | Unset=UNSET, truncate_values: bool | Unset=UNSET, **kwargs: Any) -> SearchClusterVariablesResponse200:
    """Search for cluster variables based on given criteria. By default, long variable values in the
response are truncated.
...
async def asyncio(*, client: AuthenticatedClient | Client, body: SearchClusterVariablesData | Unset=UNSET, truncate_values: bool | Unset=UNSET, **kwargs: Any) -> SearchClusterVariablesResponse200:
    """Search for cluster variables based on given criteria. By default, long variable values in the
response are truncated.

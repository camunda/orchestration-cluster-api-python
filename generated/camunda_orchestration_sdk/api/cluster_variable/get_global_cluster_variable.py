...
def sync(name: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetGlobalClusterVariableResponse200:
    """Get a global-scoped cluster variable
...
async def asyncio(name: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetGlobalClusterVariableResponse200:
    """Get a global-scoped cluster variable

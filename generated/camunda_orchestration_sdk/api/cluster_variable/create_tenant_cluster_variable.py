...
def sync(tenant_id: str, *, client: AuthenticatedClient | Client, body: CreateTenantClusterVariableData, **kwargs: Any) -> CreateTenantClusterVariableResponse200:
    """Create a tenant-scoped cluster variable
...
async def asyncio(tenant_id: str, *, client: AuthenticatedClient | Client, body: CreateTenantClusterVariableData, **kwargs: Any) -> CreateTenantClusterVariableResponse200:
    """Create a tenant-scoped cluster variable

...
def sync(name: str, *, client: AuthenticatedClient | Client, body: UpdateGlobalClusterVariableData, **kwargs: Any) -> UpdateGlobalClusterVariableResponse200:
    """Update a global-scoped cluster variable
...
async def asyncio(name: str, *, client: AuthenticatedClient | Client, body: UpdateGlobalClusterVariableData, **kwargs: Any) -> UpdateGlobalClusterVariableResponse200:
    """Update a global-scoped cluster variable

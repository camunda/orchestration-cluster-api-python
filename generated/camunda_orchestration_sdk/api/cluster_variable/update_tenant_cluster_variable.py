...
def sync(tenant_id: str, name: str, *, client: AuthenticatedClient | Client, body: UpdateTenantClusterVariableData, **kwargs: Any) -> UpdateTenantClusterVariableResponse200:
    """Update a tenant-scoped cluster variable
...
async def asyncio(tenant_id: str, name: str, *, client: AuthenticatedClient | Client, body: UpdateTenantClusterVariableData, **kwargs: Any) -> UpdateTenantClusterVariableResponse200:
    """Update a tenant-scoped cluster variable

...
def sync_detailed(
    role_id: str, *, client: AuthenticatedClient, body: RoleUpdateRequest
) -> Response[ProblemDetail | RoleUpdateResult]:
    """Update role
...
def sync(
    role_id: str, *, client: AuthenticatedClient, body: RoleUpdateRequest, **kwargs: Any
) -> RoleUpdateResult:
    """Update role
    ...
    if response.status_code < 200 or response.status_code >= 300:
        ...
        raise errors.UnexpectedStatus(
            response.status_code, response.content, operation_id="update_role"
        )

...
def sync(role_id: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetRoleResponse200:
    """Get role
...
async def asyncio(role_id: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetRoleResponse200:
    """Get role

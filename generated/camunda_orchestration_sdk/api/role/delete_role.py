...
def sync_detailed(role_id: str, *, client: AuthenticatedClient | Client) -> Response[Any | ProblemDetail]:
    """Delete role
...
def sync(role_id: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> None:
    """Delete role
...
async def asyncio_detailed(role_id: str, *, client: AuthenticatedClient | Client) -> Response[Any | ProblemDetail]:
    """Delete role
...
async def asyncio(role_id: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> None:
    """Delete role

...
def sync(role_id: str, *, client: AuthenticatedClient | Client, body: SearchMappingRulesForRoleData | Unset=UNSET, **kwargs: Any) -> SearchMappingRulesForRoleResponse200:
    """Search role mapping rules
...
async def asyncio(role_id: str, *, client: AuthenticatedClient | Client, body: SearchMappingRulesForRoleData | Unset=UNSET, **kwargs: Any) -> SearchMappingRulesForRoleResponse200:
    """Search role mapping rules

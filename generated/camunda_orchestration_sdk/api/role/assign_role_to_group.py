...
def sync_detailed(
    role_id: str, group_id: str, *, client: AuthenticatedClient
) -> Response[Any | ProblemDetail]:
...
def sync(
    role_id: str, group_id: str, *, client: AuthenticatedClient, **kwargs: Any
) -> None:
    """Assign a role to a group
    ...
    if response.status_code < 200 or response.status_code >= 300:
        ...
        raise errors.UnexpectedStatus(
            response.status_code, response.content, operation_id="assign_role_to_group"
        )
    return None

...
def sync_detailed(
    role_id: str, mapping_rule_id: str, *, client: AuthenticatedClient
) -> Response[Any | ProblemDetail]:
...
def sync(
    role_id: str, mapping_rule_id: str, *, client: AuthenticatedClient, **kwargs: Any
) -> None:
    """Assign a role to a mapping rule
    ...
    if response.status_code < 200 or response.status_code >= 300:
        if response.status_code == 400:
            raise errors.BadRequestError(
                ...
                operation_id="assign_role_to_mapping_rule",
            )
        if response.status_code == 403:

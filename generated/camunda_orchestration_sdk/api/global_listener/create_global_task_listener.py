...
def sync_detailed(
    *, client: AuthenticatedClient, body: CreateGlobalTaskListenerRequest
) -> Response[GlobalTaskListenerResult | ProblemDetail]:
...
def sync(
    *, client: AuthenticatedClient, body: CreateGlobalTaskListenerRequest, **kwargs: Any
    ...
    if response.status_code < 200 or response.status_code >= 300:
        if response.status_code == 400:
            raise errors.BadRequestError(
                ...
                operation_id="create_global_task_listener",
            )
        if response.status_code == 401:

...
def sync_detailed(*, client: AuthenticatedClient, body: GlobalTaskListenerSearchQueryRequest | Unset=UNSET) -> Response[GlobalTaskListenerSearchQueryResult | ProblemDetail]:
...
def sync(*, client: AuthenticatedClient, body: GlobalTaskListenerSearchQueryRequest | Unset=UNSET, **kwargs: Any) -> GlobalTaskListenerSearchQueryResult:
    """Search global user task listeners
...
async def asyncio_detailed(*, client: AuthenticatedClient, body: GlobalTaskListenerSearchQueryRequest | Unset=UNSET) -> Response[GlobalTaskListenerSearchQueryResult | ProblemDetail]:
    """Search global user task listeners
...
async def asyncio(*, client: AuthenticatedClient, body: GlobalTaskListenerSearchQueryRequest | Unset=UNSET, **kwargs: Any) -> GlobalTaskListenerSearchQueryResult:
    """Search global user task listeners

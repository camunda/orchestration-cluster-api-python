...
def sync(*, client: AuthenticatedClient | Client, **kwargs: Any) -> GetLicenseResponse200:
    """Get license status
...
async def asyncio(*, client: AuthenticatedClient | Client, **kwargs: Any) -> GetLicenseResponse200:
    """Get license status

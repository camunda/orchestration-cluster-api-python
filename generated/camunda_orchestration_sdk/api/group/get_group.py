...
def sync(group_id: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetGroupResponse200:
    """Get group
...
async def asyncio(group_id: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetGroupResponse200:
    """Get group

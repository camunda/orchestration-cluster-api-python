...
def sync(group_id: str, *, client: AuthenticatedClient | Client, body: UpdateGroupData, **kwargs: Any) -> UpdateGroupResponse200:
    """Update group
...
async def asyncio(group_id: str, *, client: AuthenticatedClient | Client, body: UpdateGroupData, **kwargs: Any) -> UpdateGroupResponse200:
    """Update group

...
def sync(group_id: str, *, client: AuthenticatedClient | Client, body: SearchMappingRulesForGroupData | Unset=UNSET, **kwargs: Any) -> SearchMappingRulesForGroupResponse200:
    """Search group mapping rules
...
async def asyncio(group_id: str, *, client: AuthenticatedClient | Client, body: SearchMappingRulesForGroupData | Unset=UNSET, **kwargs: Any) -> SearchMappingRulesForGroupResponse200:
    """Search group mapping rules

...
def sync_detailed(
    group_id: str, username: str, *, client: AuthenticatedClient
) -> Response[Any | ProblemDetail]:
...
def sync(
    group_id: str, username: str, *, client: AuthenticatedClient, **kwargs: Any
) -> None:
    """Assign a user to a group
    ...
    if response.status_code < 200 or response.status_code >= 300:
        ...
        raise errors.UnexpectedStatus(
            response.status_code, response.content, operation_id="assign_user_to_group"
        )
    return None

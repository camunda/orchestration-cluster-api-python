...
def sync_detailed(*, client: AuthenticatedClient, body: MessageSubscriptionSearchQuery | Unset=UNSET) -> Response[MessageSubscriptionSearchQueryResult | ProblemDetail]:
...
def sync(*, client: AuthenticatedClient, body: MessageSubscriptionSearchQuery | Unset=UNSET, **kwargs: Any) -> MessageSubscriptionSearchQueryResult:
    """Search message subscriptions
...
async def asyncio_detailed(*, client: AuthenticatedClient, body: MessageSubscriptionSearchQuery | Unset=UNSET) -> Response[MessageSubscriptionSearchQueryResult | ProblemDetail]:
    """Search message subscriptions
...
async def asyncio(*, client: AuthenticatedClient, body: MessageSubscriptionSearchQuery | Unset=UNSET, **kwargs: Any) -> MessageSubscriptionSearchQueryResult:
    """Search message subscriptions

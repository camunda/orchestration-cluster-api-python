...
def sync_detailed(process_instance_key: str, *, client: AuthenticatedClient, body: ProcessInstanceMigrationInstruction) -> Response[Any | ProblemDetail]:
...
def sync(process_instance_key: str, *, client: AuthenticatedClient, body: ProcessInstanceMigrationInstruction, **kwargs: Any) -> None:
    """Migrate process instance
...
async def asyncio_detailed(process_instance_key: str, *, client: AuthenticatedClient, body: ProcessInstanceMigrationInstruction) -> Response[Any | ProblemDetail]:
    """Migrate process instance
...
async def asyncio(process_instance_key: str, *, client: AuthenticatedClient, body: ProcessInstanceMigrationInstruction, **kwargs: Any) -> None:
    """Migrate process instance

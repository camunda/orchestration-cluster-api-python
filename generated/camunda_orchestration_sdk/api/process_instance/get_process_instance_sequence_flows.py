...
def sync(process_instance_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetProcessInstanceSequenceFlowsResponse200:
    """Get sequence flows
...
async def asyncio(process_instance_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetProcessInstanceSequenceFlowsResponse200:
    """Get sequence flows

...
def sync_detailed(process_instance_key: str, *, client: AuthenticatedClient) -> Response[ProblemDetail | ProcessInstanceSequenceFlowsQueryResult]:
    """Get sequence flows
...
def sync(process_instance_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> ProcessInstanceSequenceFlowsQueryResult:
    """Get sequence flows
...
async def asyncio_detailed(process_instance_key: str, *, client: AuthenticatedClient) -> Response[ProblemDetail | ProcessInstanceSequenceFlowsQueryResult]:
    """Get sequence flows
...
async def asyncio(process_instance_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> ProcessInstanceSequenceFlowsQueryResult:
    """Get sequence flows

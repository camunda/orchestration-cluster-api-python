...
def sync(*, client: AuthenticatedClient | Client, body: ResolveIncidentsBatchOperationData | Unset=UNSET, **kwargs: Any) -> ResolveIncidentsBatchOperationResponse200:
    """Resolve related incidents (batch)
...
async def asyncio(*, client: AuthenticatedClient | Client, body: ResolveIncidentsBatchOperationData | Unset=UNSET, **kwargs: Any) -> ResolveIncidentsBatchOperationResponse200:
    """Resolve related incidents (batch)

...
def sync_detailed(*, client: AuthenticatedClient | Client, body: ProcessInstanceModificationBatchOperationRequest) -> Response[BatchOperationCreatedResult | ProblemDetail]:
...
def sync(*, client: AuthenticatedClient | Client, body: ProcessInstanceModificationBatchOperationRequest, **kwargs: Any) -> BatchOperationCreatedResult:
    """Modify process instances (batch)
...
async def asyncio_detailed(*, client: AuthenticatedClient | Client, body: ProcessInstanceModificationBatchOperationRequest) -> Response[BatchOperationCreatedResult | ProblemDetail]:
    """Modify process instances (batch)
...
async def asyncio(*, client: AuthenticatedClient | Client, body: ProcessInstanceModificationBatchOperationRequest, **kwargs: Any) -> BatchOperationCreatedResult:
    """Modify process instances (batch)

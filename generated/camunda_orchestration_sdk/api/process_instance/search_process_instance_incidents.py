...
def sync(process_instance_key: str, *, client: AuthenticatedClient | Client, body: SearchProcessInstanceIncidentsData | Unset=UNSET, **kwargs: Any) -> SearchProcessInstanceIncidentsResponse200:
    """Search related incidents
...
async def asyncio(process_instance_key: str, *, client: AuthenticatedClient | Client, body: SearchProcessInstanceIncidentsData | Unset=UNSET, **kwargs: Any) -> SearchProcessInstanceIncidentsResponse200:
    """Search related incidents

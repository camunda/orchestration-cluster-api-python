...
def sync(*, client: AuthenticatedClient | Client, body: Processcreationbyid | Processcreationbykey, **kwargs: Any) -> CreateProcessInstanceResponse200:
    """Create process instance
...
async def asyncio(*, client: AuthenticatedClient | Client, body: Processcreationbyid | Processcreationbykey, **kwargs: Any) -> CreateProcessInstanceResponse200:
    """Create process instance

...
def sync(*, client: AuthenticatedClient | Client, body: CancelProcessInstancesBatchOperationData, **kwargs: Any) -> CancelProcessInstancesBatchOperationResponse200:
    """Cancel process instances (batch)
...
async def asyncio(*, client: AuthenticatedClient | Client, body: CancelProcessInstancesBatchOperationData, **kwargs: Any) -> CancelProcessInstancesBatchOperationResponse200:
    """Cancel process instances (batch)

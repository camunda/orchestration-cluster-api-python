...
def sync_detailed(process_instance_key: str, *, client: AuthenticatedClient) -> Response[ProblemDetail | list[ProcessInstanceCallHierarchyEntry]]:
    """Get call hierarchy
...
def sync(process_instance_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> list[Any]:
    """Get call hierarchy
...
async def asyncio_detailed(process_instance_key: str, *, client: AuthenticatedClient) -> Response[ProblemDetail | list[ProcessInstanceCallHierarchyEntry]]:
    """Get call hierarchy
...
async def asyncio(process_instance_key: str, *, client: AuthenticatedClient, **kwargs: Any) -> list[Any]:
    """Get call hierarchy

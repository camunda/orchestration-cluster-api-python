...
def sync(document_id: str, *, client: AuthenticatedClient | Client, body: CreateDocumentLinkData | Unset=UNSET, store_id: str | Unset=UNSET, content_hash: str | Unset=UNSET, **kwargs: Any) -> CreateDocumentLinkResponse201:
    """Create document link
...
async def asyncio(document_id: str, *, client: AuthenticatedClient | Client, body: CreateDocumentLinkData | Unset=UNSET, store_id: str | Unset=UNSET, content_hash: str | Unset=UNSET, **kwargs: Any) -> CreateDocumentLinkResponse201:
    """Create document link

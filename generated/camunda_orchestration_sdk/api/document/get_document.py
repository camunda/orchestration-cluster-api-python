...
def sync_detailed(document_id: str, *, client: AuthenticatedClient, store_id: str | Unset=UNSET, content_hash: str | Unset=UNSET) -> Response[File | ProblemDetail]:
    """Download document
...
def sync(document_id: str, *, client: AuthenticatedClient, store_id: str | Unset=UNSET, content_hash: str | Unset=UNSET, **kwargs: Any) -> File:
    """Download document
...
async def asyncio_detailed(document_id: str, *, client: AuthenticatedClient, store_id: str | Unset=UNSET, content_hash: str | Unset=UNSET) -> Response[File | ProblemDetail]:
    """Download document
...
async def asyncio(document_id: str, *, client: AuthenticatedClient, store_id: str | Unset=UNSET, content_hash: str | Unset=UNSET, **kwargs: Any) -> File:
    """Download document

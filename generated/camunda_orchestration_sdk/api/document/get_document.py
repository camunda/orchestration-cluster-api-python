...
def sync_detailed(document_id: str, *, client: AuthenticatedClient | Client, store_id: str | Unset=UNSET, content_hash: str | Unset=UNSET) -> Response[File | ProblemDetail]:
    """Download document
...
def sync(document_id: str, *, client: AuthenticatedClient | Client, store_id: str | Unset=UNSET, content_hash: str | Unset=UNSET, **kwargs: Any) -> File:
    """Download document
...
Returns:
    ...
    if response.status_code < 200 or response.status_code >= 300:
        if response.status_code == 404:
            raise errors.NotFoundError(status_code=response.status_code, content=response.content, parsed=cast(ProblemDetail, response.parsed), operation_id='get_document')
        if response.status_code == 500:
            raise errors.InternalServerErrorError(status_code=response.status_code, content=response.content, parsed=cast(ProblemDetail, response.parsed), operation_id='get_document')
        raise errors.UnexpectedStatus(response.status_code, response.content, operation_id='get_document')
    assert response.parsed is not None
    return cast(File, response.parsed)

async def asyncio_detailed(document_id: str, *, client: AuthenticatedClient | Client, store_id: str | Unset=UNSET, content_hash: str | Unset=UNSET) -> Response[File | ProblemDetail]:
    """Download document
...
async def asyncio(document_id: str, *, client: AuthenticatedClient | Client, store_id: str | Unset=UNSET, content_hash: str | Unset=UNSET, **kwargs: Any) -> File:
    """Download document

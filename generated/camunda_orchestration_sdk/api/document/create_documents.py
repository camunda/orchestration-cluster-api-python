...
def sync_detailed(*, client: AuthenticatedClient, body: CreateDocumentsData, store_id: str | Unset=UNSET) -> Response[DocumentCreationBatchResponse | ProblemDetail]:
...
def sync(*, client: AuthenticatedClient, body: CreateDocumentsData, store_id: str | Unset=UNSET, **kwargs: Any) -> DocumentCreationBatchResponse:
    """Upload multiple documents
...
async def asyncio_detailed(*, client: AuthenticatedClient, body: CreateDocumentsData, store_id: str | Unset=UNSET) -> Response[DocumentCreationBatchResponse | ProblemDetail]:
    """Upload multiple documents
...
async def asyncio(*, client: AuthenticatedClient, body: CreateDocumentsData, store_id: str | Unset=UNSET, **kwargs: Any) -> DocumentCreationBatchResponse:
    """Upload multiple documents

...
def sync(variable_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetVariableResponse200:
    """Get variable
...
async def asyncio(variable_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetVariableResponse200:
    """Get variable

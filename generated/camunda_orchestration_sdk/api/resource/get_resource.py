...
def sync(resource_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetResourceResponse200:
    """Get resource
...
async def asyncio(resource_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetResourceResponse200:
    """Get resource

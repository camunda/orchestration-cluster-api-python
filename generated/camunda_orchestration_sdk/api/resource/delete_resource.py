...
def sync_detailed(resource_key: str, *, client: AuthenticatedClient, body: DeleteResourceRequest | None | Unset=UNSET) -> Response[DeleteResourceResponse | ProblemDetail]:
    """Delete resource
...
def sync(resource_key: str, *, client: AuthenticatedClient, body: DeleteResourceRequest | None | Unset=UNSET, **kwargs: Any) -> DeleteResourceResponse:
    """Delete resource
...
async def asyncio_detailed(resource_key: str, *, client: AuthenticatedClient, body: DeleteResourceRequest | None | Unset=UNSET) -> Response[DeleteResourceResponse | ProblemDetail]:
    """Delete resource
...
async def asyncio(resource_key: str, *, client: AuthenticatedClient, body: DeleteResourceRequest | None | Unset=UNSET, **kwargs: Any) -> DeleteResourceResponse:
    """Delete resource

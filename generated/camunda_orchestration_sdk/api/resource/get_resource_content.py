...
Returns:
    ...
    if response.status_code < 200 or response.status_code >= 300:
        ...
        if response.status_code == 406:
            raise errors.NotAcceptableError(status_code=response.status_code, content=response.content, parsed=cast(ProblemDetail, response.parsed), operation_id='get_resource_content')
        if response.status_code == 500:

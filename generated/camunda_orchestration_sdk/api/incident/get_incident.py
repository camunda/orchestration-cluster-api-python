...
def sync(incident_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetIncidentResponse200:
    """Get incident
...
async def asyncio(incident_key: str, *, client: AuthenticatedClient | Client, **kwargs: Any) -> GetIncidentResponse200:
    """Get incident

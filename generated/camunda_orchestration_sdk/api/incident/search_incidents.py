...
def sync(*, client: AuthenticatedClient | Client, body: SearchIncidentsData | Unset=UNSET, **kwargs) -> SearchIncidentsResponse200:
    """Search incidents
...
async def asyncio(*, client: AuthenticatedClient | Client, body: SearchIncidentsData | Unset=UNSET, **kwargs) -> SearchIncidentsResponse200:
    """Search incidents

...
def sync(*, client: AuthenticatedClient | Client, body: GetProcessInstanceStatisticsByDefinitionData, **kwargs: Any) -> GetProcessInstanceStatisticsByDefinitionResponse200:
    """Get process instance statistics by definition
...
async def asyncio(*, client: AuthenticatedClient | Client, body: GetProcessInstanceStatisticsByDefinitionData, **kwargs: Any) -> GetProcessInstanceStatisticsByDefinitionResponse200:
    """Get process instance statistics by definition
